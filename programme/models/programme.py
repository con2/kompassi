    ...
    def as_json(self, format="default"):
        ...
        if format == "default":
            ...
            return pick_attrs(
                ...
                ropecon2023_signuplist=self.ropecon2023_signuplist if self.form_used.slug == "pelitiski" else None,
                ropecon2023_workshop_fee=self.ropecon2023_workshop_fee if self.form_used.slug == "tyopaja" else None,

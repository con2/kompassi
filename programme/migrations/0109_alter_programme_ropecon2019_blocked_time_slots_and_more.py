...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.ManyToManyField(blank=True, help_text="Tell us when you <strong>can not run</strong> your game. You can write more specific requests in the <em>other information</em> field below (e.g. <em>I'd like to run my game late in the evening</em>), but here we want information about limitations set by for example work or bus schedules (for example if you need to leave the venue by 11 PM to get to your accommodation in time).", related_name='+', to='ropecon2019.timeslot', verbose_name='When are you unable to run your game?'),
        ),
        migrations.AlterField(
            model_name='programme',
            name='ropecon2019_preferred_time_slots',
            field=models.ManyToManyField(blank=True, help_text='When would you like to host your game program? Check the times when you would like to host your game program. If you have more specific needs regarding the timing, please let us know in the Comments field below. We do not restrict your desired times, but we reserve the right to make changes. For example, we would rather have tournaments one after another than at the same time.', related_name='+', to='ropecon2019.timeslot', verbose_name='time preferences'),
        ),
        migrations.AlterField(
            model_name='programme',
            name='ropecon2021_blocked_time_slots',
            field=models.ManyToManyField(blank=True, help_text='Select the times when you are <b>NOT able</b> to run your larp. In other words, leave the times that you would be able to run your larp unselected!<br/>If you have a more specific request in mind regarding your schedule (for example, you would like to run your larp late at night), please let us know in the Comments section below.<br/>In this section, we would like to know more about how work or volunteer shifts, public transport schedules and other factors might be impacting your schedule. For example, if you need to leave the venue by 11pm to be able to catch the last bus to your accommodation.', related_name='+', to='ropecon2021.timeslot', verbose_name='When are you NOT able to run your larp?'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='room',
            name='paikkala_room',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='paikkala.room'),
        ),

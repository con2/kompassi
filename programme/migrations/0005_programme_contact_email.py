...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProgrammeEventMeta.contact_email'
        db.add_column(u'programme_programmeeventmeta', 'contact_email',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProgrammeEventMeta.contact_email'
        db.delete_column(u'programme_programmeeventmeta', 'contact_email')

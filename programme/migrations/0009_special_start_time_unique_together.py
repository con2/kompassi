...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'SpecialStartTime', fields ['start_time', 'event']
        db.create_unique(u'programme_specialstarttime', ['start_time', 'event_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SpecialStartTime', fields ['start_time', 'event']
        db.delete_unique(u'programme_specialstarttime', ['start_time', 'event_id'])
    ...
    models = {
        ...
        u'programme.programme': {
            ...
            'room': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['programme.Room']", 'null': 'True', 'blank': 'True'}),
        ...
        u'programme.programmeedittoken': {
            'Meta': {'object_name': 'ProgrammeEditToken', 'index_together': "[('person', 'state')]"},
        ...
        u'programme.room': {
            'Meta': {'ordering': "['venue', 'order']", 'unique_together': "[('venue', 'order')]", 'object_name': 'Room'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'programme.specialstarttime': {
            'Meta': {'ordering': "['event', 'start_time']", 'unique_together': "[('event', 'start_time')]", 'object_name': 'SpecialStartTime'},
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

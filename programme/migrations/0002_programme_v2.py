...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Programme.start_time'
        db.alter_column(u'programme_programme', 'start_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Programme.length'
        db.alter_column(u'programme_programme', 'length', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Programme.room'
        db.alter_column(u'programme_programme', 'room_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['programme.Room'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Programme.start_time'
        raise RuntimeError("Cannot reverse this migration. 'Programme.start_time' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Programme.length'
        raise RuntimeError("Cannot reverse this migration. 'Programme.length' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Programme.room'
        raise RuntimeError("Cannot reverse this migration. 'Programme.room' and its values cannot be restored.")

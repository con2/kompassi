...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('title', models.CharField(help_text='Keksi ohjelmanumerollesi lyhyt ja ytimek\xe4s otsikko ohjelmakarttaa sek\xe4 ohjelmalehte\xe4 varten. Tracon varaa oikeuden muuttaa otsikkoa.', max_length=1023, verbose_name='Otsikko')),
                ('description', models.TextField(help_text='Ohjelmakuvaus n\xe4kyy web-ohjelmakartassa sek\xe4 ohjelmalehdess\xe4. Ohjelmakuvauksen tarkoitus on antaa k\xe4vij\xe4lle riitt\xe4v\xe4t tiedot p\xe4\xe4tt\xe4\xe4, osallistuako ohjelmaasi, ja markkinoida ohjelmaasi k\xe4vij\xf6ille. Tracon varaa oikeuden editoida kuvausta.', verbose_name='Ohjelmanumeron kuvaus', blank=True)),
                ('room_requirements', models.TextField(help_text='Kuinka paljon odotat ohjelmanumerosi vet\xe4v\xe4n yleis\xf6\xe4? Mink\xe4laista salia toivot ohjelmanumerosi k\xe4ytt\xf6\xf6n?', verbose_name='Tilatarpeet', blank=True)),
                ('tech_requirements', models.TextField(help_text='Tarvitsetko ohjelmasi pit\xe4miseen esimerkiksi tietokonetta, videotykki\xe4, luento\xe4\xe4nentoistoa, musiikki\xe4\xe4nentoistoa, tussi-, fl\xe4ppi- tai liitutaulua tai muita erityisv\xe4lineit\xe4? Oman tietokoneen k\xe4ytt\xf6 on mahdollista vain, jos siit\xe4 on sovittu etuk\xe4teen.', verbose_name='Tekniikkatarpeet', blank=True)),
                ('requested_time_slot', models.TextField(help_text='Mihin aikaan haluaisit pit\xe4\xe4 ohjelmanumerosi? Mink\xe4 ohjelmanumeroiden kanssa et halua olla p\xe4\xe4llek\xe4in?', verbose_name='Aikatoiveet', blank=True)),
                ('video_permission', models.CharField(default='public', help_text='Saako luentosi videoida ja julkaista Internetiss\xe4?', max_length=15, verbose_name='Videointilupa', choices=[('public', 'Ohjelmanumeroni saa videoida ja julkaista'), ('private', 'Kiell\xe4n ohjelmanumeroni julkaisun, mutta sen saa videoida arkistok\xe4ytt\xf6\xf6n'), ('forbidden', 'Kiell\xe4n ohjelmanumeroni videoinnin')])),
                ('notes_from_host', models.TextField(help_text='Jos haluat sanoa ohjelmanumeroosi liittyen jotain, mik\xe4 ei sovi mihink\xe4\xe4n yll\xe4 olevista kentist\xe4, k\xe4yt\xe4 t\xe4t\xe4 kentt\xe4\xe4.', verbose_name='Vapaamuotoiset terveiset ohjelmavastaaville', blank=True)),
            ...
            bases=(models.Model, core.csv_export.CsvExportMixin),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            bases=(models.Model, programme.models.ViewMethodsMixin),
        ),
        migrations.AlterUniqueTogether(
            name='specialstarttime',
            unique_together=set([('event', 'start_time')]),
        ),
        migrations.AlterUniqueTogether(
            name='room',
            unique_together=set([('venue', 'order')]),
        ),
        migrations.AddField(

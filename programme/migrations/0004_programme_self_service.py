...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProgrammeEditToken'
        db.create_table(u'programme_programmeedittoken', (
        ...
        db.send_create_signal(u'programme', ['ProgrammeEditToken'])

        # Adding index on 'ProgrammeEditToken', fields ['person', 'state']
        db.create_index(u'programme_programmeedittoken', ['person_id', 'state'])


    def backwards(self, orm):
        # Removing index on 'ProgrammeEditToken', fields ['person', 'state']
        db.delete_index(u'programme_programmeedittoken', ['person_id', 'state'])

        # Deleting model 'ProgrammeEditToken'
        db.delete_table(u'programme_programmeedittoken')

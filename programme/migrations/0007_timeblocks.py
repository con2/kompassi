...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SpecialStartTime'
        db.create_table(u'programme_specialstarttime', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Event'])),
            ('start_time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'programme', ['SpecialStartTime'])

        # Adding model 'TimeBlock'
        db.create_table(u'programme_timeblock', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Event'])),
            ('start_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'programme', ['TimeBlock'])


    def backwards(self, orm):
        # Deleting model 'SpecialStartTime'
        db.delete_table(u'programme_specialstarttime')

        # Deleting model 'TimeBlock'
        db.delete_table(u'programme_timeblock')
    ...
    models = {
        ...
        u'programme.specialstarttime': {
            'Meta': {'object_name': 'SpecialStartTime'},
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tag.event'
        db.add_column(u'programme_tag', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Event']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tag.event'
        db.delete_column(u'programme_tag', 'event_id')
    ...
    models = {
        ...
        u'programme.view': {
            'Meta': {'ordering': "['event', 'order']", 'object_name': 'View'},
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

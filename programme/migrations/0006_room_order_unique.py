...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Room', fields ['order']
        db.delete_unique(u'programme_room', ['order'])

        # Adding unique constraint on 'Room', fields ['venue', 'order']
        db.create_unique(u'programme_room', ['venue_id', 'order'])


    def backwards(self, orm):
        # Removing unique constraint on 'Room', fields ['venue', 'order']
        db.delete_unique(u'programme_room', ['venue_id', 'order'])

        # Adding unique constraint on 'Room', fields ['order']
        db.create_unique(u'programme_room', ['order'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.internal_description'
        db.add_column('ticket_sales_product', 'internal_description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.internal_description'
        db.delete_column('ticket_sales_product', 'internal_description')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'School.product'
        db.delete_column('ticket_sales_school', 'product_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'School.product'
        raise RuntimeError("Cannot reverse this migration. 'School.product' and its values cannot be restored.")
    ...
    models = {
        ...
        'ticket_sales.product': {
            'Meta': {'ordering': "('ordering', 'id')", 'object_name': 'Product'},

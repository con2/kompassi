...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Batch.prepare_time'
        db.delete_column(u'tickets_batch', 'prepare_time')

        # Deleting field 'Batch.print_time'
        db.delete_column(u'tickets_batch', 'print_time')


        # Changing field 'Order.start_time'
        db.alter_column(u'tickets_order', 'start_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Adding field 'Batch.prepare_time'
        db.add_column(u'tickets_batch', 'prepare_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Batch.print_time'
        db.add_column(u'tickets_batch', 'print_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Order.start_time'
        db.alter_column(u'tickets_order', 'start_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('ticket_sales_product', 'image', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Product.classname'
        db.alter_column('ticket_sales_product', 'classname', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

    def backwards(self, orm):

        # Changing field 'Product.image'
        db.alter_column('ticket_sales_product', 'image', self.gf('django.db.models.fields.CharField')(default='missing', max_length=32))

        # Changing field 'Product.classname'
        db.alter_column('ticket_sales_product', 'classname', self.gf('django.db.models.fields.CharField')(default='missing', max_length=32))
    ...
    models = {
        ...
        'ticket_sales.product': {
            ...
            'classname': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ilmoitus_mail': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'image': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),

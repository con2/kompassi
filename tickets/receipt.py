...
def render_receipt(order, c):
    ...
    c.drawString(BASE_INDENT, ypos - 5*mm, u"ottakaa viipymättä yhteyttä lipunmyyntivastaavaan sähköpostitse: {0}".format(order.event.tickets_event_meta.contact_email))

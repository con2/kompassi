...
class Signup(CsvExportMixin, SignupMixin, models.Model):
    ...
    def granted_privileges(self):
        from kompassi.access.models import GrantedPrivilege
    ...
    def potential_privileges(self):
        from kompassi.access.models import Privilege
    ...
    def apply_state_cleanup_team_membership(self):
        ...
        from kompassi.core.utils import ensure_user_is_member_of_group
        from kompassi.intra.models.team_member import TeamMember
    ...
    def email_address(self):
        from kompassi.access.models import EmailAlias
    ...
    def get_csv_fields(cls, event):
        if getattr(event, "_signup_csv_fields", None) is None:
            ...
            from kompassi.labour_common_qualifications.models import JVKortti

            event._signup_csv_fields = []

            related_models = [Person, Signup, JVKortti]

...
Kubernetes manifests are generated by a small Node.js program, `kubernetes/manifest.mts`, rather than templated YAML. See `kubernetes/README.md` for how to generate and deploy them.

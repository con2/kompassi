...
def tracon2027_afterparty_participants_view(request, event_slug):
    if event_slug != "tracon2027":
        raise NotImplementedError("This view is only available for tracon2027")
...
@default_cbac_required
def tracon2027_afterparty_summary_view(request, event_slug):
    if event_slug != "tracon2027":
        raise NotImplementedError("This view is only available for tracon2027")
    ...
    return render(request, "tracon2027_afterparty_summary_view.pug", vars)

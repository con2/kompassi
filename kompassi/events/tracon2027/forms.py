...
class OrganizerSignupForm(forms.ModelForm, AlternativeFormMixin):
    ...
    def get_excluded_m2m_field_defaults(self):
        return dict(job_categories=JobCategory.objects.filter(event__slug="tracon2027", name="Conitea"))
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Fieldset(
                ...
                HTML(
                    'Tutustuthan <a href="https://2027.tracon.fi/turvallisuus/#H%C3%A4irinn%C3%A4n-vastainen-linjaus" target="_blank" rel="noopener noreferrer">Traconin häirinnän vastaiseen linjaukseen</a> ennen kaatajaisiin ilmoittautumista.'
                ),
                "afterparty_policy",
            ),
        )

...
RPG_FORM_FIELD_TEXTS = dict(
    ...
    ropecon_theme=(
        _("Theme: Friendship"),
        _("If your game is related to the theme of Ropecon 2022, please tick this box."),
    ),
...
LARP_FORM_FIELD_TEXTS = dict(
    ...
    ropecon_theme=(
        _("Theme: Friendship"),
        _("If your larp is related to the theme of Ropecon 2022, please tick this box."),
    ),
...
PROGRAMME_FORM_FIELD_TEXTS = dict(
    ...
    ropecon_theme=(
        _("Theme: Friendship"),
        _("If your programme is related to the theme of Ropecon 2022, please tick this box."),
    ),
    ropecon2022_content_warnings=(
        _(
...
class OrganizerSignupForm(forms.ModelForm, AlternativeFormMixin):
    ...
    def get_excluded_m2m_field_defaults(self):
        return dict(job_categories=JobCategory.objects.filter(event__slug="ropecon2022", name="Conitea"))

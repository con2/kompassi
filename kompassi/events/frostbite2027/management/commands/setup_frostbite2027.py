...
class Setup:
    ...
    def setup_core(self):
        ...
        self.event, _unused = Event.objects.get_or_create(
            slug="frostbite2027",
            defaults=dict(
                name="Desucon Frostbite (2027)",
                name_genitive="Desucon Frostbiten",
                name_illative="Desucon Frostbiteen",
                name_inessive="Desucon Frostbitessä",
                homepage_url="https://desucon.fi/frostbite2027/",
                organization=self.organization,
                start_time=datetime(2027, 1, 22, 17, 0, 0, tzinfo=self.tz),
                end_time=datetime(2027, 1, 24, 17, 0, 0, tzinfo=self.tz),
                venue=self.venue,
            ),
        )
    ...
    def setup_labour(self):
        ...
        organizer_form, _unused = AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path="events.frostbite2027.forms:OrganizerSignupForm",
                signup_extra_form_class_path="events.frostbite2027.forms:OrganizerSignupExtraForm",
        ...
        AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path="events.frostbite2027.forms:SpecialistSignupForm",
                signup_extra_form_class_path="events.frostbite2027.forms:SpecialistSignupExtraForm",
                active_from=self.event.created_at,
                active_until=self.event.start_time,
                signup_message=(
        ...
        LabourSurvey.objects.get_or_create(
            ...
            defaults=dict(
                ...
                form_class_path="events.frostbite2027.forms:AfterpartyParticipationSurvey",
                active_from=now(),
                active_until=self.event.start_time,
            ),
        )
        ...
        LabourSurvey.objects.get_or_create(
            ...
            defaults=dict(
                ...
                form_class_path="events.frostbite2027.forms:AccommodationSurvey",
                active_from=now(),
                active_until=self.event.start_time,
            ),
        )
...
class Command(BaseCommand):
    args = ""
    help = "Setup frostbite2027 specific stuff"

...
class Setup:
    ...
    def setup_labour(self):
        ...
        AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path="events.tracon2023.forms:OrganizerSignupForm",
                signup_extra_form_class_path="events.tracon2023.forms:OrganizerSignupExtraForm",
                active_from=now(),
        ...
        Survey.objects.get_or_create(
            ...
            defaults=dict(
                ...
                form_class_path="events.tracon2023.forms:ShiftWishesSurvey",
                active_from=now(),
        ...
        Survey.objects.get_or_create(
            ...
            defaults=dict(
                ...
                form_class_path="events.tracon2023.forms:SwagSurvey",
                active_from=now(),
                active_until=datetime(2023, 6, 22, 23, 59, 59, tzinfo=self.tz),
            ),
        )
    ...
    def setup_tickets(self):
        ...
        defaults = dict(
            ...
            ticket_free_text=(
                "Tämä on sähköinen lippusi vuoden 2023 Traconiin. Sähköinen lippu vaihdetaan rannekkeeseen\n"
            ...
            front_page_text=(
                ...
                "<p>Lue lisää tapahtumasta <a href='http://2023.tracon.fi'>Traconin kotisivuilta</a>.</p>"
            ),
        )
    ...
    def setup_programme(self):
        ...
        AlternativeProgrammeForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                programme_form_code="events.tracon2023.forms:RpgForm",
                num_extra_invites=0,
                order=10,
            ),
        )
        ...
        default_form, created = AlternativeProgrammeForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                programme_form_code="events.tracon2023.forms:ProgrammeForm",
                num_extra_invites=3,
                order=30,
            ),
        )

...
class Command(BaseCommand):
    def handle(self, *args, **opts):
        ...
        event, unused = Event.objects.get_or_create(
            ...
            defaults=dict(
                public=False,
                name="Traconin JV-peruskurssi 2022",
                ...
                start_time=datetime(2022, 8, 5, 8, 0, tzinfo=tz),
                end_time=datetime(2022, 8, 13, 16, 0, tzinfo=tz),
                venue=venue,
            ),
        )
        ...
        EnrollmentEventMeta.objects.get_or_create(
            ...
            defaults=dict(
                ...
                form_class_path="events.traconjvp2022.forms:EnrollmentForm",
                ...
                enrollment_closes=datetime(2022, 8, 4, 20, 0, tzinfo=tz),
            ),
        )

...
class Setup:
    ...
    def setup_core(self):
        ...
        self.event, _unused = Event.objects.get_or_create(
            ...
            defaults=dict(
                ...
                start_time=datetime(2020, 7, 11, 10, 00, tzinfo=self.tz),
                end_time=datetime(2020, 7, 12, 17, 0, tzinfo=self.tz),
                venue=self.venue,
            ),
        )
    ...
    def setup_tickets(self):
        ...
        defaults = dict(
            ...
            reference_number_template="2020{:06}",
            contact_email="Nekocon (2020) <nekoconliput@gmail.com>",
            ticket_free_text="Tämä on sähköinen lippusi vuoden 2020 Nekoconiin. Sähköinen lippu vaihdetaan rannekkeeseen\n"
            ...
            "Tervetuloa Nekocon (2020) -tapahtumaan!",
        ...
        for product_info in [
            ...
            # ),
            # dict(
            #     name='Nekocon (2020) -konserttilippu',
...
class Command(BaseCommand):
    args = ""
    help = "Setup nekocon2020 specific stuff"

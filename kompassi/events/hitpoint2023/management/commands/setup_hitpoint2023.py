...
class Setup:
    ...
    def setup_core(self):
        ...
        self.event, _unused = Event.objects.get_or_create(
            slug="hitpoint2023",
            defaults=dict(
                name="Tracon Hitpoint 2023",
                name_genitive="Tracon Hitpoint 2023 -tapahtuman",
                name_illative="Tracon Hitpoint 2023 -tapahtumaan",
                name_inessive="Tracon Hitpoint 2023 -tapahtumassa",
                homepage_url="http://2023.hitpoint.tracon.fi",
                organization=self.organization,
                start_time=datetime(2023, 11, 4, 10, 0, tzinfo=self.tz),
                end_time=datetime(2023, 11, 5, 18, 0, tzinfo=self.tz),
                venue=self.venue,
            ),
        )
    ...
    def setup_labour(self):
        ...
        labour_event_meta_defaults = dict(
            ...
            contact_email="Tracon Hitpoint 2023 -työvoimatiimi <hitpoint@tracon.fi>",
        )
        ...
        AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path="events.hitpoint2023.forms:OrganizerSignupForm",
                signup_extra_form_class_path="events.hitpoint2023.forms:OrganizerSignupExtraForm",
                active_from=now(),
        ...
        Survey.objects.get_or_create(
            ...
            defaults=dict(
                ...
                form_class_path="events.hitpoint2023.forms:SwagSurvey",
                active_from=now(),
                active_until=self.event.end_time,
            ),
        )
    ...
    def setup_programme(self):
        ...
        AlternativeProgrammeForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                description="",
                programme_form_code="events.hitpoint2023.forms:RpgForm",
                num_extra_invites=0,
                order=10,
            ),
        )
        ...
        AlternativeProgrammeForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                short_description="",
                programme_form_code="events.hitpoint2023.forms:FreeformForm",
                num_extra_invites=0,
                order=20,
            ),
        )
...
class Command(BaseCommand):
    args = ""
    help = "Setup hitpoint2023 specific stuff"

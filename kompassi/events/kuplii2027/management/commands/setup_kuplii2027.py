...
class Setup:
    ...
    def setup_core(self):
        ...
        self.event, _unused = Event.objects.get_or_create(
            slug="kuplii2027",
            defaults=dict(
                name="Tampere Kuplii 2027",
                name_genitive="Tampere Kuplii 2027 -tapahtuman",
                name_illative="Tampere Kuplii 2027 -tapahtumaan",
                name_inessive="Tampere Kuplii 2027 -tapahtumassa",
                homepage_url="http://2027.tamperekuplii.fi",
                organization=self.organization,
                start_time=datetime(2027, 3, 1, 10, 0, tzinfo=self.tz),
                end_time=datetime(2027, 3, 7, 17, 0, tzinfo=self.tz),
                venue=self.venue,
            ),
        )
    ...
    def setup_labour(self):
        ...
        if not JobCategory.objects.filter(event=self.event).exists():
            JobCategory.copy_from_event(
                source_event=Event.objects.get(slug="kuplii2026"),
        ...
        AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path="events.kuplii2027.forms:OrganizerSignupForm",
                signup_extra_form_class_path="events.kuplii2027.forms:OrganizerSignupExtraForm",
                active_from=now(),
...
class Command(BaseCommand):
    args = ""
    help = "Setup kuplii2027 specific stuff"

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('want_certificate', models.BooleanField(default=False, verbose_name='Haluan todistuksen työskentelystäni')),
                ...
                ('accommodation', models.ManyToManyField(blank=True, related_name='kotaeexpo2026_signup_extras', to='kotaeexpo2026.accommodation', verbose_name='Tarvitsen lattiamajoitusta')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_signup_extras', to='core.event')),
                ('known_language', models.ManyToManyField(blank=True, related_name='kotaeexpo2026_signup_extras', to='kotaeexpo2026.knownlanguage', verbose_name='Osaamasi kielet')),
                ...
                ('special_diet', models.ManyToManyField(blank=True, related_name='kotaeexpo2026_signup_extras', to='enrollment.specialdiet', verbose_name='Erikoisruokavalio')),
                ('work_days', models.ManyToManyField(blank=True, help_text='Merkitse ne päivät, jolloin olet käytettävissä vapaaehtoisena.', related_name='kotaeexpo2026_signup_extras', to='kotaeexpo2026.workday', verbose_name='Työskentelypäivät')),
            ],
            options={
                'abstract': False,
            },

            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, to="shumicon2023.knownlanguage", verbose_name="Muut osaamasi kielet"
                    ),
                ),
                (
                    "native_language",
                    models.ManyToManyField(to="shumicon2023.nativelanguage", verbose_name="Äidinkielesi"),
                ),
                (
                    "person",
                ...
                (
                    "special_diet",
                    models.ManyToManyField(blank=True, to="shumicon2023.specialdiet", verbose_name="Erikoisruokavalio"),
                ),
                (
                    "work_days",
                    models.ManyToManyField(
                        help_text="Minä päivinä olet halukas työskentelemään?",
                        to="shumicon2023.eventday",

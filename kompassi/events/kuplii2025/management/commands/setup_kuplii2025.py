...
class Setup:
    ...
    def setup_core(self):
        ...
        self.event, _unused = Event.objects.get_or_create(
            slug="kuplii2025",
            defaults=dict(
                name="Tampere Kuplii 2025",
                name_genitive="Tampere Kuplii 2025 -tapahtuman",
                name_illative="Tampere Kuplii 2025 -tapahtumaan",
                name_inessive="Tampere Kuplii 2025 -tapahtumassa",
                homepage_url="http://2025.tamperekuplii.fi",
                organization=self.organization,
                start_time=datetime(2025, 3, 29, 10, 0, tzinfo=self.tz),
                end_time=datetime(2025, 3, 30, 17, 0, tzinfo=self.tz),
                venue=self.venue,
            ),
        )
    ...
    def setup_labour(self):
        ...
        if not JobCategory.objects.filter(event=self.event).exists():
            JobCategory.copy_from_event(
                source_event=Event.objects.get(slug="kuplii2023"),
        ...
        AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path="events.kuplii2025.forms:OrganizerSignupForm",
                signup_extra_form_class_path="events.kuplii2025.forms:OrganizerSignupExtraForm",
                active_from=now(),
...
class Command(BaseCommand):
    args = ""
    help = "Setup kuplii2025 specific stuff"

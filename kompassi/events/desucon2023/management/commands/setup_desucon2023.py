    ...
    def setup_core(self):
        ...
        self.event, _unused = Event.objects.get_or_create(
            ...
            defaults=dict(
                ...
                homepage_url="https://desucon.fi/desucon2023/",
    ...
    def setup_labour(self):
        ...
        organizer_form, _unused = AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path="events.desucon2023.forms:OrganizerSignupForm",
                signup_extra_form_class_path="events.desucon2023.forms:OrganizerSignupExtraForm",
        ...
        AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path="events.desucon2023.forms:SpecialistSignupForm",
                signup_extra_form_class_path="events.desucon2023.forms:SpecialistSignupExtraForm",
                active_from=self.event.created_at,
                active_until=self.event.start_time,
                signup_message=(
        ...
        Survey.objects.get_or_create(
            ...
            defaults=dict(
                ...
                description=(
                    ...
                    "sunnuntaina 19. kesäkuuta 2023 noin kello 19:00."
                ),
                form_class_path="events.desucon2023.forms:AfterpartyParticipationSurvey",
                active_from=now(),
                active_until=self.event.start_time,
            ),
        )
    ...
    def setup_programme(self):
        ...
        _form, created = AlternativeProgrammeForm.objects.get_or_create(
            ...
            defaults=dict(
                title="Ohjelmalomake",
                short_description="",
                programme_form_code="events.desucon2023.forms:ProgrammeForm",
                num_extra_invites=0,
            ),
        )
...
class Command(BaseCommand):
    args = ""
    help = "Setup desucon2023 specific stuff"

...
def tracon2026_afterparty_participants_view(request, event_slug):
    if event_slug != "tracon2026":
        raise NotImplementedError("This view is only available for tracon2026")
...
@default_cbac_required
def tracon2026_afterparty_summary_view(request, event_slug):
    if event_slug != "tracon2026":
        raise NotImplementedError("This view is only available for tracon2026")
    ...
    return render(request, "tracon2026_afterparty_summary_view.pug", vars)

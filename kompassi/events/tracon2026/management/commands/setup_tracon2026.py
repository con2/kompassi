    ...
    def setup_core(self):
        ...
        self.event, _unused = Event.objects.get_or_create(
            ...
            defaults=dict(
                ...
                homepage_url="http://2026.tracon.fi",
                organization=self.organization,
                start_time=datetime(2026, 9, 4, 16, 0, tzinfo=self.tz),
                end_time=datetime(2026, 9, 6, 18, 0, tzinfo=self.tz),
                venue=self.venue,
            ),
        )
    ...
    def setup_labour(self):
        ...
        AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path="events.tracon2026.forms:OrganizerSignupForm",
                signup_extra_form_class_path="events.tracon2026.forms:OrganizerSignupExtraForm",
                active_from=now(),
        ...
        LabourSurvey.objects.get_or_create(
            ...
            defaults=dict(
                ...
                form_class_path="events.tracon2026.forms:ShiftWishesSurvey",
                active_from=now(),
        ...
        LabourSurvey.objects.get_or_create(
            ...
            defaults=dict(
                ...
                form_class_path="events.tracon2026.forms:SwagSurvey",
                active_from=now(),
    ...
    def setup_station_access(self):
        ...
        for id in [20672, 20675]:
            ...
            if person and person.user:
                ...
                logger.warning(
                    "setup_tracon2026.setup_access: Tickets POS user with person id %d not found, skipping", id
                )
        ...
        if person and person.user:
            ...
            logger.warning("setup_tracon2026.setup_access: Onboarding user with person id %d not found, skipping", id)
...
class Command(BaseCommand):
    args = ""
    help = "Setup tracon2026 specific stuff"

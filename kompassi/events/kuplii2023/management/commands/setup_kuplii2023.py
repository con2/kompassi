...
class Setup:
    ...
    def setup_core(self):
        ...
        self.event, _unused = Event.objects.get_or_create(
            slug="kuplii2023",
            defaults=dict(
                name="Tampere Kuplii 2023",
                name_genitive="Tampere Kuplii 2023 -tapahtuman",
                name_illative="Tampere Kuplii 2023 -tapahtumaan",
                name_inessive="Tampere Kuplii 2023 -tapahtumassa",
                homepage_url="http://2023.tamperekuplii.fi",
                organization=self.organization,
                start_time=datetime(2023, 3, 22, 10, 0, tzinfo=self.tz),
                end_time=datetime(2023, 3, 26, 17, 0, tzinfo=self.tz),
                venue=self.venue,
            ),
        )
    ...
    def setup_labour(self):
        ...
        AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path="events.kuplii2023.forms:OrganizerSignupForm",
                signup_extra_form_class_path="events.kuplii2023.forms:OrganizerSignupExtraForm",
                active_from=now(),
...
class Command(BaseCommand):
    args = ""
    help = "Setup kuplii2023 specific stuff"

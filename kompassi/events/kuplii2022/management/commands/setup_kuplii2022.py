...
class Setup:
    ...
    def setup_core(self):
        ...
        self.event, _unused = Event.objects.get_or_create(
            slug="kuplii2022",
            defaults=dict(
                name="Tampere Kuplii 2022",
                name_genitive="Tampere Kuplii 2022 -tapahtuman",
                name_illative="Tampere Kuplii 2022 -tapahtumaan",
                name_inessive="Tampere Kuplii 2022 -tapahtumassa",
                homepage_url="http://2022.tamperekuplii.fi",
                organization=self.organization,
                start_time=datetime(2022, 3, 23, 10, 0, tzinfo=self.tz),
                end_time=datetime(2022, 3, 27, 17, 0, tzinfo=self.tz),
                venue=self.venue,
            ),
        )
    ...
    def setup_labour(self):
        ...
        AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path="events.kuplii2022.forms:OrganizerSignupForm",
                signup_extra_form_class_path="events.kuplii2022.forms:OrganizerSignupExtraForm",
                active_from=now(),
...
class Command(BaseCommand):
    args = ""
    help = "Setup kuplii2022 specific stuff"

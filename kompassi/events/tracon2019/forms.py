...
class OrganizerSignupForm(forms.ModelForm, AlternativeFormMixin):
    ...
    def get_excluded_m2m_field_defaults(self):
        return dict(job_categories=JobCategory.objects.filter(event__slug="tracon2019", name="Conitea"))
...
class RpgForm(forms.ModelForm, AlternativeProgrammeFormMixin):
    ...
    def get_excluded_field_defaults(self):
        return dict(
            category=Category.objects.get(event__slug="tracon2019", slug="roolipeliohjelma"),
        )

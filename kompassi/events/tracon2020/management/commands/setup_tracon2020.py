...
class Setup:
    ...
    def setup_core(self):
        ...
        self.event, unused = Event.objects.get_or_create(
            ...
            defaults=dict(
                ...
                homepage_url="http://2020.tracon.fi",
                organization=self.organization,
                start_time=datetime(2020, 9, 4, 16, 0, tzinfo=self.tz),
                end_time=datetime(2020, 9, 6, 18, 0, tzinfo=self.tz),
                venue=self.venue,
            ),
        )
    ...
    def setup_labour(self):
        ...
        AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path="events.tracon2020.forms:OrganizerSignupForm",
                signup_extra_form_class_path="events.tracon2020.forms:OrganizerSignupExtraForm",
                active_from=now(),
        ...
        Survey.objects.get_or_create(
            ...
            defaults=dict(
                ...
                form_class_path="events.tracon2020.forms:ShiftWishesSurvey",
                active_from=now(),
    ...
    def setup_tickets(self):
        ...
        defaults = dict(
            ...
            ticket_free_text=(
                "Tämä on sähköinen lippusi vuoden 2020 Traconiin. Sähköinen lippu vaihdetaan rannekkeeseen\n"
            ...
            front_page_text=(
                ...
                "<p>Lue lisää tapahtumasta <a href='http://2020.tracon.fi'>Traconin kotisivuilta</a>.</p>"
            ),
        )
    ...
    def setup_programme(self):
            ...
            for hour_start_time in full_hours_between(time_block.start_time, time_block.end_time)[:-1]:
                for minute in [15, 30, 45]:
                    SpecialStartTime.objects.get_or_create(
                        event=self.event, start_time=hour_start_time.replace(minute=minute)
                    )
        ...
        AlternativeProgrammeForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                programme_form_code="events.tracon2020.forms:RpgForm",
                num_extra_invites=0,
                order=10,
            ),
        )
        ...
        default_form, created = AlternativeProgrammeForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                programme_form_code="events.tracon2020.forms:ProgrammeForm",
                num_extra_invites=3,
                order=30,
            ),
        )
        if default_form.programme_form_code == "programme.forms:ProgrammeOfferForm":
            default_form.programme_form_code = "events.tracon2020.forms:ProgrammeForm"
            default_form.save()
        ...
        kaatoilmo, unused = Survey.objects.get_or_create(
            ...
            defaults=dict(
                ...
                description=(
                    ...
                    # f'Näet bussivarauksesi <a href="{reverse("program_v2:paikkala_profile_reservations_view")}" target="_blank">paikkalippusivulta</a>.'
                ),
...
class Command(BaseCommand):
    args = ""
    help = "Setup tracon2020 specific stuff"

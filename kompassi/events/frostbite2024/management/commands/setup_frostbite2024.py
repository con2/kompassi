...
class Setup:
    ...
    def setup_core(self):
        ...
        self.event, _unused = Event.objects.get_or_create(
            slug="frostbite2024",
            defaults=dict(
                name="Desucon Frostbite (2024)",
                name_genitive="Desucon Frostbiten",
                name_illative="Desucon Frostbiteen",
                name_inessive="Desucon Frostbitessä",
                homepage_url="https://desucon.fi/frostbite2024/",
                organization=self.organization,
                start_time=datetime(2024, 1, 26, 17, 0, 0, tzinfo=self.tz),
                end_time=datetime(2024, 1, 28, 17, 0, 0, tzinfo=self.tz),
                venue=self.venue,
            ),
        )
    ...
    def setup_labour(self):
        ...
        organizer_form, _unused = AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path="events.frostbite2024.forms:OrganizerSignupForm",
                signup_extra_form_class_path="events.frostbite2024.forms:OrganizerSignupExtraForm",
        ...
        AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path="events.frostbite2024.forms:SpecialistSignupForm",
                signup_extra_form_class_path="events.frostbite2024.forms:SpecialistSignupExtraForm",
                active_from=self.event.created_at,
                active_until=self.event.start_time,
                signup_message=(
    ...
    def setup_programme(self):
        ...
        for role_title in [
            ...
            role, _unused = Role.objects.get_or_create(
                title=role_title,
        ...
        _form, created = AlternativeProgrammeForm.objects.get_or_create(
            ...
            defaults=dict(
                title="Ohjelmalomake",
                short_description="",
                programme_form_code="events.frostbite2024.forms:ProgrammeForm",
                num_extra_invites=0,
            ),
        )
...
class Command(BaseCommand):
    args = ""
    help = "Setup frostbite2024 specific stuff"

...
class Setup:
    ...
    def setup_core(self):
        ...
        self.venue, _unused = Venue.objects.get_or_create(
            name="Aalto-yliopiston kandidaattikeskus (Espoo)",
            defaults=dict(
                name_inessive="Aalto-yliopiston kandidaattikeskuksessa",
            ),
        )
        ...
        self.event, _unused = Event.objects.get_or_create(
            ...
            defaults=dict(
                name="Finncon 2022",
                name_genitive="Finncon 2022 -tapahtuman",
                name_illative="Finncon 2022 -tapahtumaan",
                name_inessive="Finncon 2022 -tapahtumassa",
                homepage_url="http://2022.finncon.org",
                organization=self.organization,
                start_time=datetime(2022, 7, 8, 10, 0, tzinfo=self.tz),
                end_time=datetime(2022, 7, 10, 18, 0, tzinfo=self.tz),
                venue=self.venue,
            ),
        )
    ...
    def setup_programme(self):
        ...
        admin_group, _hosts_group = ProgrammeEventMeta.get_or_create_groups(self.event, ["admins", "hosts"])
        ...
        if not programme_event_meta.contact_email:
            programme_event_meta.contact_email = "Finnconin ohjelmavastaava <ohjelma@2022.finncon.org>"
        ...
        _default_form, _created = AlternativeProgrammeForm.objects.get_or_create(
            event=self.event,
            slug="default",
            defaults=dict(
                title="Tarjoa ohjelmaa",
                programme_form_code="events.finncon2022.forms:ProgrammeForm",
                num_extra_invites=3,
            ),
        )
    ...
    def setup_labour(self):
        ...
        labour_event_meta_defaults = dict(
            ...
            contact_email="Finnconin työvoimavastaava <tyovoima@2022.finncon.org>",
        )
        ...
        AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path="events.finncon2022.forms:OrganizerSignupForm",
                signup_extra_form_class_path="events.finncon2022.forms:OrganizerSignupExtraForm",
                active_from=now(),
        ...
        for wiki_space, link_title, link_group in [
            # ('FINNCON2022', 'Finnconin työvoimawiki', 'accepted'),
        ]:
...
class Command(BaseCommand):
    args = ""
    help = "Setup finncon2022 specific stuff"

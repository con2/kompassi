...
class Setup:
    ...
    def setup_core(self):
        ...
        self.event, _unused = Event.objects.get_or_create(
            ...
            defaults=dict(
                ...
                start_time=datetime(2022, 7, 9, 10, 00, tzinfo=self.tz),
                end_time=datetime(2022, 7, 10, 17, 0, tzinfo=self.tz),
                venue=self.venue,
            ),
        )
    ...
    def setup_labour(self):
        ...
        AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path="events.nekocon2022.forms:OrganizerSignupForm",
                signup_extra_form_class_path="events.nekocon2022.forms:OrganizerSignupExtraForm",
                active_from=now(),
        ...
        for wiki_space, link_title, link_group in [
            ("NEKOCON2022", "Coniteawiki", "conitea"),
    ...
    def setup_tickets(self):
        ...
        defaults = dict(
            ...
            "Tervetuloa Nekocon (2022) -tapahtumaan!",
    ...
    def setup_programme(self):
        ...
        _form, _created = AlternativeProgrammeForm.objects.get_or_create(
            event=self.event,
            slug="default",
            defaults=dict(
                title="Ohjelmalomake",
                short_description="",
                programme_form_code="events.nekocon2022.forms:ProgrammeForm",
                num_extra_invites=0,
            ),
        )
...
class Command(BaseCommand):
    args = ""
    help = "Setup nekocon2022 specific stuff"

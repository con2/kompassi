...
from kompassi.core.utils import NONUNIQUE_SLUG_FIELD_PARAMS, format_datetime, slugify, url
from kompassi.core.utils.time_utils import format_interval
from kompassi.graphql_api.language import get_language_choices
...
class Programme(models.Model, CsvExportMixin):
    ...
    def apply_state_group_membership(self):
        from kompassi.core.utils import ensure_user_group_membership

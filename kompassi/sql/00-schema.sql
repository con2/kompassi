...
CREATE TABLE access_accessorganizationmeta (
...
CREATE TABLE access_emailalias (
    id integer NOT NULL,
...
CREATE SEQUENCE access_emailalias_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE access_emailalias_id_seq OWNED BY access_emailalias.id;
...
CREATE TABLE access_emailaliasdomain (
    id integer NOT NULL,
...
CREATE SEQUENCE access_emailaliasdomain_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE access_emailaliasdomain_id_seq OWNED BY access_emailaliasdomain.id;
...
CREATE TABLE access_emailaliastype (
    id integer NOT NULL,
...
CREATE SEQUENCE access_emailaliastype_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE access_emailaliastype_id_seq OWNED BY access_emailaliastype.id;
...
CREATE TABLE access_grantedprivilege (
    id integer NOT NULL,
...
CREATE SEQUENCE access_grantedprivilege_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE access_grantedprivilege_id_seq OWNED BY access_grantedprivilege.id;
...
CREATE TABLE access_groupemailaliasgrant (
    id integer NOT NULL,
...
CREATE SEQUENCE access_groupemailaliasgrant_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE access_groupemailaliasgrant_id_seq OWNED BY access_groupemailaliasgrant.id;
...
CREATE TABLE access_groupprivilege (
    id integer NOT NULL,
    event_id integer,
    group_id integer NOT NULL,
    privilege_id integer NOT NULL
...
CREATE SEQUENCE access_groupprivilege_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE access_groupprivilege_id_seq OWNED BY access_groupprivilege.id;
...
CREATE TABLE access_internalemailalias (
    id integer NOT NULL,
    account_name character varying(255) NOT NULL,
...
CREATE SEQUENCE access_internalemailalias_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE access_internalemailalias_id_seq OWNED BY access_internalemailalias.id;
...
CREATE SEQUENCE access_privilege_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE access_privilege_id_seq OWNED BY access_privilege.id;
...
CREATE TABLE access_slackaccess (
    id integer NOT NULL,
...
CREATE SEQUENCE access_slackaccess_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE access_slackaccess_id_seq OWNED BY access_slackaccess.id;
...
CREATE TABLE access_smtppassword (
    id integer NOT NULL,
...
CREATE SEQUENCE access_smtppassword_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE access_smtppassword_id_seq OWNED BY access_smtppassword.id;
...
CREATE TABLE access_smtpserver (
    id integer NOT NULL,
...
CREATE TABLE access_smtpserver_domains (
    id integer NOT NULL,
...
CREATE SEQUENCE access_smtpserver_domains_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE access_smtpserver_domains_id_seq OWNED BY access_smtpserver_domains.id;
...
CREATE SEQUENCE access_smtpserver_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE access_smtpserver_id_seq OWNED BY access_smtpserver.id;
...
CREATE TABLE aicon2016_signupextra (
...
CREATE TABLE aicon2016_signupextra_special_diet (
    id integer NOT NULL,
...
CREATE SEQUENCE aicon2016_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE aicon2016_signupextra_special_diet_id_seq OWNED BY aicon2016_signupextra_special_diet.id;
...
CREATE TABLE aicon2016_specialdiet (
    id integer NOT NULL,
...
CREATE SEQUENCE aicon2016_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE aicon2016_specialdiet_id_seq OWNED BY aicon2016_specialdiet.id;
...
CREATE TABLE animecon2015_night (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE animecon2015_night_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE animecon2015_night_id_seq OWNED BY animecon2015_night.id;
...
CREATE TABLE animecon2015_signupextra (
    signup_id integer NOT NULL,
    total_work character varying(15) NOT NULL,
    want_certificate boolean NOT NULL,
    certificate_delivery_address text NOT NULL,
...
CREATE TABLE animecon2015_signupextra_lodging_needs (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
...
CREATE SEQUENCE animecon2015_signupextra_lodging_needs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE animecon2015_signupextra_lodging_needs_id_seq OWNED BY animecon2015_signupextra_lodging_needs.id;
...
CREATE TABLE animecon2015_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE animecon2015_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE animecon2015_signupextra_special_diet_id_seq OWNED BY animecon2015_signupextra_special_diet.id;
...
CREATE TABLE animecon2015_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE animecon2015_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE animecon2015_specialdiet_id_seq OWNED BY animecon2015_specialdiet.id;
...
CREATE TABLE animecon2016_night (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE animecon2016_night_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE animecon2016_night_id_seq OWNED BY animecon2016_night.id;
...
CREATE TABLE animecon2016_signupextra (
    signup_id integer NOT NULL,
    total_work character varying(15) NOT NULL,
    personal_identification_number character varying(12) NOT NULL,
    want_certificate boolean NOT NULL,
...
CREATE TABLE animecon2016_signupextra_lodging_needs (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    night_id integer NOT NULL
);
...
CREATE SEQUENCE animecon2016_signupextra_lodging_needs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE animecon2016_signupextra_lodging_needs_id_seq OWNED BY animecon2016_signupextra_lodging_needs.id;
...
CREATE TABLE animecon2016_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE animecon2016_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE animecon2016_signupextra_special_diet_id_seq OWNED BY animecon2016_signupextra_special_diet.id;
...
CREATE TABLE animecon2016_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE animecon2016_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE animecon2016_specialdiet_id_seq OWNED BY animecon2016_specialdiet.id;
...
CREATE TABLE badges_badgeseventmeta (
...
CREATE SEQUENCE badges_batch_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE badges_batch_id_seq OWNED BY badges_batch.id;
...
CREATE TABLE core_carouselslide (
    id integer NOT NULL,
...
CREATE SEQUENCE core_carouselslide_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE core_carouselslide_id_seq OWNED BY core_carouselslide.id;
...
CREATE SEQUENCE core_emailverificationtoken_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE core_emailverificationtoken_id_seq OWNED BY core_emailverificationtoken.id;
...
CREATE SEQUENCE core_organization_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE core_organization_id_seq OWNED BY core_organization.id;
...
CREATE SEQUENCE core_passwordresettoken_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE core_passwordresettoken_id_seq OWNED BY core_passwordresettoken.id;
...
CREATE SEQUENCE core_person_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE core_person_id_seq OWNED BY core_person.id;
...
CREATE SEQUENCE core_venue_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE core_venue_id_seq OWNED BY core_venue.id;
...
CREATE TABLE desucon2016_signupextra (
    signup_id integer NOT NULL,
    shift_type character varying(15) NOT NULL,
...
CREATE TABLE desucon2016_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE desucon2016_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE desucon2016_signupextra_special_diet_id_seq OWNED BY desucon2016_signupextra_special_diet.id;
...
CREATE TABLE desucon2016_signupextrav2 (
    id integer NOT NULL,
    shift_type character varying(15) NOT NULL,
    desu_amount integer NOT NULL,
    prior_experience text NOT NULL,
...
CREATE SEQUENCE desucon2016_signupextrav2_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE desucon2016_signupextrav2_id_seq OWNED BY desucon2016_signupextrav2.id;
...
CREATE TABLE desucon2016_signupextrav2_special_diet (
    id integer NOT NULL,
...
CREATE SEQUENCE desucon2016_signupextrav2_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE desucon2016_signupextrav2_special_diet_id_seq OWNED BY desucon2016_signupextrav2_special_diet.id;
...
CREATE TABLE desucon2016_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE desucon2016_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE desucon2016_specialdiet_id_seq OWNED BY desucon2016_specialdiet.id;
...
CREATE TABLE desucon2017_signupextra (
    id integer NOT NULL,
    is_active boolean NOT NULL,
    shift_type character varying(15) NOT NULL,
    prior_experience text NOT NULL,
...
CREATE SEQUENCE desucon2017_signupextra_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE desucon2017_signupextra_id_seq OWNED BY desucon2017_signupextra.id;
...
CREATE TABLE desucon2017_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE desucon2017_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE desucon2017_signupextra_special_diet_id_seq OWNED BY desucon2017_signupextra_special_diet.id;
...
CREATE TABLE desucon2017_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE desucon2017_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE desucon2017_specialdiet_id_seq OWNED BY desucon2017_specialdiet.id;
...
CREATE TABLE desuprofile_integration_confirmationcode (
    id integer NOT NULL,
    code character varying(63) NOT NULL,
    created_at timestamp with time zone NOT NULL,
    used_at timestamp with time zone,
...
CREATE SEQUENCE desuprofile_integration_confirmationcode_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE desuprofile_integration_confirmationcode_id_seq OWNED BY desuprofile_integration_confirmationcode.id;
...
CREATE TABLE desuprofile_integration_connection (
    id integer NOT NULL,
    user_id integer NOT NULL,
    desuprofile_username character varying(30) NOT NULL
);
...
CREATE TABLE directory_directoryaccessgroup (
    id integer NOT NULL,
    active_from timestamp with time zone,
    active_until timestamp with time zone,
    created_at timestamp with time zone NOT NULL,
...
CREATE SEQUENCE directory_directoryaccessgroup_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE directory_directoryaccessgroup_id_seq OWNED BY directory_directoryaccessgroup.id;
...
CREATE TABLE directory_directoryorganizationmeta (
    organization_id integer NOT NULL
);
...
CREATE TABLE enrollment_conconpart (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE enrollment_conconpart_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE enrollment_conconpart_id_seq OWNED BY enrollment_conconpart.id;
...
CREATE TABLE enrollment_enrollment_concon_parts (
    id integer NOT NULL,
...
CREATE SEQUENCE enrollment_enrollment_concon_parts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE enrollment_enrollment_concon_parts_id_seq OWNED BY enrollment_enrollment_concon_parts.id;
...
ALTER SEQUENCE enrollment_enrollment_id_seq OWNED BY enrollment_enrollment.id;
...
CREATE TABLE enrollment_enrollment_special_diet (
    id integer NOT NULL,
    enrollment_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE enrollment_enrollment_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE enrollment_enrollment_special_diet_id_seq OWNED BY enrollment_enrollment_special_diet.id;
...
CREATE TABLE enrollment_enrollmenteventmeta (
    event_id integer NOT NULL,
...
CREATE TABLE enrollment_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE enrollment_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE enrollment_specialdiet_id_seq OWNED BY enrollment_specialdiet.id;
...
CREATE SEQUENCE event_log_entry_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE event_log_entry_id_seq OWNED BY event_log_entry.id;
...
CREATE TABLE event_log_subscription (
    id integer NOT NULL,
    entry_type character varying(255) NOT NULL,
...
CREATE SEQUENCE event_log_subscription_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE event_log_subscription_id_seq OWNED BY event_log_subscription.id;
...
CREATE TABLE feedback_feedbackmessage (
    id integer NOT NULL,
    context character varying(1024) NOT NULL,
...
CREATE SEQUENCE feedback_feedbackmessage_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE feedback_feedbackmessage_id_seq OWNED BY feedback_feedbackmessage.id;
...
CREATE TABLE finncon2016_signupextra (
    signup_id integer NOT NULL,
    shift_type character varying(15) NOT NULL,
    total_work character varying(15) NOT NULL,
    special_diet_other text NOT NULL,
...
CREATE TABLE finncon2016_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE finncon2016_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE finncon2016_signupextra_special_diet_id_seq OWNED BY finncon2016_signupextra_special_diet.id;
...
CREATE TABLE finncon2016_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE finncon2016_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE finncon2016_specialdiet_id_seq OWNED BY finncon2016_specialdiet.id;
...
CREATE TABLE frostbite2016_signupextra (
    signup_id integer NOT NULL,
    shift_type character varying(15) NOT NULL,
    desu_amount integer NOT NULL,
    prior_experience text NOT NULL,
...
CREATE TABLE frostbite2017_signupextra (
    id integer NOT NULL,
    is_active boolean NOT NULL,
    shift_type character varying(15) NOT NULL,
    desu_amount integer NOT NULL,
...
CREATE SEQUENCE frostbite2017_signupextra_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE frostbite2017_signupextra_id_seq OWNED BY frostbite2017_signupextra.id;
...
CREATE TABLE frostbite2017_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE frostbite2017_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE frostbite2017_signupextra_special_diet_id_seq OWNED BY frostbite2017_signupextra_special_diet.id;
...
CREATE TABLE frostbite2017_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE frostbite2017_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE frostbite2017_specialdiet_id_seq OWNED BY frostbite2017_specialdiet.id;
...
CREATE TABLE frostbite2018_signupextra (
    id integer NOT NULL,
    is_active boolean NOT NULL,
    shift_type character varying(15) NOT NULL,
    prior_experience text NOT NULL,
...
CREATE SEQUENCE frostbite2018_signupextra_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE frostbite2018_signupextra_id_seq OWNED BY frostbite2018_signupextra.id;
...
CREATE TABLE frostbite2018_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE frostbite2018_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE frostbite2018_signupextra_special_diet_id_seq OWNED BY frostbite2018_signupextra_special_diet.id;
...
CREATE TABLE frostbite2018_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE frostbite2018_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE frostbite2018_specialdiet_id_seq OWNED BY frostbite2018_specialdiet.id;
...
CREATE TABLE hitpoint2015_signupextra (
    signup_id integer NOT NULL,
    shift_type character varying(15) NOT NULL,
    total_work character varying(15) NOT NULL,
...
CREATE TABLE hitpoint2015_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE hitpoint2015_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE hitpoint2015_signupextra_special_diet_id_seq OWNED BY hitpoint2015_signupextra_special_diet.id;
...
CREATE TABLE hitpoint2015_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE hitpoint2015_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE hitpoint2015_specialdiet_id_seq OWNED BY hitpoint2015_specialdiet.id;
...
CREATE TABLE hitpoint2017_signupextra (
    signup_id integer NOT NULL,
    shift_type character varying(15) NOT NULL,
    total_work character varying(15) NOT NULL,
    night_work character varying(5) NOT NULL,
...
CREATE TABLE hitpoint2017_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE hitpoint2017_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE hitpoint2017_signupextra_special_diet_id_seq OWNED BY hitpoint2017_signupextra_special_diet.id;
...
CREATE TABLE hitpoint2017_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE hitpoint2017_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE hitpoint2017_specialdiet_id_seq OWNED BY hitpoint2017_specialdiet.id;
...
CREATE TABLE hitpoint2017_timeslot (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE hitpoint2017_timeslot_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE hitpoint2017_timeslot_id_seq OWNED BY hitpoint2017_timeslot.id;
...
CREATE TABLE intra_intraeventmeta (
    event_id integer NOT NULL,
    admin_group_id integer NOT NULL,
...
CREATE SEQUENCE intra_team_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE intra_team_id_seq OWNED BY intra_team.id;
...
CREATE SEQUENCE intra_teammember_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE intra_teammember_id_seq OWNED BY intra_teammember.id;
...
CREATE TABLE kawacon2016_night (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE kawacon2016_night_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kawacon2016_night_id_seq OWNED BY kawacon2016_night.id;
...
CREATE TABLE kawacon2016_signupextra (
    signup_id integer NOT NULL,
    shirt_size character varying(8) NOT NULL,
    special_diet_other text NOT NULL,
    prior_experience text NOT NULL,
...
CREATE TABLE kawacon2016_signupextra_needs_lodging (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    night_id integer NOT NULL
);
...
CREATE SEQUENCE kawacon2016_signupextra_needs_lodging_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kawacon2016_signupextra_needs_lodging_id_seq OWNED BY kawacon2016_signupextra_needs_lodging.id;
...
CREATE TABLE kawacon2016_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE kawacon2016_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kawacon2016_signupextra_special_diet_id_seq OWNED BY kawacon2016_signupextra_special_diet.id;
...
CREATE TABLE kawacon2016_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE kawacon2016_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kawacon2016_specialdiet_id_seq OWNED BY kawacon2016_specialdiet.id;
...
CREATE TABLE kawacon2017_night (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE kawacon2017_night_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kawacon2017_night_id_seq OWNED BY kawacon2017_night.id;
...
CREATE TABLE kawacon2017_shift (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE kawacon2017_shift_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kawacon2017_shift_id_seq OWNED BY kawacon2017_shift.id;
...
CREATE TABLE kawacon2017_signupextra (
    id integer NOT NULL,
    is_active boolean NOT NULL,
    shirt_size character varying(8) NOT NULL,
    special_diet_other text NOT NULL,
...
CREATE SEQUENCE kawacon2017_signupextra_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kawacon2017_signupextra_id_seq OWNED BY kawacon2017_signupextra.id;
...
CREATE TABLE kawacon2017_signupextra_needs_lodging (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    night_id integer NOT NULL
);
...
CREATE SEQUENCE kawacon2017_signupextra_needs_lodging_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kawacon2017_signupextra_needs_lodging_id_seq OWNED BY kawacon2017_signupextra_needs_lodging.id;
...
CREATE TABLE kawacon2017_signupextra_shifts (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
...
CREATE SEQUENCE kawacon2017_signupextra_shifts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kawacon2017_signupextra_shifts_id_seq OWNED BY kawacon2017_signupextra_shifts.id;
...
CREATE TABLE kawacon2017_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE kawacon2017_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kawacon2017_signupextra_special_diet_id_seq OWNED BY kawacon2017_signupextra_special_diet.id;
...
CREATE TABLE kawacon2017_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE kawacon2017_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kawacon2017_specialdiet_id_seq OWNED BY kawacon2017_specialdiet.id;
...
CREATE TABLE kuplii2015_signupextra (
    signup_id integer NOT NULL,
    shift_type character varying(15) NOT NULL,
    total_work character varying(15) NOT NULL,
    special_diet_other text NOT NULL,
...
CREATE TABLE kuplii2015_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE kuplii2015_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kuplii2015_signupextra_special_diet_id_seq OWNED BY kuplii2015_signupextra_special_diet.id;
...
CREATE TABLE kuplii2015_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE kuplii2015_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kuplii2015_specialdiet_id_seq OWNED BY kuplii2015_specialdiet.id;
...
CREATE TABLE kuplii2016_signupextra (
    signup_id integer NOT NULL,
    shift_type character varying(15) NOT NULL,
    total_work character varying(15) NOT NULL,
    special_diet_other text NOT NULL,
...
CREATE TABLE kuplii2016_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE kuplii2016_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kuplii2016_signupextra_special_diet_id_seq OWNED BY kuplii2016_signupextra_special_diet.id;
...
CREATE TABLE kuplii2016_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE kuplii2016_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kuplii2016_specialdiet_id_seq OWNED BY kuplii2016_specialdiet.id;
...
CREATE TABLE kuplii2017_signupextra (
    id integer NOT NULL,
    is_active boolean NOT NULL,
    shift_type character varying(15) NOT NULL,
    total_work character varying(15) NOT NULL,
...
CREATE SEQUENCE kuplii2017_signupextra_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kuplii2017_signupextra_id_seq OWNED BY kuplii2017_signupextra.id;
...
CREATE TABLE kuplii2017_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE kuplii2017_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kuplii2017_signupextra_special_diet_id_seq OWNED BY kuplii2017_signupextra_special_diet.id;
...
CREATE TABLE kuplii2017_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE kuplii2017_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kuplii2017_specialdiet_id_seq OWNED BY kuplii2017_specialdiet.id;
...
CREATE TABLE kuplii2018_signupextra (
    id integer NOT NULL,
    is_active boolean NOT NULL,
    shift_type character varying(15) NOT NULL,
    total_work character varying(15) NOT NULL,
...
CREATE SEQUENCE kuplii2018_signupextra_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kuplii2018_signupextra_id_seq OWNED BY kuplii2018_signupextra.id;
...
CREATE TABLE kuplii2018_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE kuplii2018_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kuplii2018_signupextra_special_diet_id_seq OWNED BY kuplii2018_signupextra_special_diet.id;
...
CREATE TABLE kuplii2018_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE kuplii2018_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE kuplii2018_specialdiet_id_seq OWNED BY kuplii2018_specialdiet.id;
...
CREATE TABLE labour_alternativesignupform (
    id integer NOT NULL,
    slug character varying(255) NOT NULL,
...
CREATE SEQUENCE labour_alternativesignupform_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_alternativesignupform_id_seq OWNED BY labour_alternativesignupform.id;
...
CREATE TABLE labour_common_qualifications_jvkortti (
...
CREATE TABLE labour_emptysignupextra (
    id integer NOT NULL,
    event_id integer NOT NULL,
    person_id integer NOT NULL,
    is_active boolean NOT NULL
...
CREATE SEQUENCE labour_emptysignupextra_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_emptysignupextra_id_seq OWNED BY labour_emptysignupextra.id;
...
CREATE SEQUENCE labour_infolink_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_infolink_id_seq OWNED BY labour_infolink.id;
...
CREATE SEQUENCE labour_job_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_job_id_seq OWNED BY labour_job.id;
...
CREATE TABLE labour_jobcategory (
    id integer NOT NULL,
    name character varying(63) NOT NULL,
    slug character varying(255) NOT NULL,
    description text NOT NULL,
...
CREATE SEQUENCE labour_jobcategory_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_jobcategory_id_seq OWNED BY labour_jobcategory.id;
...
CREATE TABLE labour_jobcategory_personnel_classes (
    id integer NOT NULL,
...
CREATE SEQUENCE labour_jobcategory_personnel_classes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_jobcategory_personnel_classes_id_seq OWNED BY labour_jobcategory_personnel_classes.id;
...
CREATE TABLE labour_jobcategory_required_qualifications (
    id integer NOT NULL,
    jobcategory_id integer NOT NULL,
...
CREATE SEQUENCE labour_jobcategory_required_qualifications_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_jobcategory_required_qualifications_id_seq OWNED BY labour_jobcategory_required_qualifications.id;
...
CREATE TABLE labour_jobrequirement (
    id integer NOT NULL,
...
CREATE SEQUENCE labour_jobrequirement_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_jobrequirement_id_seq OWNED BY labour_jobrequirement.id;
...
CREATE TABLE labour_laboureventmeta (
    event_id integer NOT NULL,
...
CREATE TABLE labour_obsoleteemptysignupextrav1 (
    signup_id integer NOT NULL,
    is_active boolean NOT NULL
);
...
CREATE SEQUENCE labour_perk_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_perk_id_seq OWNED BY labour_perk.id;
...
CREATE TABLE labour_personnelclass (
    id integer NOT NULL,
    app_label character varying(63) NOT NULL,
    name character varying(63) NOT NULL,
    slug character varying(255) NOT NULL,
...
CREATE SEQUENCE labour_personnelclass_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_personnelclass_id_seq OWNED BY labour_personnelclass.id;
...
CREATE TABLE labour_personnelclass_perks (
    id integer NOT NULL,
    personnelclass_id integer NOT NULL,
...
CREATE SEQUENCE labour_personnelclass_perks_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_personnelclass_perks_id_seq OWNED BY labour_personnelclass_perks.id;
...
CREATE TABLE labour_personqualification (
    id integer NOT NULL,
    person_id integer NOT NULL,
    qualification_id integer NOT NULL
);
...
CREATE SEQUENCE labour_personqualification_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_personqualification_id_seq OWNED BY labour_personqualification.id;
...
CREATE TABLE labour_qualification (
    id integer NOT NULL,
    slug character varying(255) NOT NULL,
    name character varying(63) NOT NULL,
    description text NOT NULL,
...
CREATE SEQUENCE labour_qualification_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_qualification_id_seq OWNED BY labour_qualification.id;
...
CREATE SEQUENCE labour_shift_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_shift_id_seq OWNED BY labour_shift.id;
...
CREATE SEQUENCE labour_signup_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_signup_id_seq OWNED BY labour_signup.id;
...
CREATE TABLE labour_signup_job_categories (
    id integer NOT NULL,
    signup_id integer NOT NULL,
    jobcategory_id integer NOT NULL
);
...
CREATE TABLE labour_signup_job_categories_accepted (
    id integer NOT NULL,
    signup_id integer NOT NULL,
    jobcategory_id integer NOT NULL
);
...
CREATE SEQUENCE labour_signup_job_categories_accepted_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_signup_job_categories_accepted_id_seq OWNED BY labour_signup_job_categories_accepted.id;
...
CREATE SEQUENCE labour_signup_job_categories_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_signup_job_categories_id_seq OWNED BY labour_signup_job_categories.id;
...
CREATE TABLE labour_signup_job_categories_rejected (
    id integer NOT NULL,
    signup_id integer NOT NULL,
    jobcategory_id integer NOT NULL
);
...
CREATE SEQUENCE labour_signup_job_categories_rejected_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_signup_job_categories_rejected_id_seq OWNED BY labour_signup_job_categories_rejected.id;
...
CREATE TABLE labour_signup_personnel_classes (
    id integer NOT NULL,
    signup_id integer NOT NULL,
    personnelclass_id integer NOT NULL
);
...
CREATE SEQUENCE labour_signup_personnel_classes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_signup_personnel_classes_id_seq OWNED BY labour_signup_personnel_classes.id;
...
CREATE SEQUENCE labour_survey_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_survey_id_seq OWNED BY labour_survey.id;
...
CREATE TABLE labour_surveyrecord (
    id integer NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL,
    person_id integer NOT NULL,
...
CREATE SEQUENCE labour_surveyrecord_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_surveyrecord_id_seq OWNED BY labour_surveyrecord.id;
...
CREATE TABLE labour_workperiod (
    id integer NOT NULL,
...
CREATE SEQUENCE labour_workperiod_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE labour_workperiod_id_seq OWNED BY labour_workperiod.id;
...
CREATE TABLE lakeuscon2016_signupextra (
    signup_id integer NOT NULL,
    shift_type character varying(15) NOT NULL,
    shirt_size character varying(8) NOT NULL,
    special_diet_other text NOT NULL,
...
CREATE TABLE lakeuscon2016_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE lakeuscon2016_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE lakeuscon2016_signupextra_special_diet_id_seq OWNED BY lakeuscon2016_signupextra_special_diet.id;
...
CREATE TABLE lakeuscon2016_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE lakeuscon2016_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE lakeuscon2016_specialdiet_id_seq OWNED BY lakeuscon2016_specialdiet.id;
...
CREATE SEQUENCE lippukala_code_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE lippukala_code_id_seq OWNED BY lippukala_code.id;
...
CREATE SEQUENCE lippukala_order_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE lippukala_order_id_seq OWNED BY lippukala_order.id;
...
CREATE SEQUENCE mailings_message_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE mailings_message_id_seq OWNED BY mailings_message.id;
...
CREATE TABLE mailings_personmessage (
    id integer NOT NULL,
    created_at timestamp with time zone NOT NULL,
...
CREATE SEQUENCE mailings_personmessage_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE mailings_personmessage_id_seq OWNED BY mailings_personmessage.id;
...
CREATE TABLE mailings_personmessagebody (
    id integer NOT NULL,
...
CREATE SEQUENCE mailings_personmessagebody_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE mailings_personmessagebody_id_seq OWNED BY mailings_personmessagebody.id;
...
CREATE TABLE mailings_personmessagesubject (
    id integer NOT NULL,
    digest character varying(63) NOT NULL,
...
CREATE SEQUENCE mailings_personmessagesubject_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE mailings_personmessagesubject_id_seq OWNED BY mailings_personmessagesubject.id;
...
CREATE TABLE mailings_recipientgroup (
    id integer NOT NULL,
    app_label character varying(63) NOT NULL,
...
CREATE SEQUENCE mailings_recipientgroup_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE mailings_recipientgroup_id_seq OWNED BY mailings_recipientgroup.id;
...
CREATE TABLE membership_membershipfeepayment (
    id integer NOT NULL,
...
CREATE SEQUENCE membership_membershipfeepayment_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE membership_membershipfeepayment_id_seq OWNED BY membership_membershipfeepayment.id;
...
CREATE TABLE membership_membershiporganizationmeta (
    organization_id integer NOT NULL,
    admin_group_id integer NOT NULL,
...
CREATE SEQUENCE membership_term_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE membership_term_id_seq OWNED BY membership_term.id;
...
CREATE TABLE mimicon2016_night (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE mimicon2016_night_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE mimicon2016_night_id_seq OWNED BY mimicon2016_night.id;
...
CREATE TABLE mimicon2016_signupextra (
    signup_id integer NOT NULL,
    shift_type character varying(15) NOT NULL,
    total_work character varying(15) NOT NULL,
    construction boolean NOT NULL,
...
CREATE TABLE mimicon2016_signupextra_lodging_needs (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    night_id integer NOT NULL
);
...
CREATE SEQUENCE mimicon2016_signupextra_lodging_needs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE mimicon2016_signupextra_lodging_needs_id_seq OWNED BY mimicon2016_signupextra_lodging_needs.id;
...
CREATE TABLE mimicon2016_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE mimicon2016_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE mimicon2016_signupextra_special_diet_id_seq OWNED BY mimicon2016_signupextra_special_diet.id;
...
CREATE TABLE mimicon2016_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE mimicon2016_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE mimicon2016_specialdiet_id_seq OWNED BY mimicon2016_specialdiet.id;
...
CREATE TABLE nexmo_deliverystatusfragment (
    id integer NOT NULL,
...
CREATE SEQUENCE nexmo_deliverystatusfragment_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE nexmo_deliverystatusfragment_id_seq OWNED BY nexmo_deliverystatusfragment.id;
...
CREATE TABLE nexmo_inboundmessage (
    id integer NOT NULL,
    nexmo_message_id character varying(255) NOT NULL,
...
CREATE SEQUENCE nexmo_inboundmessage_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE nexmo_inboundmessage_id_seq OWNED BY nexmo_inboundmessage.id;
...
CREATE TABLE nexmo_inboundmessagefragment (
    id integer NOT NULL,
    nexmo_message_id character varying(255) NOT NULL,
    sender character varying(255) NOT NULL,
    nexmo_timestamp timestamp with time zone,
...
CREATE SEQUENCE nexmo_inboundmessagefragment_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE nexmo_inboundmessagefragment_id_seq OWNED BY nexmo_inboundmessagefragment.id;
...
CREATE TABLE nexmo_outboundmessage (
    id integer NOT NULL,
    message text NOT NULL,
...
CREATE SEQUENCE nexmo_outboundmessage_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE nexmo_outboundmessage_id_seq OWNED BY nexmo_outboundmessage.id;
...
CREATE TABLE nippori2017_signupextra (
    id integer NOT NULL,
    is_active boolean NOT NULL,
    prior_experience text NOT NULL,
    shift_wishes text NOT NULL,
...
CREATE SEQUENCE nippori2017_signupextra_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE nippori2017_signupextra_id_seq OWNED BY nippori2017_signupextra.id;
...
CREATE TABLE payments_paymentseventmeta (
    event_id integer NOT NULL,
...
CREATE TABLE popcult2017_signupextra (
    id integer NOT NULL,
    is_active boolean NOT NULL,
    want_certificate boolean NOT NULL,
    special_diet_other text NOT NULL,
...
CREATE SEQUENCE popcult2017_signupextra_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE popcult2017_signupextra_id_seq OWNED BY popcult2017_signupextra.id;
...
CREATE TABLE popcult2017_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE popcult2017_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE popcult2017_signupextra_special_diet_id_seq OWNED BY popcult2017_signupextra_special_diet.id;
...
CREATE TABLE programme_alternativeprogrammeform (
    id integer NOT NULL,
    slug character varying(255) NOT NULL,
    title character varying(63) NOT NULL,
    description text,
...
CREATE SEQUENCE programme_alternativeprogrammeform_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE programme_alternativeprogrammeform_id_seq OWNED BY programme_alternativeprogrammeform.id;
...
CREATE SEQUENCE programme_category_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE programme_category_id_seq OWNED BY programme_category.id;
...
CREATE TABLE programme_freeformorganizer (
    id integer NOT NULL,
    text character varying(255) NOT NULL,
...
CREATE SEQUENCE programme_freeformorganizer_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE programme_freeformorganizer_id_seq OWNED BY programme_freeformorganizer.id;
...
CREATE TABLE programme_invitation (
    id integer NOT NULL,
    email character varying(255) NOT NULL,
    programme_id integer NOT NULL,
...
CREATE SEQUENCE programme_invitation_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE programme_invitation_id_seq OWNED BY programme_invitation.id;
...
CREATE TABLE programme_programme (
    id integer NOT NULL,
    title character varying(1023) NOT NULL,
    description text NOT NULL,
...
CREATE TABLE programme_programme_hitpoint2017_preferred_time_slots (
    id integer NOT NULL,
    programme_id integer NOT NULL,
...
CREATE SEQUENCE programme_programme_hitpoint2017_preferred_time_slots_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE programme_programme_hitpoint2017_preferred_time_slots_id_seq OWNED BY programme_programme_hitpoint2017_preferred_time_slots.id;
...
CREATE SEQUENCE programme_programme_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE programme_programme_id_seq OWNED BY programme_programme.id;
...
CREATE TABLE programme_programme_tags (
    id integer NOT NULL,
    programme_id integer NOT NULL,
...
CREATE SEQUENCE programme_programme_tags_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE programme_programme_tags_id_seq OWNED BY programme_programme_tags.id;
...
CREATE TABLE programme_programmeeventmeta (
    event_id integer NOT NULL,
    contact_email character varying(255) NOT NULL,
    admin_group_id integer NOT NULL,
...
CREATE TABLE programme_programmefeedback (
    id integer NOT NULL,
    author_ip_address character varying(48) NOT NULL,
...
CREATE SEQUENCE programme_programmefeedback_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE programme_programmefeedback_id_seq OWNED BY programme_programmefeedback.id;
...
CREATE TABLE programme_programmerole (
    id integer NOT NULL,
    person_id integer NOT NULL,
    programme_id integer NOT NULL,
    role_id integer NOT NULL,
...
CREATE SEQUENCE programme_programmerole_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE programme_programmerole_id_seq OWNED BY programme_programmerole.id;
...
CREATE SEQUENCE programme_role_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE programme_role_id_seq OWNED BY programme_role.id;
...
CREATE SEQUENCE programme_room_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE programme_room_id_seq OWNED BY programme_room.id;
...
CREATE TABLE programme_specialstarttime (
    id integer NOT NULL,
    start_time timestamp with time zone NOT NULL,
    event_id integer NOT NULL
);
...
CREATE SEQUENCE programme_specialstarttime_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE programme_specialstarttime_id_seq OWNED BY programme_specialstarttime.id;
...
CREATE SEQUENCE programme_tag_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE programme_tag_id_seq OWNED BY programme_tag.id;
...
CREATE TABLE programme_timeblock (
    id integer NOT NULL,
    start_time timestamp with time zone NOT NULL,
    end_time timestamp with time zone NOT NULL,
    event_id integer NOT NULL
...
CREATE SEQUENCE programme_timeblock_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE programme_timeblock_id_seq OWNED BY programme_timeblock.id;
...
CREATE SEQUENCE programme_view_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE programme_view_id_seq OWNED BY programme_view.id;


--
-- Name: programme_view_rooms; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE programme_view_rooms (
    id integer NOT NULL,
...
--
-- Name: programme_view_rooms_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE programme_view_rooms_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: programme_view_rooms_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE programme_view_rooms_id_seq OWNED BY programme_view_rooms.id;
...
CREATE TABLE shippocon2016_signupextra (
    id integer NOT NULL,
    is_active boolean NOT NULL,
    special_diet_other text NOT NULL,
    total_work character varying(15) NOT NULL,
...
CREATE SEQUENCE shippocon2016_signupextra_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE shippocon2016_signupextra_id_seq OWNED BY shippocon2016_signupextra.id;
...
CREATE TABLE shippocon2016_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE shippocon2016_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE shippocon2016_signupextra_special_diet_id_seq OWNED BY shippocon2016_signupextra_special_diet.id;
...
CREATE TABLE shippocon2016_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE shippocon2016_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE shippocon2016_specialdiet_id_seq OWNED BY shippocon2016_specialdiet.id;
...
CREATE SEQUENCE sms_hotword_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE sms_hotword_id_seq OWNED BY sms_hotword.id;
...
CREATE TABLE sms_nominee_category (
    id integer NOT NULL,
...
CREATE SEQUENCE sms_nominee_category_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE sms_nominee_category_id_seq OWNED BY sms_nominee_category.id;
...
CREATE SEQUENCE sms_nominee_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE sms_nominee_id_seq OWNED BY sms_nominee.id;
...
CREATE SEQUENCE sms_smsmessagein_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE sms_smsmessagein_id_seq OWNED BY sms_smsmessagein.id;
...
CREATE TABLE sms_smsmessageout (
    id integer NOT NULL,
    message text NOT NULL,
...
CREATE SEQUENCE sms_smsmessageout_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE sms_smsmessageout_id_seq OWNED BY sms_smsmessageout.id;
...
CREATE SEQUENCE sms_vote_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE sms_vote_id_seq OWNED BY sms_vote.id;
...
CREATE SEQUENCE sms_votecategory_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE sms_votecategory_id_seq OWNED BY sms_votecategory.id;
...
CREATE TABLE surveys_eventsurvey (
    id integer NOT NULL,
    title character varying(255) NOT NULL,
    description text NOT NULL,
    is_active boolean NOT NULL,
...
CREATE SEQUENCE surveys_eventsurvey_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE surveys_eventsurvey_id_seq OWNED BY surveys_eventsurvey.id;
...
CREATE TABLE surveys_eventsurveyresult (
    id integer NOT NULL,
    created_at timestamp with time zone NOT NULL,
    model jsonb NOT NULL,
    author_ip_address character varying(48) NOT NULL,
...
CREATE SEQUENCE surveys_eventsurveyresult_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE surveys_eventsurveyresult_id_seq OWNED BY surveys_eventsurveyresult.id;
...
CREATE TABLE surveys_globalsurvey (
    id integer NOT NULL,
    title character varying(255) NOT NULL,
    description text NOT NULL,
    is_active boolean NOT NULL,
...
CREATE SEQUENCE surveys_globalsurvey_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE surveys_globalsurvey_id_seq OWNED BY surveys_globalsurvey.id;
...
CREATE TABLE surveys_globalsurveyresult (
    id integer NOT NULL,
    created_at timestamp with time zone NOT NULL,
    model jsonb NOT NULL,
    author_ip_address character varying(48) NOT NULL,
...
CREATE SEQUENCE surveys_globalsurveyresult_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE surveys_globalsurveyresult_id_seq OWNED BY surveys_globalsurveyresult.id;
...
CREATE TABLE tickets_accommodationinformation (
    id integer NOT NULL,
...
CREATE SEQUENCE tickets_accommodationinformation_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tickets_accommodationinformation_id_seq OWNED BY tickets_accommodationinformation.id;
...
CREATE TABLE tickets_accommodationinformation_limit_groups (
    id integer NOT NULL,
...
CREATE SEQUENCE tickets_accommodationinformation_limit_groups_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tickets_accommodationinformation_limit_groups_id_seq OWNED BY tickets_accommodationinformation_limit_groups.id;
...
CREATE SEQUENCE tickets_batch_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tickets_batch_id_seq OWNED BY tickets_batch.id;
...
CREATE SEQUENCE tickets_customer_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tickets_customer_id_seq OWNED BY tickets_customer.id;
...
CREATE TABLE tickets_limitgroup (
    id integer NOT NULL,
...
CREATE SEQUENCE tickets_limitgroup_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tickets_limitgroup_id_seq OWNED BY tickets_limitgroup.id;
...
CREATE SEQUENCE tickets_order_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tickets_order_id_seq OWNED BY tickets_order.id;
...
CREATE TABLE tickets_orderproduct (
    id integer NOT NULL,
    count integer NOT NULL,
    order_id integer NOT NULL,
...
CREATE SEQUENCE tickets_orderproduct_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tickets_orderproduct_id_seq OWNED BY tickets_orderproduct.id;
...
CREATE SEQUENCE tickets_product_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tickets_product_id_seq OWNED BY tickets_product.id;
...
CREATE TABLE tickets_product_limit_groups (
    id integer NOT NULL,
    product_id integer NOT NULL,
    limitgroup_id integer NOT NULL
);
...
CREATE SEQUENCE tickets_product_limit_groups_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tickets_product_limit_groups_id_seq OWNED BY tickets_product_limit_groups.id;
...
CREATE TABLE tickets_shirtorder (
    id integer NOT NULL,
    count integer NOT NULL,
    order_id integer NOT NULL,
...
CREATE SEQUENCE tickets_shirtorder_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tickets_shirtorder_id_seq OWNED BY tickets_shirtorder.id;
...
CREATE TABLE tickets_shirtsize (
    id integer NOT NULL,
    name character varying(255) NOT NULL,
    slug character varying(255) NOT NULL,
    available boolean NOT NULL,
...
CREATE SEQUENCE tickets_shirtsize_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tickets_shirtsize_id_seq OWNED BY tickets_shirtsize.id;
...
CREATE TABLE tickets_shirttype (
    id integer NOT NULL,
    name character varying(255) NOT NULL,
    slug character varying(255) NOT NULL,
    available boolean NOT NULL,
...
CREATE SEQUENCE tickets_shirttype_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tickets_shirttype_id_seq OWNED BY tickets_shirttype.id;
...
CREATE TABLE tickets_ticketseventmeta (
    event_id integer NOT NULL,
...
CREATE SEQUENCE tracon11_night_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon11_night_id_seq OWNED BY tracon11_night.id;
...
CREATE TABLE tracon11_signupextra (
    signup_id integer NOT NULL,
    shift_type character varying(15) NOT NULL,
    total_work character varying(15) NOT NULL,
    overseer boolean NOT NULL,
...
CREATE TABLE tracon11_signupextra_lodging_needs (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    night_id integer NOT NULL
);
...
CREATE SEQUENCE tracon11_signupextra_lodging_needs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon11_signupextra_lodging_needs_id_seq OWNED BY tracon11_signupextra_lodging_needs.id;
...
CREATE TABLE tracon11_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE tracon11_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon11_signupextra_special_diet_id_seq OWNED BY tracon11_signupextra_special_diet.id;
...
CREATE TABLE tracon11_signupextrav2 (
    id integer NOT NULL,
    is_active boolean NOT NULL,
    shift_type character varying(15) NOT NULL,
    total_work character varying(15) NOT NULL,
...
CREATE SEQUENCE tracon11_signupextrav2_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon11_signupextrav2_id_seq OWNED BY tracon11_signupextrav2.id;
...
CREATE TABLE tracon11_signupextrav2_lodging_needs (
    id integer NOT NULL,
    signupextrav2_id integer NOT NULL,
    night_id integer NOT NULL
);
...
CREATE SEQUENCE tracon11_signupextrav2_lodging_needs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon11_signupextrav2_lodging_needs_id_seq OWNED BY tracon11_signupextrav2_lodging_needs.id;
...
CREATE TABLE tracon11_signupextrav2_special_diet (
    id integer NOT NULL,
    signupextrav2_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE tracon11_signupextrav2_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon11_signupextrav2_special_diet_id_seq OWNED BY tracon11_signupextrav2_special_diet.id;
...
CREATE TABLE tracon11_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE tracon11_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon11_specialdiet_id_seq OWNED BY tracon11_specialdiet.id;
...
CREATE SEQUENCE tracon2017_night_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon2017_night_id_seq OWNED BY tracon2017_night.id;
...
CREATE TABLE tracon2017_poison (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE tracon2017_poison_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon2017_poison_id_seq OWNED BY tracon2017_poison.id;
...
CREATE TABLE tracon2017_signupextra (
    id integer NOT NULL,
    is_active boolean NOT NULL,
    shift_type character varying(15) NOT NULL,
    total_work character varying(15) NOT NULL,
...
CREATE SEQUENCE tracon2017_signupextra_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon2017_signupextra_id_seq OWNED BY tracon2017_signupextra.id;
...
CREATE TABLE tracon2017_signupextra_lodging_needs (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    night_id integer NOT NULL
);
...
CREATE SEQUENCE tracon2017_signupextra_lodging_needs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon2017_signupextra_lodging_needs_id_seq OWNED BY tracon2017_signupextra_lodging_needs.id;
...
CREATE TABLE tracon2017_signupextra_pick_your_poison (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
...
CREATE SEQUENCE tracon2017_signupextra_pick_your_poison_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon2017_signupextra_pick_your_poison_id_seq OWNED BY tracon2017_signupextra_pick_your_poison.id;
...
CREATE TABLE tracon2017_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE tracon2017_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon2017_signupextra_special_diet_id_seq OWNED BY tracon2017_signupextra_special_diet.id;
...
CREATE SEQUENCE tracon2018_night_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon2018_night_id_seq OWNED BY tracon2018_night.id;
...
CREATE TABLE tracon2018_signupextra (
    id integer NOT NULL,
    is_active boolean NOT NULL,
    shift_type character varying(15) NOT NULL,
    total_work character varying(15) NOT NULL,
...
CREATE SEQUENCE tracon2018_signupextra_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon2018_signupextra_id_seq OWNED BY tracon2018_signupextra.id;
...
CREATE TABLE tracon2018_signupextra_lodging_needs (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    night_id integer NOT NULL
);
...
CREATE SEQUENCE tracon2018_signupextra_lodging_needs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon2018_signupextra_lodging_needs_id_seq OWNED BY tracon2018_signupextra_lodging_needs.id;
...
CREATE TABLE tracon2018_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE tracon2018_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon2018_signupextra_special_diet_id_seq OWNED BY tracon2018_signupextra_special_diet.id;
...
CREATE SEQUENCE tracon9_night_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon9_night_id_seq OWNED BY tracon9_night.id;
...
CREATE TABLE tracon9_signupextra (
    signup_id integer NOT NULL,
    shift_type character varying(15) NOT NULL,
    total_work character varying(15) NOT NULL,
    construction boolean NOT NULL,
...
CREATE TABLE tracon9_signupextra_lodging_needs (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    night_id integer NOT NULL
);
...
CREATE SEQUENCE tracon9_signupextra_lodging_needs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon9_signupextra_lodging_needs_id_seq OWNED BY tracon9_signupextra_lodging_needs.id;
...
CREATE TABLE tracon9_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE tracon9_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon9_signupextra_special_diet_id_seq OWNED BY tracon9_signupextra_special_diet.id;
...
CREATE TABLE tracon9_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE tracon9_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tracon9_specialdiet_id_seq OWNED BY tracon9_specialdiet.id;
...
CREATE SEQUENCE traconx_night_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE traconx_night_id_seq OWNED BY traconx_night.id;
...
CREATE TABLE traconx_signupextra (
    signup_id integer NOT NULL,
    shift_type character varying(15) NOT NULL,
    total_work character varying(15) NOT NULL,
    overseer boolean NOT NULL,
...
CREATE TABLE traconx_signupextra_lodging_needs (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    night_id integer NOT NULL
);
...
CREATE SEQUENCE traconx_signupextra_lodging_needs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE traconx_signupextra_lodging_needs_id_seq OWNED BY traconx_signupextra_lodging_needs.id;
...
CREATE TABLE traconx_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE traconx_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE traconx_signupextra_special_diet_id_seq OWNED BY traconx_signupextra_special_diet.id;
...
CREATE TABLE traconx_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE traconx_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE traconx_specialdiet_id_seq OWNED BY traconx_specialdiet.id;
...
CREATE TABLE tylycon2017_signupextra (
    id integer NOT NULL,
    is_active boolean NOT NULL,
    shift_type character varying(15) NOT NULL,
    total_work character varying(15) NOT NULL,
...
CREATE SEQUENCE tylycon2017_signupextra_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tylycon2017_signupextra_id_seq OWNED BY tylycon2017_signupextra.id;
...
CREATE TABLE tylycon2017_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE tylycon2017_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tylycon2017_signupextra_special_diet_id_seq OWNED BY tylycon2017_signupextra_special_diet.id;
...
CREATE TABLE tylycon2017_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE tylycon2017_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE tylycon2017_specialdiet_id_seq OWNED BY tylycon2017_specialdiet.id;
...
CREATE TABLE worldcon75_signupextra (
    id integer NOT NULL,
    is_active boolean NOT NULL,
    special_diet_other text NOT NULL,
    shift_wishes text NOT NULL,
...
CREATE SEQUENCE worldcon75_signupextra_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE worldcon75_signupextra_id_seq OWNED BY worldcon75_signupextra.id;
...
CREATE TABLE worldcon75_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE worldcon75_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE worldcon75_signupextra_special_diet_id_seq OWNED BY worldcon75_signupextra_special_diet.id;
...
CREATE TABLE yukicon2016_signupextra (
    signup_id integer NOT NULL,
    shift_type character varying(15) NOT NULL,
    total_work character varying(15) NOT NULL,
    construction boolean NOT NULL,
...
CREATE TABLE yukicon2016_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE yukicon2016_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE yukicon2016_signupextra_special_diet_id_seq OWNED BY yukicon2016_signupextra_special_diet.id;
...
CREATE TABLE yukicon2016_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE yukicon2016_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE yukicon2016_specialdiet_id_seq OWNED BY yukicon2016_specialdiet.id;
...
CREATE TABLE yukicon2017_eventday (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE yukicon2017_eventday_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE yukicon2017_eventday_id_seq OWNED BY yukicon2017_eventday.id;
...
CREATE TABLE yukicon2017_signupextra (
    id integer NOT NULL,
    is_active boolean NOT NULL,
    shift_type character varying(15) NOT NULL,
    total_work character varying(15) NOT NULL,
...
CREATE SEQUENCE yukicon2017_signupextra_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE yukicon2017_signupextra_id_seq OWNED BY yukicon2017_signupextra.id;
...
CREATE TABLE yukicon2017_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE yukicon2017_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE yukicon2017_signupextra_special_diet_id_seq OWNED BY yukicon2017_signupextra_special_diet.id;
...
CREATE TABLE yukicon2017_signupextra_work_days (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
...
CREATE SEQUENCE yukicon2017_signupextra_work_days_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE yukicon2017_signupextra_work_days_id_seq OWNED BY yukicon2017_signupextra_work_days.id;
...
CREATE TABLE yukicon2017_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE yukicon2017_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE yukicon2017_specialdiet_id_seq OWNED BY yukicon2017_specialdiet.id;
...
CREATE TABLE yukicon2018_eventday (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE yukicon2018_eventday_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE yukicon2018_eventday_id_seq OWNED BY yukicon2018_eventday.id;
...
CREATE TABLE yukicon2018_signupextra (
    id integer NOT NULL,
    is_active boolean NOT NULL,
    shift_type character varying(15) NOT NULL,
    total_work character varying(15) NOT NULL,
...
CREATE SEQUENCE yukicon2018_signupextra_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE yukicon2018_signupextra_id_seq OWNED BY yukicon2018_signupextra.id;
...
CREATE TABLE yukicon2018_signupextra_special_diet (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    specialdiet_id integer NOT NULL
);
...
CREATE SEQUENCE yukicon2018_signupextra_special_diet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE yukicon2018_signupextra_special_diet_id_seq OWNED BY yukicon2018_signupextra_special_diet.id;
...
CREATE TABLE yukicon2018_signupextra_work_days (
    id integer NOT NULL,
    signupextra_id integer NOT NULL,
    eventday_id integer NOT NULL
);
...
CREATE SEQUENCE yukicon2018_signupextra_work_days_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE yukicon2018_signupextra_work_days_id_seq OWNED BY yukicon2018_signupextra_work_days.id;
...
CREATE TABLE yukicon2018_specialdiet (
    id integer NOT NULL,
    name character varying(63) NOT NULL
);
...
CREATE SEQUENCE yukicon2018_specialdiet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE yukicon2018_specialdiet_id_seq OWNED BY yukicon2018_specialdiet.id;
...
ALTER TABLE ONLY access_emailalias ALTER COLUMN id SET DEFAULT nextval('access_emailalias_id_seq'::regclass);
...
ALTER TABLE ONLY access_emailaliasdomain ALTER COLUMN id SET DEFAULT nextval('access_emailaliasdomain_id_seq'::regclass);
...
ALTER TABLE ONLY access_emailaliastype ALTER COLUMN id SET DEFAULT nextval('access_emailaliastype_id_seq'::regclass);
...
ALTER TABLE ONLY access_grantedprivilege ALTER COLUMN id SET DEFAULT nextval('access_grantedprivilege_id_seq'::regclass);
...
ALTER TABLE ONLY access_groupemailaliasgrant ALTER COLUMN id SET DEFAULT nextval('access_groupemailaliasgrant_id_seq'::regclass);
...
ALTER TABLE ONLY access_groupprivilege ALTER COLUMN id SET DEFAULT nextval('access_groupprivilege_id_seq'::regclass);
...
ALTER TABLE ONLY access_internalemailalias ALTER COLUMN id SET DEFAULT nextval('access_internalemailalias_id_seq'::regclass);
...
ALTER TABLE ONLY access_privilege ALTER COLUMN id SET DEFAULT nextval('access_privilege_id_seq'::regclass);
...
ALTER TABLE ONLY access_slackaccess ALTER COLUMN id SET DEFAULT nextval('access_slackaccess_id_seq'::regclass);
...
ALTER TABLE ONLY access_smtppassword ALTER COLUMN id SET DEFAULT nextval('access_smtppassword_id_seq'::regclass);
...
ALTER TABLE ONLY access_smtpserver ALTER COLUMN id SET DEFAULT nextval('access_smtpserver_id_seq'::regclass);
...
ALTER TABLE ONLY access_smtpserver_domains ALTER COLUMN id SET DEFAULT nextval('access_smtpserver_domains_id_seq'::regclass);
...
ALTER TABLE ONLY aicon2016_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('aicon2016_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY aicon2016_specialdiet ALTER COLUMN id SET DEFAULT nextval('aicon2016_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY animecon2015_night ALTER COLUMN id SET DEFAULT nextval('animecon2015_night_id_seq'::regclass);
...
ALTER TABLE ONLY animecon2015_signupextra_lodging_needs ALTER COLUMN id SET DEFAULT nextval('animecon2015_signupextra_lodging_needs_id_seq'::regclass);
...
ALTER TABLE ONLY animecon2015_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('animecon2015_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY animecon2015_specialdiet ALTER COLUMN id SET DEFAULT nextval('animecon2015_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY animecon2016_night ALTER COLUMN id SET DEFAULT nextval('animecon2016_night_id_seq'::regclass);
...
ALTER TABLE ONLY animecon2016_signupextra_lodging_needs ALTER COLUMN id SET DEFAULT nextval('animecon2016_signupextra_lodging_needs_id_seq'::regclass);
...
ALTER TABLE ONLY animecon2016_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('animecon2016_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY animecon2016_specialdiet ALTER COLUMN id SET DEFAULT nextval('animecon2016_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY badges_batch ALTER COLUMN id SET DEFAULT nextval('badges_batch_id_seq'::regclass);
...
ALTER TABLE ONLY core_carouselslide ALTER COLUMN id SET DEFAULT nextval('core_carouselslide_id_seq'::regclass);
...
ALTER TABLE ONLY core_emailverificationtoken ALTER COLUMN id SET DEFAULT nextval('core_emailverificationtoken_id_seq'::regclass);
...
ALTER TABLE ONLY core_organization ALTER COLUMN id SET DEFAULT nextval('core_organization_id_seq'::regclass);
...
ALTER TABLE ONLY core_passwordresettoken ALTER COLUMN id SET DEFAULT nextval('core_passwordresettoken_id_seq'::regclass);
...
ALTER TABLE ONLY core_person ALTER COLUMN id SET DEFAULT nextval('core_person_id_seq'::regclass);
...
ALTER TABLE ONLY core_venue ALTER COLUMN id SET DEFAULT nextval('core_venue_id_seq'::regclass);
...
ALTER TABLE ONLY desucon2016_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('desucon2016_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY desucon2016_signupextrav2 ALTER COLUMN id SET DEFAULT nextval('desucon2016_signupextrav2_id_seq'::regclass);
...
ALTER TABLE ONLY desucon2016_signupextrav2_special_diet ALTER COLUMN id SET DEFAULT nextval('desucon2016_signupextrav2_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY desucon2016_specialdiet ALTER COLUMN id SET DEFAULT nextval('desucon2016_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY desucon2017_signupextra ALTER COLUMN id SET DEFAULT nextval('desucon2017_signupextra_id_seq'::regclass);
...
ALTER TABLE ONLY desucon2017_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('desucon2017_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY desucon2017_specialdiet ALTER COLUMN id SET DEFAULT nextval('desucon2017_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY desuprofile_integration_confirmationcode ALTER COLUMN id SET DEFAULT nextval('desuprofile_integration_confirmationcode_id_seq'::regclass);
...
ALTER TABLE ONLY directory_directoryaccessgroup ALTER COLUMN id SET DEFAULT nextval('directory_directoryaccessgroup_id_seq'::regclass);
...
ALTER TABLE ONLY enrollment_conconpart ALTER COLUMN id SET DEFAULT nextval('enrollment_conconpart_id_seq'::regclass);
...
ALTER TABLE ONLY enrollment_enrollment ALTER COLUMN id SET DEFAULT nextval('enrollment_enrollment_id_seq'::regclass);
...
ALTER TABLE ONLY enrollment_enrollment_concon_parts ALTER COLUMN id SET DEFAULT nextval('enrollment_enrollment_concon_parts_id_seq'::regclass);
...
ALTER TABLE ONLY enrollment_enrollment_special_diet ALTER COLUMN id SET DEFAULT nextval('enrollment_enrollment_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY enrollment_specialdiet ALTER COLUMN id SET DEFAULT nextval('enrollment_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY event_log_entry ALTER COLUMN id SET DEFAULT nextval('event_log_entry_id_seq'::regclass);
...
ALTER TABLE ONLY event_log_subscription ALTER COLUMN id SET DEFAULT nextval('event_log_subscription_id_seq'::regclass);
...
ALTER TABLE ONLY feedback_feedbackmessage ALTER COLUMN id SET DEFAULT nextval('feedback_feedbackmessage_id_seq'::regclass);
...
ALTER TABLE ONLY finncon2016_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('finncon2016_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY finncon2016_specialdiet ALTER COLUMN id SET DEFAULT nextval('finncon2016_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY frostbite2017_signupextra ALTER COLUMN id SET DEFAULT nextval('frostbite2017_signupextra_id_seq'::regclass);
...
ALTER TABLE ONLY frostbite2017_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('frostbite2017_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY frostbite2017_specialdiet ALTER COLUMN id SET DEFAULT nextval('frostbite2017_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY frostbite2018_signupextra ALTER COLUMN id SET DEFAULT nextval('frostbite2018_signupextra_id_seq'::regclass);
...
ALTER TABLE ONLY frostbite2018_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('frostbite2018_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY frostbite2018_specialdiet ALTER COLUMN id SET DEFAULT nextval('frostbite2018_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY hitpoint2015_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('hitpoint2015_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY hitpoint2015_specialdiet ALTER COLUMN id SET DEFAULT nextval('hitpoint2015_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY hitpoint2017_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('hitpoint2017_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY hitpoint2017_specialdiet ALTER COLUMN id SET DEFAULT nextval('hitpoint2017_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY hitpoint2017_timeslot ALTER COLUMN id SET DEFAULT nextval('hitpoint2017_timeslot_id_seq'::regclass);
...
ALTER TABLE ONLY intra_team ALTER COLUMN id SET DEFAULT nextval('intra_team_id_seq'::regclass);
...
ALTER TABLE ONLY intra_teammember ALTER COLUMN id SET DEFAULT nextval('intra_teammember_id_seq'::regclass);
...
ALTER TABLE ONLY kawacon2016_night ALTER COLUMN id SET DEFAULT nextval('kawacon2016_night_id_seq'::regclass);
...
ALTER TABLE ONLY kawacon2016_signupextra_needs_lodging ALTER COLUMN id SET DEFAULT nextval('kawacon2016_signupextra_needs_lodging_id_seq'::regclass);
...
ALTER TABLE ONLY kawacon2016_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('kawacon2016_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY kawacon2016_specialdiet ALTER COLUMN id SET DEFAULT nextval('kawacon2016_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY kawacon2017_night ALTER COLUMN id SET DEFAULT nextval('kawacon2017_night_id_seq'::regclass);
...
ALTER TABLE ONLY kawacon2017_shift ALTER COLUMN id SET DEFAULT nextval('kawacon2017_shift_id_seq'::regclass);
...
ALTER TABLE ONLY kawacon2017_signupextra ALTER COLUMN id SET DEFAULT nextval('kawacon2017_signupextra_id_seq'::regclass);
...
ALTER TABLE ONLY kawacon2017_signupextra_needs_lodging ALTER COLUMN id SET DEFAULT nextval('kawacon2017_signupextra_needs_lodging_id_seq'::regclass);
...
ALTER TABLE ONLY kawacon2017_signupextra_shifts ALTER COLUMN id SET DEFAULT nextval('kawacon2017_signupextra_shifts_id_seq'::regclass);
...
ALTER TABLE ONLY kawacon2017_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('kawacon2017_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY kawacon2017_specialdiet ALTER COLUMN id SET DEFAULT nextval('kawacon2017_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY kuplii2015_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('kuplii2015_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY kuplii2015_specialdiet ALTER COLUMN id SET DEFAULT nextval('kuplii2015_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY kuplii2016_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('kuplii2016_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY kuplii2016_specialdiet ALTER COLUMN id SET DEFAULT nextval('kuplii2016_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY kuplii2017_signupextra ALTER COLUMN id SET DEFAULT nextval('kuplii2017_signupextra_id_seq'::regclass);
...
ALTER TABLE ONLY kuplii2017_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('kuplii2017_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY kuplii2017_specialdiet ALTER COLUMN id SET DEFAULT nextval('kuplii2017_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY kuplii2018_signupextra ALTER COLUMN id SET DEFAULT nextval('kuplii2018_signupextra_id_seq'::regclass);
...
ALTER TABLE ONLY kuplii2018_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('kuplii2018_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY kuplii2018_specialdiet ALTER COLUMN id SET DEFAULT nextval('kuplii2018_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY labour_alternativesignupform ALTER COLUMN id SET DEFAULT nextval('labour_alternativesignupform_id_seq'::regclass);
...
ALTER TABLE ONLY labour_emptysignupextra ALTER COLUMN id SET DEFAULT nextval('labour_emptysignupextra_id_seq'::regclass);
...
ALTER TABLE ONLY labour_infolink ALTER COLUMN id SET DEFAULT nextval('labour_infolink_id_seq'::regclass);
...
ALTER TABLE ONLY labour_job ALTER COLUMN id SET DEFAULT nextval('labour_job_id_seq'::regclass);
...
ALTER TABLE ONLY labour_jobcategory ALTER COLUMN id SET DEFAULT nextval('labour_jobcategory_id_seq'::regclass);
...
ALTER TABLE ONLY labour_jobcategory_personnel_classes ALTER COLUMN id SET DEFAULT nextval('labour_jobcategory_personnel_classes_id_seq'::regclass);
...
ALTER TABLE ONLY labour_jobcategory_required_qualifications ALTER COLUMN id SET DEFAULT nextval('labour_jobcategory_required_qualifications_id_seq'::regclass);
...
ALTER TABLE ONLY labour_jobrequirement ALTER COLUMN id SET DEFAULT nextval('labour_jobrequirement_id_seq'::regclass);
...
ALTER TABLE ONLY labour_perk ALTER COLUMN id SET DEFAULT nextval('labour_perk_id_seq'::regclass);
...
ALTER TABLE ONLY labour_personnelclass ALTER COLUMN id SET DEFAULT nextval('labour_personnelclass_id_seq'::regclass);
...
ALTER TABLE ONLY labour_personnelclass_perks ALTER COLUMN id SET DEFAULT nextval('labour_personnelclass_perks_id_seq'::regclass);
...
ALTER TABLE ONLY labour_personqualification ALTER COLUMN id SET DEFAULT nextval('labour_personqualification_id_seq'::regclass);
...
ALTER TABLE ONLY labour_qualification ALTER COLUMN id SET DEFAULT nextval('labour_qualification_id_seq'::regclass);
...
ALTER TABLE ONLY labour_shift ALTER COLUMN id SET DEFAULT nextval('labour_shift_id_seq'::regclass);
...
ALTER TABLE ONLY labour_signup ALTER COLUMN id SET DEFAULT nextval('labour_signup_id_seq'::regclass);
...
ALTER TABLE ONLY labour_signup_job_categories ALTER COLUMN id SET DEFAULT nextval('labour_signup_job_categories_id_seq'::regclass);
...
ALTER TABLE ONLY labour_signup_job_categories_accepted ALTER COLUMN id SET DEFAULT nextval('labour_signup_job_categories_accepted_id_seq'::regclass);
...
ALTER TABLE ONLY labour_signup_job_categories_rejected ALTER COLUMN id SET DEFAULT nextval('labour_signup_job_categories_rejected_id_seq'::regclass);
...
ALTER TABLE ONLY labour_signup_personnel_classes ALTER COLUMN id SET DEFAULT nextval('labour_signup_personnel_classes_id_seq'::regclass);
...
ALTER TABLE ONLY labour_survey ALTER COLUMN id SET DEFAULT nextval('labour_survey_id_seq'::regclass);
...
ALTER TABLE ONLY labour_surveyrecord ALTER COLUMN id SET DEFAULT nextval('labour_surveyrecord_id_seq'::regclass);
...
ALTER TABLE ONLY labour_workperiod ALTER COLUMN id SET DEFAULT nextval('labour_workperiod_id_seq'::regclass);
...
ALTER TABLE ONLY lakeuscon2016_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('lakeuscon2016_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY lakeuscon2016_specialdiet ALTER COLUMN id SET DEFAULT nextval('lakeuscon2016_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY lippukala_code ALTER COLUMN id SET DEFAULT nextval('lippukala_code_id_seq'::regclass);
...
ALTER TABLE ONLY lippukala_order ALTER COLUMN id SET DEFAULT nextval('lippukala_order_id_seq'::regclass);
...
ALTER TABLE ONLY mailings_message ALTER COLUMN id SET DEFAULT nextval('mailings_message_id_seq'::regclass);
...
ALTER TABLE ONLY mailings_personmessage ALTER COLUMN id SET DEFAULT nextval('mailings_personmessage_id_seq'::regclass);
...
ALTER TABLE ONLY mailings_personmessagebody ALTER COLUMN id SET DEFAULT nextval('mailings_personmessagebody_id_seq'::regclass);
...
ALTER TABLE ONLY mailings_personmessagesubject ALTER COLUMN id SET DEFAULT nextval('mailings_personmessagesubject_id_seq'::regclass);
...
ALTER TABLE ONLY mailings_recipientgroup ALTER COLUMN id SET DEFAULT nextval('mailings_recipientgroup_id_seq'::regclass);
...
ALTER TABLE ONLY membership_membershipfeepayment ALTER COLUMN id SET DEFAULT nextval('membership_membershipfeepayment_id_seq'::regclass);
...
ALTER TABLE ONLY membership_term ALTER COLUMN id SET DEFAULT nextval('membership_term_id_seq'::regclass);
...
ALTER TABLE ONLY mimicon2016_night ALTER COLUMN id SET DEFAULT nextval('mimicon2016_night_id_seq'::regclass);
...
ALTER TABLE ONLY mimicon2016_signupextra_lodging_needs ALTER COLUMN id SET DEFAULT nextval('mimicon2016_signupextra_lodging_needs_id_seq'::regclass);
...
ALTER TABLE ONLY mimicon2016_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('mimicon2016_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY mimicon2016_specialdiet ALTER COLUMN id SET DEFAULT nextval('mimicon2016_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY nexmo_deliverystatusfragment ALTER COLUMN id SET DEFAULT nextval('nexmo_deliverystatusfragment_id_seq'::regclass);
...
ALTER TABLE ONLY nexmo_inboundmessage ALTER COLUMN id SET DEFAULT nextval('nexmo_inboundmessage_id_seq'::regclass);
...
ALTER TABLE ONLY nexmo_inboundmessagefragment ALTER COLUMN id SET DEFAULT nextval('nexmo_inboundmessagefragment_id_seq'::regclass);
...
ALTER TABLE ONLY nexmo_outboundmessage ALTER COLUMN id SET DEFAULT nextval('nexmo_outboundmessage_id_seq'::regclass);
...
ALTER TABLE ONLY nippori2017_signupextra ALTER COLUMN id SET DEFAULT nextval('nippori2017_signupextra_id_seq'::regclass);
...
ALTER TABLE ONLY popcult2017_signupextra ALTER COLUMN id SET DEFAULT nextval('popcult2017_signupextra_id_seq'::regclass);
...
ALTER TABLE ONLY popcult2017_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('popcult2017_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY programme_alternativeprogrammeform ALTER COLUMN id SET DEFAULT nextval('programme_alternativeprogrammeform_id_seq'::regclass);
...
ALTER TABLE ONLY programme_category ALTER COLUMN id SET DEFAULT nextval('programme_category_id_seq'::regclass);
...
ALTER TABLE ONLY programme_freeformorganizer ALTER COLUMN id SET DEFAULT nextval('programme_freeformorganizer_id_seq'::regclass);
...
ALTER TABLE ONLY programme_invitation ALTER COLUMN id SET DEFAULT nextval('programme_invitation_id_seq'::regclass);
...
ALTER TABLE ONLY programme_programme ALTER COLUMN id SET DEFAULT nextval('programme_programme_id_seq'::regclass);
...
ALTER TABLE ONLY programme_programme_hitpoint2017_preferred_time_slots ALTER COLUMN id SET DEFAULT nextval('programme_programme_hitpoint2017_preferred_time_slots_id_seq'::regclass);
...
ALTER TABLE ONLY programme_programme_tags ALTER COLUMN id SET DEFAULT nextval('programme_programme_tags_id_seq'::regclass);
...
ALTER TABLE ONLY programme_programmefeedback ALTER COLUMN id SET DEFAULT nextval('programme_programmefeedback_id_seq'::regclass);
...
ALTER TABLE ONLY programme_programmerole ALTER COLUMN id SET DEFAULT nextval('programme_programmerole_id_seq'::regclass);
...
ALTER TABLE ONLY programme_role ALTER COLUMN id SET DEFAULT nextval('programme_role_id_seq'::regclass);
...
ALTER TABLE ONLY programme_room ALTER COLUMN id SET DEFAULT nextval('programme_room_id_seq'::regclass);
...
ALTER TABLE ONLY programme_specialstarttime ALTER COLUMN id SET DEFAULT nextval('programme_specialstarttime_id_seq'::regclass);
...
ALTER TABLE ONLY programme_tag ALTER COLUMN id SET DEFAULT nextval('programme_tag_id_seq'::regclass);
...
ALTER TABLE ONLY programme_timeblock ALTER COLUMN id SET DEFAULT nextval('programme_timeblock_id_seq'::regclass);
...
ALTER TABLE ONLY programme_view ALTER COLUMN id SET DEFAULT nextval('programme_view_id_seq'::regclass);


--
-- Name: programme_view_rooms id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY programme_view_rooms ALTER COLUMN id SET DEFAULT nextval('programme_view_rooms_id_seq'::regclass);
...
ALTER TABLE ONLY shippocon2016_signupextra ALTER COLUMN id SET DEFAULT nextval('shippocon2016_signupextra_id_seq'::regclass);
...
ALTER TABLE ONLY shippocon2016_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('shippocon2016_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY shippocon2016_specialdiet ALTER COLUMN id SET DEFAULT nextval('shippocon2016_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY sms_hotword ALTER COLUMN id SET DEFAULT nextval('sms_hotword_id_seq'::regclass);
...
ALTER TABLE ONLY sms_nominee ALTER COLUMN id SET DEFAULT nextval('sms_nominee_id_seq'::regclass);
...
ALTER TABLE ONLY sms_nominee_category ALTER COLUMN id SET DEFAULT nextval('sms_nominee_category_id_seq'::regclass);
...
ALTER TABLE ONLY sms_smsmessagein ALTER COLUMN id SET DEFAULT nextval('sms_smsmessagein_id_seq'::regclass);
...
ALTER TABLE ONLY sms_smsmessageout ALTER COLUMN id SET DEFAULT nextval('sms_smsmessageout_id_seq'::regclass);
...
ALTER TABLE ONLY sms_vote ALTER COLUMN id SET DEFAULT nextval('sms_vote_id_seq'::regclass);
...
ALTER TABLE ONLY sms_votecategory ALTER COLUMN id SET DEFAULT nextval('sms_votecategory_id_seq'::regclass);
...
ALTER TABLE ONLY surveys_eventsurvey ALTER COLUMN id SET DEFAULT nextval('surveys_eventsurvey_id_seq'::regclass);
...
ALTER TABLE ONLY surveys_eventsurveyresult ALTER COLUMN id SET DEFAULT nextval('surveys_eventsurveyresult_id_seq'::regclass);
...
ALTER TABLE ONLY surveys_globalsurvey ALTER COLUMN id SET DEFAULT nextval('surveys_globalsurvey_id_seq'::regclass);
...
ALTER TABLE ONLY surveys_globalsurveyresult ALTER COLUMN id SET DEFAULT nextval('surveys_globalsurveyresult_id_seq'::regclass);
...
ALTER TABLE ONLY tickets_accommodationinformation ALTER COLUMN id SET DEFAULT nextval('tickets_accommodationinformation_id_seq'::regclass);
...
ALTER TABLE ONLY tickets_accommodationinformation_limit_groups ALTER COLUMN id SET DEFAULT nextval('tickets_accommodationinformation_limit_groups_id_seq'::regclass);
...
ALTER TABLE ONLY tickets_batch ALTER COLUMN id SET DEFAULT nextval('tickets_batch_id_seq'::regclass);
...
ALTER TABLE ONLY tickets_customer ALTER COLUMN id SET DEFAULT nextval('tickets_customer_id_seq'::regclass);
...
ALTER TABLE ONLY tickets_limitgroup ALTER COLUMN id SET DEFAULT nextval('tickets_limitgroup_id_seq'::regclass);
...
ALTER TABLE ONLY tickets_order ALTER COLUMN id SET DEFAULT nextval('tickets_order_id_seq'::regclass);
...
ALTER TABLE ONLY tickets_orderproduct ALTER COLUMN id SET DEFAULT nextval('tickets_orderproduct_id_seq'::regclass);
...
ALTER TABLE ONLY tickets_product ALTER COLUMN id SET DEFAULT nextval('tickets_product_id_seq'::regclass);
...
ALTER TABLE ONLY tickets_product_limit_groups ALTER COLUMN id SET DEFAULT nextval('tickets_product_limit_groups_id_seq'::regclass);
...
ALTER TABLE ONLY tickets_shirtorder ALTER COLUMN id SET DEFAULT nextval('tickets_shirtorder_id_seq'::regclass);
...
ALTER TABLE ONLY tickets_shirtsize ALTER COLUMN id SET DEFAULT nextval('tickets_shirtsize_id_seq'::regclass);
...
ALTER TABLE ONLY tickets_shirttype ALTER COLUMN id SET DEFAULT nextval('tickets_shirttype_id_seq'::regclass);
...
ALTER TABLE ONLY tracon11_night ALTER COLUMN id SET DEFAULT nextval('tracon11_night_id_seq'::regclass);
...
ALTER TABLE ONLY tracon11_signupextra_lodging_needs ALTER COLUMN id SET DEFAULT nextval('tracon11_signupextra_lodging_needs_id_seq'::regclass);
...
ALTER TABLE ONLY tracon11_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('tracon11_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY tracon11_signupextrav2 ALTER COLUMN id SET DEFAULT nextval('tracon11_signupextrav2_id_seq'::regclass);
...
ALTER TABLE ONLY tracon11_signupextrav2_lodging_needs ALTER COLUMN id SET DEFAULT nextval('tracon11_signupextrav2_lodging_needs_id_seq'::regclass);
...
ALTER TABLE ONLY tracon11_signupextrav2_special_diet ALTER COLUMN id SET DEFAULT nextval('tracon11_signupextrav2_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY tracon11_specialdiet ALTER COLUMN id SET DEFAULT nextval('tracon11_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY tracon2017_night ALTER COLUMN id SET DEFAULT nextval('tracon2017_night_id_seq'::regclass);
...
ALTER TABLE ONLY tracon2017_poison ALTER COLUMN id SET DEFAULT nextval('tracon2017_poison_id_seq'::regclass);
...
ALTER TABLE ONLY tracon2017_signupextra ALTER COLUMN id SET DEFAULT nextval('tracon2017_signupextra_id_seq'::regclass);
...
ALTER TABLE ONLY tracon2017_signupextra_lodging_needs ALTER COLUMN id SET DEFAULT nextval('tracon2017_signupextra_lodging_needs_id_seq'::regclass);
...
ALTER TABLE ONLY tracon2017_signupextra_pick_your_poison ALTER COLUMN id SET DEFAULT nextval('tracon2017_signupextra_pick_your_poison_id_seq'::regclass);
...
ALTER TABLE ONLY tracon2017_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('tracon2017_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY tracon2018_night ALTER COLUMN id SET DEFAULT nextval('tracon2018_night_id_seq'::regclass);
...
ALTER TABLE ONLY tracon2018_signupextra ALTER COLUMN id SET DEFAULT nextval('tracon2018_signupextra_id_seq'::regclass);
...
ALTER TABLE ONLY tracon2018_signupextra_lodging_needs ALTER COLUMN id SET DEFAULT nextval('tracon2018_signupextra_lodging_needs_id_seq'::regclass);
...
ALTER TABLE ONLY tracon2018_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('tracon2018_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY tracon9_night ALTER COLUMN id SET DEFAULT nextval('tracon9_night_id_seq'::regclass);
...
ALTER TABLE ONLY tracon9_signupextra_lodging_needs ALTER COLUMN id SET DEFAULT nextval('tracon9_signupextra_lodging_needs_id_seq'::regclass);
...
ALTER TABLE ONLY tracon9_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('tracon9_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY tracon9_specialdiet ALTER COLUMN id SET DEFAULT nextval('tracon9_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY traconx_night ALTER COLUMN id SET DEFAULT nextval('traconx_night_id_seq'::regclass);
...
ALTER TABLE ONLY traconx_signupextra_lodging_needs ALTER COLUMN id SET DEFAULT nextval('traconx_signupextra_lodging_needs_id_seq'::regclass);
...
ALTER TABLE ONLY traconx_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('traconx_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY traconx_specialdiet ALTER COLUMN id SET DEFAULT nextval('traconx_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY tylycon2017_signupextra ALTER COLUMN id SET DEFAULT nextval('tylycon2017_signupextra_id_seq'::regclass);
...
ALTER TABLE ONLY tylycon2017_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('tylycon2017_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY tylycon2017_specialdiet ALTER COLUMN id SET DEFAULT nextval('tylycon2017_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY worldcon75_signupextra ALTER COLUMN id SET DEFAULT nextval('worldcon75_signupextra_id_seq'::regclass);
...
ALTER TABLE ONLY worldcon75_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('worldcon75_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY yukicon2016_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('yukicon2016_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY yukicon2016_specialdiet ALTER COLUMN id SET DEFAULT nextval('yukicon2016_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY yukicon2017_eventday ALTER COLUMN id SET DEFAULT nextval('yukicon2017_eventday_id_seq'::regclass);
...
ALTER TABLE ONLY yukicon2017_signupextra ALTER COLUMN id SET DEFAULT nextval('yukicon2017_signupextra_id_seq'::regclass);
...
ALTER TABLE ONLY yukicon2017_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('yukicon2017_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY yukicon2017_signupextra_work_days ALTER COLUMN id SET DEFAULT nextval('yukicon2017_signupextra_work_days_id_seq'::regclass);
...
ALTER TABLE ONLY yukicon2017_specialdiet ALTER COLUMN id SET DEFAULT nextval('yukicon2017_specialdiet_id_seq'::regclass);
...
ALTER TABLE ONLY yukicon2018_eventday ALTER COLUMN id SET DEFAULT nextval('yukicon2018_eventday_id_seq'::regclass);
...
ALTER TABLE ONLY yukicon2018_signupextra ALTER COLUMN id SET DEFAULT nextval('yukicon2018_signupextra_id_seq'::regclass);
...
ALTER TABLE ONLY yukicon2018_signupextra_special_diet ALTER COLUMN id SET DEFAULT nextval('yukicon2018_signupextra_special_diet_id_seq'::regclass);
...
ALTER TABLE ONLY yukicon2018_signupextra_work_days ALTER COLUMN id SET DEFAULT nextval('yukicon2018_signupextra_work_days_id_seq'::regclass);
...
ALTER TABLE ONLY yukicon2018_specialdiet ALTER COLUMN id SET DEFAULT nextval('yukicon2018_specialdiet_id_seq'::regclass);
...
COPY access_accessorganizationmeta (organization_id, admin_group_id) FROM stdin;
\.
...
COPY access_emailalias (id, account_name, email_address, created_at, modified_at, domain_id, group_grant_id, person_id, type_id) FROM stdin;
\.
...
COPY access_emailaliasdomain (id, domain_name, organization_id, has_internal_aliases) FROM stdin;
\.
...
COPY access_emailaliastype (id, metavar, account_name_code, domain_id, priority) FROM stdin;
\.
...
COPY access_grantedprivilege (id, granted_at, person_id, privilege_id, state) FROM stdin;
\.
...
COPY access_groupemailaliasgrant (id, group_id, type_id, active_until) FROM stdin;
\.
...
COPY access_groupprivilege (id, event_id, group_id, privilege_id) FROM stdin;
\.
...
COPY access_internalemailalias (id, account_name, target_emails, email_address, app_label, created_at, modified_at, domain_id, event_id) FROM stdin;
\.
...
COPY access_privilege (id, slug, title, description, request_success_message, grant_code, disclaimers) FROM stdin;
\.
...
COPY access_slackaccess (id, team_name, api_token, privilege_id) FROM stdin;
\.
...
COPY access_smtppassword (id, password_hash, created_at, person_id, smtp_server_id) FROM stdin;
\.
...
COPY access_smtpserver (id, hostname, crypto, port) FROM stdin;
\.
...
COPY access_smtpserver_domains (id, smtpserver_id, emailaliasdomain_id) FROM stdin;
\.
...
COPY aicon2016_signupextra (signup_id, shift_type, total_work, want_certificate, certificate_delivery_address, special_diet_other, need_lodging, prior_experience, free_text, email_alias, is_active) FROM stdin;
\.
...
COPY aicon2016_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY aicon2016_specialdiet (id, name) FROM stdin;
\.
...
COPY animecon2015_night (id, name) FROM stdin;
\.
...
COPY animecon2015_signupextra (signup_id, total_work, want_certificate, certificate_delivery_address, special_diet_other, prior_experience, free_text, personal_identification_number, is_active) FROM stdin;
\.
...
COPY animecon2015_signupextra_lodging_needs (id, signupextra_id, night_id) FROM stdin;
\.
...
COPY animecon2015_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY animecon2015_specialdiet (id, name) FROM stdin;
\.
...
COPY animecon2016_night (id, name) FROM stdin;
\.
...
COPY animecon2016_signupextra (signup_id, total_work, personal_identification_number, want_certificate, certificate_delivery_address, special_diet_other, prior_experience, free_text, is_active) FROM stdin;
\.
...
COPY animecon2016_signupextra_lodging_needs (id, signupextra_id, night_id) FROM stdin;
\.
...
COPY animecon2016_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY animecon2016_specialdiet (id, name) FROM stdin;
\.
...
COPY badges_badge (id, printed_separately_at, revoked_at, job_title, created_at, updated_at, batch_id, person_id, personnel_class_id, first_name, is_first_name_visible, is_nick_visible, is_surname_visible, nick, surname, created_by_id, revoked_by_id, arrived_at, notes) FROM stdin;
\.
...
COPY badges_badgeseventmeta (event_id, admin_group_id, badge_layout, real_name_must_be_visible, is_using_fuzzy_reissuance_hack) FROM stdin;
\.
...
COPY badges_batch (id, created_at, updated_at, printed_at, event_id, personnel_class_id) FROM stdin;
\.
...
COPY core_carouselslide (id, active_from, active_until, href, title, image_file, image_credit, target, "order") FROM stdin;
\.
...
COPY core_emailverificationtoken (id, code, created_at, used_at, state, email, person_id) FROM stdin;
\.
...
COPY core_event (id, slug, name, name_genitive, name_illative, name_inessive, description, start_time, end_time, homepage_url, public, venue_id, logo_url, organization_id, panel_css_class, logo_file) FROM stdin;
\.
...
COPY core_organization (id, slug, name, homepage_url, description, logo_url, public, muncipality, name_genitive) FROM stdin;
\.
...
COPY core_passwordresettoken (id, code, created_at, used_at, state, ip_address, person_id) FROM stdin;
\.
...
COPY core_person (id, first_name, surname, nick, birth_date, email, phone, may_send_info, preferred_name_display_style, notes, email_verified_at, user_id, muncipality, official_first_names, allow_work_history_sharing) FROM stdin;
\.
...
COPY core_venue (id, name, name_inessive) FROM stdin;
\.
...
COPY desucon2016_signupextra (signup_id, shift_type, desu_amount, prior_experience, free_text, shirt_size, shirt_type, night_work, special_diet_other, is_active) FROM stdin;
\.
...
COPY desucon2016_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY desucon2016_signupextrav2 (id, shift_type, desu_amount, prior_experience, free_text, special_diet_other, shirt_size, shirt_type, night_work, event_id, person_id, is_active) FROM stdin;
\.
...
COPY desucon2016_signupextrav2_special_diet (id, signupextrav2_id, specialdiet_id) FROM stdin;
\.
...
COPY desucon2016_specialdiet (id, name) FROM stdin;
\.
...
COPY desucon2017_signupextra (id, is_active, shift_type, prior_experience, free_text, special_diet_other, shirt_size, shirt_type, night_work, event_id, person_id) FROM stdin;
\.
...
COPY desucon2017_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY desucon2017_specialdiet (id, name) FROM stdin;
\.
...
COPY desuprofile_integration_confirmationcode (id, code, created_at, used_at, state, desuprofile_id, person_id, next_url, desuprofile_username) FROM stdin;
\.
...
COPY desuprofile_integration_connection (id, user_id, desuprofile_username) FROM stdin;
\.
...
COPY directory_directoryaccessgroup (id, active_from, active_until, created_at, updated_at, group_id, organization_id) FROM stdin;
\.
...
COPY directory_directoryorganizationmeta (organization_id) FROM stdin;
\.
...
COPY enrollment_conconpart (id, name) FROM stdin;
\.
...
COPY enrollment_enrollment (id, special_diet_other, event_id, person_id, concon_event_affiliation, created_at, is_public, state, updated_at) FROM stdin;
\.
...
COPY enrollment_enrollment_concon_parts (id, enrollment_id, conconpart_id) FROM stdin;
\.
...
COPY enrollment_enrollment_special_diet (id, enrollment_id, specialdiet_id) FROM stdin;
\.
...
COPY enrollment_enrollmenteventmeta (event_id, form_class_path, enrollment_opens, enrollment_closes, admin_group_id, override_enrollment_form_message, initial_state, is_participant_list_public) FROM stdin;
\.
...
COPY enrollment_specialdiet (id, name) FROM stdin;
\.
...
COPY event_log_entry (id, created_at, entry_type, created_by_id, feedback_message_id, event_id, event_survey_result_id, global_survey_result_id, context, person_id, organization_id, search_term, ip_address) FROM stdin;
\.
...
COPY event_log_subscription (id, entry_type, channel, active, user_id, callback_code, event_filter_id, event_survey_filter_id) FROM stdin;
\.
...
COPY feedback_feedbackmessage (id, context, author_ip_address, feedback, created_at, author_id) FROM stdin;
\.
...
COPY finncon2016_signupextra (signup_id, shift_type, total_work, special_diet_other, prior_experience, free_text, dead_dog, shirt_size, is_active) FROM stdin;
\.
...
COPY finncon2016_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY finncon2016_specialdiet (id, name) FROM stdin;
\.
...
COPY frostbite2016_signupextra (signup_id, shift_type, desu_amount, prior_experience, free_text, shirt_size, shirt_type, night_work, is_active) FROM stdin;
\.
...
COPY frostbite2017_signupextra (id, is_active, shift_type, desu_amount, prior_experience, free_text, special_diet_other, shirt_size, shirt_type, night_work, event_id, person_id) FROM stdin;
\.
...
COPY frostbite2017_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY frostbite2017_specialdiet (id, name) FROM stdin;
\.
...
COPY frostbite2018_signupextra (id, is_active, shift_type, prior_experience, free_text, special_diet_other, shirt_size, shirt_type, night_work, event_id, person_id) FROM stdin;
\.
...
COPY frostbite2018_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY frostbite2018_specialdiet (id, name) FROM stdin;
\.
...
COPY hitpoint2015_signupextra (signup_id, shift_type, total_work, construction, overseer, want_certificate, certificate_delivery_address, special_diet_other, prior_experience, free_text, night_work, shift_wishes, need_lodging, is_active) FROM stdin;
\.
...
COPY hitpoint2015_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY hitpoint2015_specialdiet (id, name) FROM stdin;
\.
...
COPY hitpoint2017_signupextra (signup_id, shift_type, total_work, night_work, construction, overseer, want_certificate, certificate_delivery_address, special_diet_other, need_lodging, prior_experience, shift_wishes, free_text, is_active) FROM stdin;
\.
...
COPY hitpoint2017_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY hitpoint2017_specialdiet (id, name) FROM stdin;
\.
...
COPY hitpoint2017_timeslot (id, name) FROM stdin;
\.
...
COPY intra_intraeventmeta (event_id, admin_group_id, organizer_group_id) FROM stdin;
\.
...
COPY intra_team (id, "order", name, description, slug, event_id, group_id, email) FROM stdin;
\.
...
COPY intra_teammember (id, is_primary_team, is_team_leader, is_shown_internally, is_shown_publicly, is_group_member, person_id, team_id, override_name_display_style, override_job_title) FROM stdin;
\.
...
COPY kawacon2016_night (id, name) FROM stdin;
\.
...
COPY kawacon2016_signupextra (signup_id, shirt_size, special_diet_other, prior_experience, free_text, is_active) FROM stdin;
\.
...
COPY kawacon2016_signupextra_needs_lodging (id, signupextra_id, night_id) FROM stdin;
\.
...
COPY kawacon2016_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY kawacon2016_specialdiet (id, name) FROM stdin;
\.
...
COPY kawacon2017_night (id, name) FROM stdin;
\.
...
COPY kawacon2017_shift (id, name) FROM stdin;
\.
...
COPY kawacon2017_signupextra (id, is_active, shirt_size, special_diet_other, afterparty, prior_experience, free_text, event_id, person_id, want_certificate) FROM stdin;
\.
...
COPY kawacon2017_signupextra_needs_lodging (id, signupextra_id, night_id) FROM stdin;
\.
...
COPY kawacon2017_signupextra_shifts (id, signupextra_id, shift_id) FROM stdin;
\.
...
COPY kawacon2017_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY kawacon2017_specialdiet (id, name) FROM stdin;
\.
...
COPY kuplii2015_signupextra (signup_id, shift_type, total_work, special_diet_other, prior_experience, free_text, is_active) FROM stdin;
\.
...
COPY kuplii2015_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY kuplii2015_specialdiet (id, name) FROM stdin;
\.
...
COPY kuplii2016_signupextra (signup_id, shift_type, total_work, special_diet_other, prior_experience, free_text, is_active) FROM stdin;
\.
...
COPY kuplii2016_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY kuplii2016_specialdiet (id, name) FROM stdin;
\.
...
COPY kuplii2017_signupextra (id, is_active, shift_type, total_work, special_diet_other, prior_experience, free_text, event_id, person_id) FROM stdin;
\.
...
COPY kuplii2017_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY kuplii2017_specialdiet (id, name) FROM stdin;
\.
...
COPY kuplii2018_signupextra (id, is_active, shift_type, total_work, special_diet_other, prior_experience, free_text, event_id, person_id) FROM stdin;
\.
...
COPY kuplii2018_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY kuplii2018_specialdiet (id, name) FROM stdin;
\.
...
COPY labour_alternativesignupform (id, slug, title, signup_form_class_path, signup_extra_form_class_path, active_from, active_until, signup_message, event_id) FROM stdin;
\.
...
COPY labour_common_qualifications_jvkortti (personqualification_id, card_number, expiration_date) FROM stdin;
\.
...
COPY labour_emptysignupextra (id, event_id, person_id, is_active) FROM stdin;
\.
...
COPY labour_infolink (id, url, title, event_id, group_id) FROM stdin;
\.
...
COPY labour_job (id, title, job_category_id, slug) FROM stdin;
\.
...
COPY labour_jobcategory (id, name, slug, description, public, event_id, app_label) FROM stdin;
\.
...
COPY labour_jobcategory_personnel_classes (id, jobcategory_id, personnelclass_id) FROM stdin;
\.
...
COPY labour_jobcategory_required_qualifications (id, jobcategory_id, qualification_id) FROM stdin;
\.
...
COPY labour_jobrequirement (id, count, start_time, end_time, job_id) FROM stdin;
\.
...
COPY labour_laboureventmeta (event_id, registration_opens, registration_closes, work_begins, work_ends, monitor_email, contact_email, signup_message, admin_group_id, signup_extra_content_type_id, work_certificate_signer) FROM stdin;
\.
...
COPY labour_obsoleteemptysignupextrav1 (signup_id, is_active) FROM stdin;
\.
...
COPY labour_perk (id, slug, name, event_id) FROM stdin;
\.
...
COPY labour_personnelclass (id, app_label, name, slug, priority, event_id, icon_css_class) FROM stdin;
\.
...
COPY labour_personnelclass_perks (id, personnelclass_id, perk_id) FROM stdin;
\.
...
COPY labour_personqualification (id, person_id, qualification_id) FROM stdin;
\.
...
COPY labour_qualification (id, slug, name, description, qualification_extra_content_type_id) FROM stdin;
\.
...
COPY labour_shift (id, start_time, hours, notes, job_id, signup_id) FROM stdin;
\.
...
COPY labour_signup (id, notes, created_at, updated_at, xxx_interim_shifts, job_title, is_active, time_accepted, time_finished, time_complained, time_cancelled, time_rejected, time_arrived, time_work_accepted, time_reprimanded, alternative_signup_form_used_id, event_id, person_id, time_confirmation_requested) FROM stdin;
\.
...
COPY labour_signup_job_categories (id, signup_id, jobcategory_id) FROM stdin;
\.
...
COPY labour_signup_job_categories_accepted (id, signup_id, jobcategory_id) FROM stdin;
\.
...
COPY labour_signup_job_categories_rejected (id, signup_id, jobcategory_id) FROM stdin;
\.
...
COPY labour_signup_personnel_classes (id, signup_id, personnelclass_id) FROM stdin;
\.
...
COPY labour_survey (id, slug, title, description, active_from, active_until, form_class_path, event_id, override_does_not_apply_message) FROM stdin;
\.
...
COPY labour_surveyrecord (id, created_at, updated_at, person_id, survey_id) FROM stdin;
\.
...
COPY labour_workperiod (id, description, start_time, end_time, event_id) FROM stdin;
\.
...
COPY lakeuscon2016_signupextra (signup_id, shift_type, shirt_size, special_diet_other, prior_experience, shift_wishes, free_text, is_active) FROM stdin;
\.
...
COPY lakeuscon2016_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY lakeuscon2016_specialdiet (id, name) FROM stdin;
\.
...
COPY lippukala_code (id, created_on, status, used_on, used_at, prefix, code, literate_code, product_text, order_id) FROM stdin;
\.
...
COPY lippukala_order (id, event, created_on, modified_on, reference_number, address_text, free_text, comment) FROM stdin;
\.
...
COPY mailings_message (id, subject_template, body_template, created_at, updated_at, sent_at, expired_at, recipient_id, channel) FROM stdin;
\.
...
COPY mailings_personmessage (id, created_at, body_id, message_id, person_id, subject_id) FROM stdin;
\.
...
COPY mailings_personmessagebody (id, digest, text) FROM stdin;
\.
...
COPY mailings_personmessagesubject (id, digest, text) FROM stdin;
\.
...
COPY mailings_recipientgroup (id, app_label, verbose_name, event_id, group_id, job_category_id, personnel_class_id) FROM stdin;
\.
...
COPY membership_membership (id, organization_id, person_id, state, message) FROM stdin;
\.
...
COPY membership_membershipfeepayment (id, payment_date, member_id, term_id) FROM stdin;
\.
...
COPY membership_membershiporganizationmeta (organization_id, admin_group_id, receiving_applications, membership_requirements, members_group_id) FROM stdin;
\.
...
COPY membership_term (id, title, start_date, end_date, entrance_fee_cents, membership_fee_cents, organization_id, payment_type) FROM stdin;
\.
...
COPY mimicon2016_night (id, name) FROM stdin;
\.
...
COPY mimicon2016_signupextra (signup_id, shift_type, total_work, construction, want_certificate, special_diet_other, prior_experience, shift_wishes, free_text, is_active) FROM stdin;
\.
...
COPY mimicon2016_signupextra_lodging_needs (id, signupextra_id, night_id) FROM stdin;
\.
...
COPY mimicon2016_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY mimicon2016_specialdiet (id, name) FROM stdin;
\.
...
COPY nexmo_deliverystatusfragment (id, nexmo_message_id, error_code, status_msg, status_timestamp, message_id) FROM stdin;
\.
...
COPY nexmo_inboundmessage (id, nexmo_message_id, sender, nexmo_timestamp, receive_timestamp, message) FROM stdin;
\.
...
COPY nexmo_inboundmessagefragment (id, nexmo_message_id, sender, nexmo_timestamp, receive_timestamp, message, concat_ref, concat_part, concat_total) FROM stdin;
\.
...
COPY nexmo_outboundmessage (id, message, "to", send_timestamp, send_status, status, sent_pieces, external_reference) FROM stdin;
\.
...
COPY nippori2017_signupextra (id, is_active, prior_experience, shift_wishes, free_text, event_id, person_id) FROM stdin;
\.
...
COPY payments_payment (id, test, "VERSION", "STAMP", "REFERENCE", "PAYMENT", "STATUS", "ALGORITHM", "MAC", event_id) FROM stdin;
\.
...
COPY payments_paymentseventmeta (event_id, checkout_password, checkout_merchant, checkout_delivery_date, admin_group_id) FROM stdin;
\.
...
COPY popcult2017_signupextra (id, is_active, want_certificate, special_diet_other, y_u, prior_experience, free_text, event_id, person_id) FROM stdin;
\.
...
COPY popcult2017_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY programme_alternativeprogrammeform (id, slug, title, description, short_description, programme_form_code, active_from, active_until, num_extra_invites, "order", event_id) FROM stdin;
\.
...
COPY programme_category (id, title, style, notes, public, event_id, slug) FROM stdin;
\.
...
COPY programme_freeformorganizer (id, text, programme_id) FROM stdin;
\.
...
COPY programme_invitation (id, email, programme_id, role_id, code, created_at, state, used_at, created_by_id, extra_invites, sire_id) FROM stdin;
\.
...
COPY programme_programme (id, title, description, room_requirements, tech_requirements, requested_time_slot, video_permission, notes_from_host, start_time, length, notes, category_id, room_id, state, end_time, created_at, updated_at, slug, computer, encumbered_content, number_of_microphones, photography, use_audio, use_video, frozen, video_link, rerun, approximate_length, is_age_restricted, is_beginner_friendly, is_children_friendly, is_english_ok, is_intended_for_experienced_participants, max_players, min_players, other_author, physical_play, rpg_system, three_word_description, form_used_id, signup_link) FROM stdin;
\.
...
COPY programme_programme_hitpoint2017_preferred_time_slots (id, programme_id, timeslot_id) FROM stdin;
\.
...
COPY programme_programme_tags (id, programme_id, tag_id) FROM stdin;
\.
...
COPY programme_programmeeventmeta (event_id, contact_email, admin_group_id, public_from, accepting_cold_offers_from, accepting_cold_offers_until, schedule_layout) FROM stdin;
\.
...
COPY programme_programmefeedback (id, author_ip_address, is_anonymous, feedback, created_at, hidden_at, author_id, hidden_by_id, programme_id) FROM stdin;
\.
...
COPY programme_programmerole (id, person_id, programme_id, role_id, invitation_id, extra_invites, is_active) FROM stdin;
\.
...
COPY programme_role (id, title, require_contact_info, is_default, is_public, personnel_class_id, priority, override_public_title) FROM stdin;
\.
...
COPY programme_room (id, name, "order", notes, slug, active, event_id) FROM stdin;
\.
...
COPY programme_specialstarttime (id, start_time, event_id) FROM stdin;
\.
...
COPY programme_tag (id, title, "order", style, event_id, slug) FROM stdin;
\.
...
COPY programme_timeblock (id, start_time, end_time, event_id) FROM stdin;
\.
...
COPY programme_view (id, name, public, "order", event_id, end_time, start_time) FROM stdin;
\.


--
-- Data for Name: programme_view_rooms; Type: TABLE DATA; Schema: public; Owner: -
--

COPY programme_view_rooms (id, view_id, room_id) FROM stdin;
\.
...
COPY shippocon2016_signupextra (id, is_active, special_diet_other, total_work, shift_type, working_days, prior_experience, shift_wishes, free_text, event_id, person_id) FROM stdin;
\.
...
COPY shippocon2016_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY shippocon2016_specialdiet (id, name) FROM stdin;
\.
...
COPY sms_hotword (id, hotword, slug, valid_from, valid_to, assigned_event_id) FROM stdin;
\.
...
COPY sms_nominee (id, number, name) FROM stdin;
\.
...
COPY sms_nominee_category (id, nominee_id, votecategory_id) FROM stdin;
\.
...
COPY sms_smseventmeta (event_id, sms_enabled, current, used_credit, admin_group_id) FROM stdin;
\.
...
COPY sms_smsmessagein (id, message_id, "SMSEventMeta_id") FROM stdin;
\.
...
COPY sms_smsmessageout (id, message, "to", event_id, ref_id) FROM stdin;
\.
...
COPY sms_vote (id, vote_id, category_id, message_id) FROM stdin;
\.
...
COPY sms_votecategory (id, category, slug, "primary", hotword_id) FROM stdin;
\.
...
COPY surveys_eventsurvey (id, title, description, is_active, created_at, updated_at, model, slug, event_id) FROM stdin;
\.
...
COPY surveys_eventsurveyresult (id, created_at, model, author_ip_address, author_id, survey_id) FROM stdin;
\.
...
COPY surveys_globalsurvey (id, title, description, is_active, created_at, updated_at, model, slug) FROM stdin;
\.
...
COPY surveys_globalsurveyresult (id, created_at, model, author_ip_address, author_id, survey_id) FROM stdin;
\.
...
COPY tickets_accommodationinformation (id, first_name, last_name, phone_number, email, order_product_id) FROM stdin;
\.
...
COPY tickets_accommodationinformation_limit_groups (id, accommodationinformation_id, limitgroup_id) FROM stdin;
\.
...
COPY tickets_batch (id, create_time, delivery_time, event_id) FROM stdin;
\.
...
COPY tickets_customer (id, first_name, last_name, address, zip_code, city, email, allow_marketing_email, phone_number) FROM stdin;
\.
...
COPY tickets_limitgroup (id, description, "limit", event_id) FROM stdin;
\.
...
COPY tickets_order (id, start_time, confirm_time, ip_address, payment_date, cancellation_time, reference_number, batch_id, customer_id, event_id) FROM stdin;
\.
...
COPY tickets_orderproduct (id, count, order_id, product_id) FROM stdin;
\.
...
COPY tickets_product (id, name, internal_description, description, mail_description, price_cents, requires_shipping, electronic_ticket, available, notify_email, ordering, event_id, requires_accommodation_information, requires_shirt_size) FROM stdin;
\.
...
COPY tickets_product_limit_groups (id, product_id, limitgroup_id) FROM stdin;
\.
...
COPY tickets_shirtorder (id, count, order_id, size_id) FROM stdin;
\.
...
COPY tickets_shirtsize (id, name, slug, available, type_id) FROM stdin;
\.
...
COPY tickets_shirttype (id, name, slug, available, event_id) FROM stdin;
\.
...
COPY tickets_ticketseventmeta (event_id, shipping_and_handling_cents, due_days, ticket_sales_starts, ticket_sales_ends, reference_number_template, contact_email, ticket_spam_email, reservation_seconds, ticket_free_text, admin_group_id, front_page_text, print_logo_height_mm, print_logo_path, print_logo_width_mm, receipt_footer) FROM stdin;
\.
...
COPY tracon11_night (id, name) FROM stdin;
\.
...
COPY tracon11_signupextra (signup_id, shift_type, total_work, overseer, want_certificate, certificate_delivery_address, shirt_size, special_diet_other, prior_experience, free_text, email_alias, is_active, shift_wishes) FROM stdin;
\.
...
COPY tracon11_signupextra_lodging_needs (id, signupextra_id, night_id) FROM stdin;
\.
...
COPY tracon11_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY tracon11_signupextrav2_lodging_needs (id, signupextrav2_id, night_id) FROM stdin;
\.
...
COPY tracon11_signupextrav2_special_diet (id, signupextrav2_id, specialdiet_id) FROM stdin;
\.
...
COPY tracon11_specialdiet (id, name) FROM stdin;
\.
...
COPY tracon2017_night (id, name) FROM stdin;
\.
...
COPY tracon2017_poison (id, name) FROM stdin;
\.
...
COPY tracon2017_signupextra_lodging_needs (id, signupextra_id, night_id) FROM stdin;
\.
...
COPY tracon2017_signupextra_pick_your_poison (id, signupextra_id, poison_id) FROM stdin;
\.
...
COPY tracon2017_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY tracon2018_night (id, name) FROM stdin;
\.
...
COPY tracon2018_signupextra (id, is_active, shift_type, total_work, overseer, want_certificate, certificate_delivery_address, shirt_size, special_diet_other, prior_experience, free_text, shift_wishes, email_alias, event_id, person_id) FROM stdin;
\.
...
COPY tracon2018_signupextra_lodging_needs (id, signupextra_id, night_id) FROM stdin;
\.
...
COPY tracon2018_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY tracon9_night (id, name) FROM stdin;
\.
...
COPY tracon9_signupextra (signup_id, shift_type, total_work, construction, overseer, want_certificate, certificate_delivery_address, shirt_size, special_diet_other, prior_experience, free_text, is_active) FROM stdin;
\.
...
COPY tracon9_signupextra_lodging_needs (id, signupextra_id, night_id) FROM stdin;
\.
...
COPY tracon9_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY tracon9_specialdiet (id, name) FROM stdin;
\.
...
COPY traconx_night (id, name) FROM stdin;
\.
...
COPY traconx_signupextra (signup_id, shift_type, total_work, overseer, want_certificate, certificate_delivery_address, shirt_size, special_diet_other, prior_experience, free_text, email_alias, is_active) FROM stdin;
\.
...
COPY traconx_signupextra_lodging_needs (id, signupextra_id, night_id) FROM stdin;
\.
...
COPY traconx_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY traconx_specialdiet (id, name) FROM stdin;
\.
...
COPY tylycon2017_signupextra (id, is_active, shift_type, total_work, want_certificate, special_diet_other, prior_experience, free_text, event_id, person_id, motivation, shift_cleanup, shift_setup) FROM stdin;
\.
...
COPY tylycon2017_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY tylycon2017_specialdiet (id, name) FROM stdin;
\.
...
COPY worldcon75_signupextra (id, is_active, special_diet_other, shift_wishes, prior_experience, free_text, is_attending_member, event_id, person_id) FROM stdin;
\.
...
COPY worldcon75_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY yukicon2016_signupextra (signup_id, shift_type, total_work, construction, want_certificate, shirt_size, special_diet_other, prior_experience, shift_wishes, free_text, is_active) FROM stdin;
\.
...
COPY yukicon2016_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY yukicon2016_specialdiet (id, name) FROM stdin;
\.
...
COPY yukicon2017_eventday (id, name) FROM stdin;
\.
...
COPY yukicon2017_signupextra (id, is_active, shift_type, total_work, want_certificate, special_diet_other, prior_experience, shift_wishes, free_text, event_id, person_id) FROM stdin;
\.
...
COPY yukicon2017_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY yukicon2017_signupextra_work_days (id, signupextra_id, eventday_id) FROM stdin;
\.
...
COPY yukicon2017_specialdiet (id, name) FROM stdin;
\.
...
COPY yukicon2018_eventday (id, name) FROM stdin;
\.
...
COPY yukicon2018_signupextra (id, is_active, shift_type, total_work, want_certificate, special_diet_other, prior_experience, shift_wishes, free_text, event_id, person_id, shirt_size) FROM stdin;
\.
...
COPY yukicon2018_signupextra_special_diet (id, signupextra_id, specialdiet_id) FROM stdin;
\.
...
COPY yukicon2018_signupextra_work_days (id, signupextra_id, eventday_id) FROM stdin;
\.
...
COPY yukicon2018_specialdiet (id, name) FROM stdin;
\.
...
SELECT pg_catalog.setval('access_emailalias_id_seq', 1, false);
...
SELECT pg_catalog.setval('access_emailaliasdomain_id_seq', 1, false);
...
SELECT pg_catalog.setval('access_emailaliastype_id_seq', 1, false);
...
SELECT pg_catalog.setval('access_grantedprivilege_id_seq', 1, false);
...
SELECT pg_catalog.setval('access_groupemailaliasgrant_id_seq', 1, false);
...
SELECT pg_catalog.setval('access_groupprivilege_id_seq', 1, false);
...
SELECT pg_catalog.setval('access_internalemailalias_id_seq', 1, false);
...
SELECT pg_catalog.setval('access_privilege_id_seq', 1, false);
...
SELECT pg_catalog.setval('access_slackaccess_id_seq', 1, false);
...
SELECT pg_catalog.setval('access_smtppassword_id_seq', 1, false);
...
SELECT pg_catalog.setval('access_smtpserver_domains_id_seq', 1, false);
...
SELECT pg_catalog.setval('access_smtpserver_id_seq', 1, false);
...
SELECT pg_catalog.setval('aicon2016_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('aicon2016_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('animecon2015_night_id_seq', 1, false);
...
SELECT pg_catalog.setval('animecon2015_signupextra_lodging_needs_id_seq', 1, false);
...
SELECT pg_catalog.setval('animecon2015_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('animecon2015_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('animecon2016_night_id_seq', 1, false);
...
SELECT pg_catalog.setval('animecon2016_signupextra_lodging_needs_id_seq', 1, false);
...
SELECT pg_catalog.setval('animecon2016_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('animecon2016_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('badges_batch_id_seq', 1, false);
...
SELECT pg_catalog.setval('core_carouselslide_id_seq', 1, false);
...
SELECT pg_catalog.setval('core_emailverificationtoken_id_seq', 1, false);
...
SELECT pg_catalog.setval('core_organization_id_seq', 1, false);
...
SELECT pg_catalog.setval('core_passwordresettoken_id_seq', 1, false);
...
SELECT pg_catalog.setval('core_person_id_seq', 1, false);
...
SELECT pg_catalog.setval('core_venue_id_seq', 1, false);
...
SELECT pg_catalog.setval('desucon2016_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('desucon2016_signupextrav2_id_seq', 1, false);
...
SELECT pg_catalog.setval('desucon2016_signupextrav2_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('desucon2016_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('desucon2017_signupextra_id_seq', 1, false);
...
SELECT pg_catalog.setval('desucon2017_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('desucon2017_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('desuprofile_integration_confirmationcode_id_seq', 1, false);
...
SELECT pg_catalog.setval('directory_directoryaccessgroup_id_seq', 1, false);
...
SELECT pg_catalog.setval('django_migrations_id_seq', 399, true);
...
SELECT pg_catalog.setval('enrollment_conconpart_id_seq', 1, false);
...
SELECT pg_catalog.setval('enrollment_enrollment_concon_parts_id_seq', 1, false);
...
SELECT pg_catalog.setval('enrollment_enrollment_id_seq', 1, false);
...
SELECT pg_catalog.setval('enrollment_enrollment_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('enrollment_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('event_log_entry_id_seq', 1, false);
...
SELECT pg_catalog.setval('event_log_subscription_id_seq', 1, false);
...
SELECT pg_catalog.setval('feedback_feedbackmessage_id_seq', 1, false);
...
SELECT pg_catalog.setval('finncon2016_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('finncon2016_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('frostbite2017_signupextra_id_seq', 1, false);
...
SELECT pg_catalog.setval('frostbite2017_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('frostbite2017_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('frostbite2018_signupextra_id_seq', 1, false);
...
SELECT pg_catalog.setval('frostbite2018_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('frostbite2018_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('hitpoint2015_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('hitpoint2015_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('hitpoint2017_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('hitpoint2017_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('hitpoint2017_timeslot_id_seq', 1, false);
...
SELECT pg_catalog.setval('intra_team_id_seq', 1, false);
...
SELECT pg_catalog.setval('intra_teammember_id_seq', 1, false);
...
SELECT pg_catalog.setval('kawacon2016_night_id_seq', 1, false);
...
SELECT pg_catalog.setval('kawacon2016_signupextra_needs_lodging_id_seq', 1, false);
...
SELECT pg_catalog.setval('kawacon2016_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('kawacon2016_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('kawacon2017_night_id_seq', 1, false);
...
SELECT pg_catalog.setval('kawacon2017_shift_id_seq', 1, false);
...
SELECT pg_catalog.setval('kawacon2017_signupextra_id_seq', 1, false);
...
SELECT pg_catalog.setval('kawacon2017_signupextra_needs_lodging_id_seq', 1, false);
...
SELECT pg_catalog.setval('kawacon2017_signupextra_shifts_id_seq', 1, false);
...
SELECT pg_catalog.setval('kawacon2017_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('kawacon2017_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('kuplii2015_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('kuplii2015_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('kuplii2016_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('kuplii2016_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('kuplii2017_signupextra_id_seq', 1, false);
...
SELECT pg_catalog.setval('kuplii2017_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('kuplii2017_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('kuplii2018_signupextra_id_seq', 1, false);
...
SELECT pg_catalog.setval('kuplii2018_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('kuplii2018_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_alternativesignupform_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_emptysignupextra_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_infolink_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_job_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_jobcategory_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_jobcategory_personnel_classes_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_jobcategory_required_qualifications_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_jobrequirement_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_perk_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_personnelclass_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_personnelclass_perks_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_personqualification_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_qualification_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_shift_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_signup_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_signup_job_categories_accepted_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_signup_job_categories_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_signup_job_categories_rejected_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_signup_personnel_classes_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_survey_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_surveyrecord_id_seq', 1, false);
...
SELECT pg_catalog.setval('labour_workperiod_id_seq', 1, false);
...
SELECT pg_catalog.setval('lakeuscon2016_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('lakeuscon2016_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('lippukala_code_id_seq', 1, false);
...
SELECT pg_catalog.setval('lippukala_order_id_seq', 1, false);
...
SELECT pg_catalog.setval('mailings_message_id_seq', 1, false);
...
SELECT pg_catalog.setval('mailings_personmessage_id_seq', 1, false);
...
SELECT pg_catalog.setval('mailings_personmessagebody_id_seq', 1, false);
...
SELECT pg_catalog.setval('mailings_personmessagesubject_id_seq', 1, false);
...
SELECT pg_catalog.setval('mailings_recipientgroup_id_seq', 1, false);
...
SELECT pg_catalog.setval('membership_membershipfeepayment_id_seq', 1, false);
...
SELECT pg_catalog.setval('membership_term_id_seq', 1, false);
...
SELECT pg_catalog.setval('mimicon2016_night_id_seq', 1, false);
...
SELECT pg_catalog.setval('mimicon2016_signupextra_lodging_needs_id_seq', 1, false);
...
SELECT pg_catalog.setval('mimicon2016_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('mimicon2016_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('nexmo_deliverystatusfragment_id_seq', 1, false);
...
SELECT pg_catalog.setval('nexmo_inboundmessage_id_seq', 1, false);
...
SELECT pg_catalog.setval('nexmo_inboundmessagefragment_id_seq', 1, false);
...
SELECT pg_catalog.setval('nexmo_outboundmessage_id_seq', 1, false);
...
SELECT pg_catalog.setval('nippori2017_signupextra_id_seq', 1, false);
...
SELECT pg_catalog.setval('popcult2017_signupextra_id_seq', 1, false);
...
SELECT pg_catalog.setval('popcult2017_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('programme_alternativeprogrammeform_id_seq', 1, false);
...
SELECT pg_catalog.setval('programme_category_id_seq', 1, false);
...
SELECT pg_catalog.setval('programme_freeformorganizer_id_seq', 1, false);
...
SELECT pg_catalog.setval('programme_invitation_id_seq', 1, false);
...
SELECT pg_catalog.setval('programme_programme_hitpoint2017_preferred_time_slots_id_seq', 1, false);
...
SELECT pg_catalog.setval('programme_programme_id_seq', 1, false);
...
SELECT pg_catalog.setval('programme_programme_tags_id_seq', 1, false);
...
SELECT pg_catalog.setval('programme_programmefeedback_id_seq', 1, false);
...
SELECT pg_catalog.setval('programme_programmerole_id_seq', 1, false);
...
SELECT pg_catalog.setval('programme_role_id_seq', 1, false);
...
SELECT pg_catalog.setval('programme_room_id_seq', 1, false);
...
SELECT pg_catalog.setval('programme_specialstarttime_id_seq', 1, false);
...
SELECT pg_catalog.setval('programme_tag_id_seq', 1, false);
...
SELECT pg_catalog.setval('programme_timeblock_id_seq', 1, false);
...
SELECT pg_catalog.setval('programme_view_id_seq', 1, false);


--
-- Name: programme_view_rooms_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('programme_view_rooms_id_seq', 1, false);
...
SELECT pg_catalog.setval('shippocon2016_signupextra_id_seq', 1, false);
...
SELECT pg_catalog.setval('shippocon2016_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('shippocon2016_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('sms_hotword_id_seq', 1, false);
...
SELECT pg_catalog.setval('sms_nominee_category_id_seq', 1, false);
...
SELECT pg_catalog.setval('sms_nominee_id_seq', 1, false);
...
SELECT pg_catalog.setval('sms_smsmessagein_id_seq', 1, false);
...
SELECT pg_catalog.setval('sms_smsmessageout_id_seq', 1, false);
...
SELECT pg_catalog.setval('sms_vote_id_seq', 1, false);
...
SELECT pg_catalog.setval('sms_votecategory_id_seq', 1, false);
...
SELECT pg_catalog.setval('surveys_eventsurvey_id_seq', 1, false);
...
SELECT pg_catalog.setval('surveys_eventsurveyresult_id_seq', 1, false);
...
SELECT pg_catalog.setval('surveys_globalsurvey_id_seq', 1, false);
...
SELECT pg_catalog.setval('surveys_globalsurveyresult_id_seq', 1, false);
...
SELECT pg_catalog.setval('tickets_accommodationinformation_id_seq', 1, false);
...
SELECT pg_catalog.setval('tickets_accommodationinformation_limit_groups_id_seq', 1, false);
...
SELECT pg_catalog.setval('tickets_batch_id_seq', 1, false);
...
SELECT pg_catalog.setval('tickets_customer_id_seq', 1, false);
...
SELECT pg_catalog.setval('tickets_limitgroup_id_seq', 1, false);
...
SELECT pg_catalog.setval('tickets_order_id_seq', 1, false);
...
SELECT pg_catalog.setval('tickets_orderproduct_id_seq', 1, false);
...
SELECT pg_catalog.setval('tickets_product_id_seq', 1, false);
...
SELECT pg_catalog.setval('tickets_product_limit_groups_id_seq', 1, false);
...
SELECT pg_catalog.setval('tickets_shirtorder_id_seq', 1, false);
...
SELECT pg_catalog.setval('tickets_shirtsize_id_seq', 1, false);
...
SELECT pg_catalog.setval('tickets_shirttype_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon11_night_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon11_signupextra_lodging_needs_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon11_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon11_signupextrav2_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon11_signupextrav2_lodging_needs_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon11_signupextrav2_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon11_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon2017_night_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon2017_poison_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon2017_signupextra_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon2017_signupextra_lodging_needs_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon2017_signupextra_pick_your_poison_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon2017_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon2018_night_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon2018_signupextra_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon2018_signupextra_lodging_needs_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon2018_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon9_night_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon9_signupextra_lodging_needs_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon9_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('tracon9_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('traconx_night_id_seq', 1, false);
...
SELECT pg_catalog.setval('traconx_signupextra_lodging_needs_id_seq', 1, false);
...
SELECT pg_catalog.setval('traconx_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('traconx_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('tylycon2017_signupextra_id_seq', 1, false);
...
SELECT pg_catalog.setval('tylycon2017_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('tylycon2017_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('worldcon75_signupextra_id_seq', 1, false);
...
SELECT pg_catalog.setval('worldcon75_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('yukicon2016_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('yukicon2016_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('yukicon2017_eventday_id_seq', 1, false);
...
SELECT pg_catalog.setval('yukicon2017_signupextra_id_seq', 1, false);
...
SELECT pg_catalog.setval('yukicon2017_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('yukicon2017_signupextra_work_days_id_seq', 1, false);
...
SELECT pg_catalog.setval('yukicon2017_specialdiet_id_seq', 1, false);
...
SELECT pg_catalog.setval('yukicon2018_eventday_id_seq', 1, false);
...
SELECT pg_catalog.setval('yukicon2018_signupextra_id_seq', 1, false);
...
SELECT pg_catalog.setval('yukicon2018_signupextra_special_diet_id_seq', 1, false);
...
SELECT pg_catalog.setval('yukicon2018_signupextra_work_days_id_seq', 1, false);
...
SELECT pg_catalog.setval('yukicon2018_specialdiet_id_seq', 1, false);
...
ALTER TABLE ONLY access_accessorganizationmeta
...
ALTER TABLE ONLY access_emailalias
...
ALTER TABLE ONLY access_emailaliasdomain
...
ALTER TABLE ONLY access_emailaliastype
...
ALTER TABLE ONLY access_grantedprivilege
...
ALTER TABLE ONLY access_groupemailaliasgrant
...
ALTER TABLE ONLY access_groupprivilege
...
ALTER TABLE ONLY access_internalemailalias
...
ALTER TABLE ONLY access_privilege
...
ALTER TABLE ONLY access_slackaccess
...
ALTER TABLE ONLY access_smtppassword
...
ALTER TABLE ONLY access_smtpserver_domains
...
ALTER TABLE ONLY access_smtpserver
...
ALTER TABLE ONLY aicon2016_signupextra
...
ALTER TABLE ONLY aicon2016_signupextra_special_diet
...
ALTER TABLE ONLY aicon2016_specialdiet
...
ALTER TABLE ONLY animecon2015_night
...
ALTER TABLE ONLY animecon2015_signupextra_lodging_needs
...
ALTER TABLE ONLY animecon2015_signupextra
...
ALTER TABLE ONLY animecon2015_signupextra_special_diet
...
ALTER TABLE ONLY animecon2015_specialdiet
...
ALTER TABLE ONLY animecon2016_night
...
ALTER TABLE ONLY animecon2016_signupextra_lodging_needs
...
ALTER TABLE ONLY animecon2016_signupextra
...
ALTER TABLE ONLY animecon2016_signupextra_special_diet
...
ALTER TABLE ONLY animecon2016_specialdiet
...
ALTER TABLE ONLY badges_badgeseventmeta
...
ALTER TABLE ONLY core_carouselslide
...
ALTER TABLE ONLY core_emailverificationtoken
...
ALTER TABLE ONLY core_organization
...
ALTER TABLE ONLY core_passwordresettoken
...
ALTER TABLE ONLY desucon2016_signupextra
...
ALTER TABLE ONLY desucon2016_signupextra_special_diet
...
ALTER TABLE ONLY desucon2016_signupextrav2
...
ALTER TABLE ONLY desucon2016_signupextrav2_special_diet
...
ALTER TABLE ONLY desucon2016_specialdiet
...
ALTER TABLE ONLY desucon2017_signupextra
...
ALTER TABLE ONLY desucon2017_signupextra_special_diet
...
ALTER TABLE ONLY desucon2017_specialdiet
...
ALTER TABLE ONLY desuprofile_integration_confirmationcode
...
ALTER TABLE ONLY desuprofile_integration_connection
...
ALTER TABLE ONLY directory_directoryaccessgroup
...
ALTER TABLE ONLY directory_directoryorganizationmeta
...
ALTER TABLE ONLY enrollment_conconpart
...
ALTER TABLE ONLY enrollment_enrollment_concon_parts
...
ALTER TABLE ONLY enrollment_enrollment
...
ALTER TABLE ONLY enrollment_enrollment_special_diet
...
ALTER TABLE ONLY enrollment_enrollmenteventmeta
...
ALTER TABLE ONLY enrollment_specialdiet
...
ALTER TABLE ONLY event_log_entry
...
ALTER TABLE ONLY event_log_subscription
...
ALTER TABLE ONLY feedback_feedbackmessage
...
ALTER TABLE ONLY finncon2016_signupextra
...
ALTER TABLE ONLY finncon2016_signupextra_special_diet
...
ALTER TABLE ONLY finncon2016_specialdiet
...
ALTER TABLE ONLY frostbite2016_signupextra
...
ALTER TABLE ONLY frostbite2017_signupextra
...
ALTER TABLE ONLY frostbite2017_signupextra_special_diet
...
ALTER TABLE ONLY frostbite2017_specialdiet
...
ALTER TABLE ONLY frostbite2018_signupextra
...
ALTER TABLE ONLY frostbite2018_signupextra_special_diet
...
ALTER TABLE ONLY frostbite2018_specialdiet
...
ALTER TABLE ONLY hitpoint2015_signupextra
...
ALTER TABLE ONLY hitpoint2015_signupextra_special_diet
...
ALTER TABLE ONLY hitpoint2015_specialdiet
...
ALTER TABLE ONLY hitpoint2017_signupextra
...
ALTER TABLE ONLY hitpoint2017_signupextra_special_diet
...
ALTER TABLE ONLY hitpoint2017_specialdiet
...
ALTER TABLE ONLY hitpoint2017_timeslot
...
ALTER TABLE ONLY intra_intraeventmeta
...
ALTER TABLE ONLY intra_teammember
...
ALTER TABLE ONLY kawacon2016_night
...
ALTER TABLE ONLY kawacon2016_signupextra_needs_lodging
...
ALTER TABLE ONLY kawacon2016_signupextra
...
ALTER TABLE ONLY kawacon2016_signupextra_special_diet
...
ALTER TABLE ONLY kawacon2016_specialdiet
...
ALTER TABLE ONLY kawacon2017_night
...
ALTER TABLE ONLY kawacon2017_shift
...
ALTER TABLE ONLY kawacon2017_signupextra_needs_lodging
...
ALTER TABLE ONLY kawacon2017_signupextra
...
ALTER TABLE ONLY kawacon2017_signupextra_shifts
...
ALTER TABLE ONLY kawacon2017_signupextra_special_diet
...
ALTER TABLE ONLY kawacon2017_specialdiet
...
ALTER TABLE ONLY kuplii2015_signupextra
...
ALTER TABLE ONLY kuplii2015_signupextra_special_diet
...
ALTER TABLE ONLY kuplii2015_specialdiet
...
ALTER TABLE ONLY kuplii2016_signupextra
...
ALTER TABLE ONLY kuplii2016_signupextra_special_diet
...
ALTER TABLE ONLY kuplii2016_specialdiet
...
ALTER TABLE ONLY kuplii2017_signupextra
...
ALTER TABLE ONLY kuplii2017_signupextra_special_diet
...
ALTER TABLE ONLY kuplii2017_specialdiet
...
ALTER TABLE ONLY kuplii2018_signupextra
...
ALTER TABLE ONLY kuplii2018_signupextra_special_diet
...
ALTER TABLE ONLY kuplii2018_specialdiet
...
ALTER TABLE ONLY labour_alternativesignupform
...
ALTER TABLE ONLY labour_common_qualifications_jvkortti
...
ALTER TABLE ONLY labour_emptysignupextra
...
ALTER TABLE ONLY labour_obsoleteemptysignupextrav1
...
ALTER TABLE ONLY labour_infolink
...
ALTER TABLE ONLY labour_jobcategory
...
ALTER TABLE ONLY labour_jobcategory_personnel_classes
...
ALTER TABLE ONLY labour_jobcategory_required_qualifications
...
ALTER TABLE ONLY labour_jobrequirement
...
ALTER TABLE ONLY labour_laboureventmeta
...
ALTER TABLE ONLY labour_personnelclass
...
ALTER TABLE ONLY labour_personnelclass_perks
...
ALTER TABLE ONLY labour_personqualification
...
ALTER TABLE ONLY labour_qualification
...
ALTER TABLE ONLY labour_signup_job_categories_accepted
...
ALTER TABLE ONLY labour_signup_job_categories
...
ALTER TABLE ONLY labour_signup_job_categories_rejected
...
ALTER TABLE ONLY labour_signup_personnel_classes
...
ALTER TABLE ONLY labour_signup
...
ALTER TABLE ONLY labour_survey
...
ALTER TABLE ONLY labour_surveyrecord
...
ALTER TABLE ONLY labour_workperiod
...
ALTER TABLE ONLY lakeuscon2016_signupextra
...
ALTER TABLE ONLY lakeuscon2016_signupextra_special_diet
...
ALTER TABLE ONLY lakeuscon2016_specialdiet
...
ALTER TABLE ONLY lippukala_code
...
ALTER TABLE ONLY lippukala_order
...
ALTER TABLE ONLY mailings_message
...
ALTER TABLE ONLY mailings_personmessage
...
ALTER TABLE ONLY mailings_personmessagebody
...
ALTER TABLE ONLY mailings_personmessagesubject
...
ALTER TABLE ONLY mailings_recipientgroup
...
ALTER TABLE ONLY membership_membershipfeepayment
...
ALTER TABLE ONLY membership_membershiporganizationmeta
...
ALTER TABLE ONLY membership_term
...
ALTER TABLE ONLY mimicon2016_night
...
ALTER TABLE ONLY mimicon2016_signupextra_lodging_needs
...
ALTER TABLE ONLY mimicon2016_signupextra
...
ALTER TABLE ONLY mimicon2016_signupextra_special_diet
...
ALTER TABLE ONLY mimicon2016_specialdiet
...
ALTER TABLE ONLY nexmo_deliverystatusfragment
...
ALTER TABLE ONLY nexmo_inboundmessage
...
ALTER TABLE ONLY nexmo_inboundmessagefragment
...
ALTER TABLE ONLY nexmo_outboundmessage
...
ALTER TABLE ONLY nippori2017_signupextra
...
ALTER TABLE ONLY payments_paymentseventmeta
...
ALTER TABLE ONLY popcult2017_signupextra
...
ALTER TABLE ONLY popcult2017_signupextra_special_diet
...
ALTER TABLE ONLY programme_alternativeprogrammeform
...
ALTER TABLE ONLY programme_category
...
ALTER TABLE ONLY programme_freeformorganizer
...
ALTER TABLE ONLY programme_invitation
...
ALTER TABLE ONLY programme_programme_hitpoint2017_preferred_time_slots
...
ALTER TABLE ONLY programme_programme
...
ALTER TABLE ONLY programme_programme_tags
...
ALTER TABLE ONLY programme_programmeeventmeta
...
ALTER TABLE ONLY programme_programmefeedback
...
ALTER TABLE ONLY programme_programmerole
...
ALTER TABLE ONLY programme_role
...
ALTER TABLE ONLY programme_room
...
ALTER TABLE ONLY programme_specialstarttime
...
ALTER TABLE ONLY programme_tag
...
ALTER TABLE ONLY programme_timeblock
...
ALTER TABLE ONLY programme_view
    ADD CONSTRAINT programme_view_pkey PRIMARY KEY (id);


--
-- Name: programme_view_rooms programme_view_rooms_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY programme_view_rooms
    ADD CONSTRAINT programme_view_rooms_pkey PRIMARY KEY (id);


--
-- Name: programme_view_rooms programme_view_rooms_view_id_0af37144_uniq; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY programme_view_rooms
    ADD CONSTRAINT programme_view_rooms_view_id_0af37144_uniq UNIQUE (view_id, room_id);
...
ALTER TABLE ONLY shippocon2016_signupextra
...
ALTER TABLE ONLY shippocon2016_signupextra_special_diet
...
ALTER TABLE ONLY shippocon2016_specialdiet
...
ALTER TABLE ONLY sms_nominee_category
...
ALTER TABLE ONLY sms_smseventmeta
...
ALTER TABLE ONLY sms_smsmessagein
...
ALTER TABLE ONLY sms_smsmessageout
...
ALTER TABLE ONLY sms_votecategory
...
ALTER TABLE ONLY surveys_eventsurvey
...
ALTER TABLE ONLY surveys_eventsurveyresult
...
ALTER TABLE ONLY surveys_globalsurvey
...
ALTER TABLE ONLY surveys_globalsurveyresult
...
ALTER TABLE ONLY tickets_accommodationinformation_limit_groups
...
ALTER TABLE ONLY tickets_accommodationinformation
...
ALTER TABLE ONLY tickets_batch
...
ALTER TABLE ONLY tickets_customer
...
ALTER TABLE ONLY tickets_limitgroup
...
ALTER TABLE ONLY tickets_order
...
ALTER TABLE ONLY tickets_orderproduct
...
ALTER TABLE ONLY tickets_product_limit_groups
...
ALTER TABLE ONLY tickets_product
...
ALTER TABLE ONLY tickets_shirtorder
...
ALTER TABLE ONLY tickets_shirtsize
...
ALTER TABLE ONLY tickets_shirttype
...
ALTER TABLE ONLY tickets_ticketseventmeta
...
ALTER TABLE ONLY tracon11_night
...
ALTER TABLE ONLY tracon11_signupextra_lodging_needs
...
ALTER TABLE ONLY tracon11_signupextra
...
ALTER TABLE ONLY tracon11_signupextra_special_diet
...
ALTER TABLE ONLY tracon11_signupextrav2_lodging_needs
...
ALTER TABLE ONLY tracon11_signupextrav2
...
ALTER TABLE ONLY tracon11_signupextrav2_special_diet
...
ALTER TABLE ONLY tracon11_specialdiet
...
ALTER TABLE ONLY tracon2017_night
...
ALTER TABLE ONLY tracon2017_poison
...
ALTER TABLE ONLY tracon2017_signupextra_lodging_needs
...
ALTER TABLE ONLY tracon2017_signupextra
...
ALTER TABLE ONLY tracon2017_signupextra_pick_your_poison
...
ALTER TABLE ONLY tracon2017_signupextra_special_diet
...
ALTER TABLE ONLY tracon2018_night
...
ALTER TABLE ONLY tracon2018_signupextra_lodging_needs
...
ALTER TABLE ONLY tracon2018_signupextra
...
ALTER TABLE ONLY tracon2018_signupextra_special_diet
...
ALTER TABLE ONLY tracon9_night
...
ALTER TABLE ONLY tracon9_signupextra_lodging_needs
...
ALTER TABLE ONLY tracon9_signupextra
...
ALTER TABLE ONLY tracon9_signupextra_special_diet
...
ALTER TABLE ONLY tracon9_specialdiet
...
ALTER TABLE ONLY traconx_night
...
ALTER TABLE ONLY traconx_signupextra_lodging_needs
...
ALTER TABLE ONLY traconx_signupextra
...
ALTER TABLE ONLY traconx_signupextra_special_diet
...
ALTER TABLE ONLY traconx_specialdiet
...
ALTER TABLE ONLY tylycon2017_signupextra
...
ALTER TABLE ONLY tylycon2017_signupextra_special_diet
...
ALTER TABLE ONLY tylycon2017_specialdiet
...
ALTER TABLE ONLY worldcon75_signupextra
...
ALTER TABLE ONLY worldcon75_signupextra_special_diet
...
ALTER TABLE ONLY yukicon2016_signupextra
...
ALTER TABLE ONLY yukicon2016_signupextra_special_diet
...
ALTER TABLE ONLY yukicon2016_specialdiet
...
ALTER TABLE ONLY yukicon2017_eventday
...
ALTER TABLE ONLY yukicon2017_signupextra
...
ALTER TABLE ONLY yukicon2017_signupextra_special_diet
...
ALTER TABLE ONLY yukicon2017_signupextra_work_days
...
ALTER TABLE ONLY yukicon2017_specialdiet
...
ALTER TABLE ONLY yukicon2018_eventday
...
ALTER TABLE ONLY yukicon2018_signupextra
...
ALTER TABLE ONLY yukicon2018_signupextra_special_diet
...
ALTER TABLE ONLY yukicon2018_signupextra_work_days
...
ALTER TABLE ONLY yukicon2018_specialdiet
...
CREATE INDEX access_accessorganizationmeta_0a405bd6 ON access_accessorganizationmeta USING btree (admin_group_id);
...
CREATE INDEX access_emailalias_662cbf12 ON access_emailalias USING btree (domain_id);
...
CREATE INDEX access_emailalias_94757cae ON access_emailalias USING btree (type_id);
...
CREATE INDEX access_emailalias_a8452ca7 ON access_emailalias USING btree (person_id);
...
CREATE INDEX access_emailalias_e4795667 ON access_emailalias USING btree (group_grant_id);
...
CREATE INDEX access_emailaliasdomain_26b2345e ON access_emailaliasdomain USING btree (organization_id);
...
CREATE INDEX access_emailaliasdomain_domain_name_a0a33fc7_like ON access_emailaliasdomain USING btree (domain_name varchar_pattern_ops);
...
CREATE INDEX access_emailaliastype_662cbf12 ON access_emailaliastype USING btree (domain_id);
...
CREATE INDEX access_grantedprivilege_a3783896 ON access_grantedprivilege USING btree (privilege_id);
...
CREATE INDEX access_grantedprivilege_a8452ca7 ON access_grantedprivilege USING btree (person_id);
...
CREATE INDEX access_groupemailaliasgrant_0e939a4f ON access_groupemailaliasgrant USING btree (group_id);
...
CREATE INDEX access_groupemailaliasgrant_94757cae ON access_groupemailaliasgrant USING btree (type_id);
...
CREATE INDEX access_groupprivilege_0e939a4f ON access_groupprivilege USING btree (group_id);
...
CREATE INDEX access_groupprivilege_4437cfac ON access_groupprivilege USING btree (event_id);
...
CREATE INDEX access_groupprivilege_a3783896 ON access_groupprivilege USING btree (privilege_id);
...
CREATE INDEX access_internalemailalias_4437cfac ON access_internalemailalias USING btree (event_id);
...
CREATE INDEX access_internalemailalias_662cbf12 ON access_internalemailalias USING btree (domain_id);
...
CREATE INDEX access_privilege_slug_4cf01a26_like ON access_privilege USING btree (slug varchar_pattern_ops);
...
CREATE INDEX access_smtppassword_9548f59c ON access_smtppassword USING btree (smtp_server_id);
...
CREATE INDEX access_smtppassword_a8452ca7 ON access_smtppassword USING btree (person_id);
...
CREATE INDEX access_smtpserver_domains_1993bf2a ON access_smtpserver_domains USING btree (smtpserver_id);
...
CREATE INDEX access_smtpserver_domains_5defd3e8 ON access_smtpserver_domains USING btree (emailaliasdomain_id);
...
CREATE INDEX aicon2016_signupextra_special_diet_42414328 ON aicon2016_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX aicon2016_signupextra_special_diet_d37df680 ON aicon2016_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX animecon2015_signupextra_lodging_needs_42414328 ON animecon2015_signupextra_lodging_needs USING btree (signupextra_id);
...
CREATE INDEX animecon2015_signupextra_lodging_needs_a9142bf0 ON animecon2015_signupextra_lodging_needs USING btree (night_id);
...
CREATE INDEX animecon2015_signupextra_special_diet_42414328 ON animecon2015_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX animecon2015_signupextra_special_diet_d37df680 ON animecon2015_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX animecon2016_signupextra_lodging_needs_42414328 ON animecon2016_signupextra_lodging_needs USING btree (signupextra_id);
...
CREATE INDEX animecon2016_signupextra_lodging_needs_a9142bf0 ON animecon2016_signupextra_lodging_needs USING btree (night_id);
...
CREATE INDEX animecon2016_signupextra_special_diet_42414328 ON animecon2016_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX animecon2016_signupextra_special_diet_d37df680 ON animecon2016_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX badges_badge_87104232 ON badges_badge USING btree (revoked_by_id);
...
CREATE INDEX badges_badge_a074c466 ON badges_badge USING btree (personnel_class_id);
...
CREATE INDEX badges_badge_a8452ca7 ON badges_badge USING btree (person_id);
...
CREATE INDEX badges_badge_d4e60137 ON badges_badge USING btree (batch_id);
...
CREATE INDEX badges_badge_e93cb7eb ON badges_badge USING btree (created_by_id);
...
CREATE INDEX badges_badgeseventmeta_0a405bd6 ON badges_badgeseventmeta USING btree (admin_group_id);
...
CREATE INDEX badges_batch_4437cfac ON badges_batch USING btree (event_id);
...
CREATE INDEX badges_batch_a074c466 ON badges_batch USING btree (personnel_class_id);
...
CREATE INDEX core_emailverificationtoken_a8452ca7 ON core_emailverificationtoken USING btree (person_id);
...
CREATE INDEX core_emailverificationtoken_code_058f42bf_like ON core_emailverificationtoken USING btree (code varchar_pattern_ops);
...
CREATE INDEX core_emailverificationtoken_person_id_504d87f6_idx ON core_emailverificationtoken USING btree (person_id, state);
...
CREATE INDEX core_event_26b2345e ON core_event USING btree (organization_id);
...
CREATE INDEX core_event_f3a4803c ON core_event USING btree (venue_id);
...
CREATE INDEX core_event_slug_cb4996eb_like ON core_event USING btree (slug varchar_pattern_ops);
...
CREATE INDEX core_organization_slug_d23b3126_like ON core_organization USING btree (slug varchar_pattern_ops);
...
CREATE INDEX core_passwordresettoken_a8452ca7 ON core_passwordresettoken USING btree (person_id);
...
CREATE INDEX core_passwordresettoken_code_5d6e960c_like ON core_passwordresettoken USING btree (code varchar_pattern_ops);
...
CREATE INDEX core_passwordresettoken_person_id_b727e8c1_idx ON core_passwordresettoken USING btree (person_id, state);
...
CREATE INDEX desucon2016_signupextra_special_diet_42414328 ON desucon2016_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX desucon2016_signupextra_special_diet_d37df680 ON desucon2016_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX desucon2016_signupextrav2_4437cfac ON desucon2016_signupextrav2 USING btree (event_id);
...
CREATE INDEX desucon2016_signupextrav2_special_diet_328bf3a7 ON desucon2016_signupextrav2_special_diet USING btree (signupextrav2_id);
...
CREATE INDEX desucon2016_signupextrav2_special_diet_d37df680 ON desucon2016_signupextrav2_special_diet USING btree (specialdiet_id);
...
CREATE INDEX desucon2017_signupextra_4437cfac ON desucon2017_signupextra USING btree (event_id);
...
CREATE INDEX desucon2017_signupextra_special_diet_42414328 ON desucon2017_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX desucon2017_signupextra_special_diet_d37df680 ON desucon2017_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX desuprofile_integration_confirmationcode_a8452ca7 ON desuprofile_integration_confirmationcode USING btree (person_id);
...
CREATE INDEX desuprofile_integration_confirmationcode_code_b91a1441_like ON desuprofile_integration_confirmationcode USING btree (code varchar_pattern_ops);
...
CREATE INDEX desuprofile_integration_confirmationcode_person_id_756dd8a0_idx ON desuprofile_integration_confirmationcode USING btree (person_id, state);
...
CREATE INDEX directory_directoryaccessgroup_0e939a4f ON directory_directoryaccessgroup USING btree (group_id);
...
CREATE INDEX directory_directoryaccessgroup_26b2345e ON directory_directoryaccessgroup USING btree (organization_id);
...
CREATE INDEX enrollment_enrollment_4437cfac ON enrollment_enrollment USING btree (event_id);
...
CREATE INDEX enrollment_enrollment_a8452ca7 ON enrollment_enrollment USING btree (person_id);
...
CREATE INDEX enrollment_enrollment_concon_parts_537d5933 ON enrollment_enrollment_concon_parts USING btree (enrollment_id);
...
CREATE INDEX enrollment_enrollment_concon_parts_acd061c6 ON enrollment_enrollment_concon_parts USING btree (conconpart_id);
...
CREATE INDEX enrollment_enrollment_special_diet_537d5933 ON enrollment_enrollment_special_diet USING btree (enrollment_id);
...
CREATE INDEX enrollment_enrollment_special_diet_d37df680 ON enrollment_enrollment_special_diet USING btree (specialdiet_id);
...
CREATE INDEX enrollment_enrollmenteventmeta_0a405bd6 ON enrollment_enrollmenteventmeta USING btree (admin_group_id);
...
CREATE INDEX event_log_entry_26b2345e ON event_log_entry USING btree (organization_id);
...
CREATE INDEX event_log_entry_4437cfac ON event_log_entry USING btree (event_id);
...
CREATE INDEX event_log_entry_94217c21 ON event_log_entry USING btree (event_survey_result_id);
...
CREATE INDEX event_log_entry_a8452ca7 ON event_log_entry USING btree (person_id);
...
CREATE INDEX event_log_entry_ce3922cc ON event_log_entry USING btree (global_survey_result_id);
...
CREATE INDEX event_log_entry_d4b7764b ON event_log_entry USING btree (feedback_message_id);
...
CREATE INDEX event_log_entry_e93cb7eb ON event_log_entry USING btree (created_by_id);
...
CREATE INDEX event_log_entry_fde81f11 ON event_log_entry USING btree (created_at);
...
CREATE INDEX event_log_subscription_be324941 ON event_log_subscription USING btree (event_survey_filter_id);
...
CREATE INDEX event_log_subscription_e8701ad4 ON event_log_subscription USING btree (user_id);
...
CREATE INDEX event_log_subscription_entry_type_22ff4449_idx ON event_log_subscription USING btree (entry_type, active);
...
CREATE INDEX event_log_subscription_fdf6aa58 ON event_log_subscription USING btree (event_filter_id);
...
CREATE INDEX feedback_feedbackmessage_4f331e2f ON feedback_feedbackmessage USING btree (author_id);
...
CREATE INDEX finncon2016_signupextra_special_diet_42414328 ON finncon2016_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX finncon2016_signupextra_special_diet_d37df680 ON finncon2016_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX frostbite2017_signupextra_4437cfac ON frostbite2017_signupextra USING btree (event_id);
...
CREATE INDEX frostbite2017_signupextra_special_diet_42414328 ON frostbite2017_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX frostbite2017_signupextra_special_diet_d37df680 ON frostbite2017_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX frostbite2018_signupextra_4437cfac ON frostbite2018_signupextra USING btree (event_id);
...
CREATE INDEX frostbite2018_signupextra_special_diet_42414328 ON frostbite2018_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX frostbite2018_signupextra_special_diet_d37df680 ON frostbite2018_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX hitpoint2015_signupextra_special_diet_42414328 ON hitpoint2015_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX hitpoint2015_signupextra_special_diet_d37df680 ON hitpoint2015_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX hitpoint2017_signupextra_special_diet_42414328 ON hitpoint2017_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX hitpoint2017_signupextra_special_diet_d37df680 ON hitpoint2017_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX intra_intraeventmeta_0a405bd6 ON intra_intraeventmeta USING btree (admin_group_id);
...
CREATE INDEX intra_intraeventmeta_bb1ca3df ON intra_intraeventmeta USING btree (organizer_group_id);
...
CREATE INDEX intra_team_0e939a4f ON intra_team USING btree (group_id);
...
CREATE INDEX intra_team_4437cfac ON intra_team USING btree (event_id);
...
CREATE INDEX intra_teammember_a8452ca7 ON intra_teammember USING btree (person_id);
...
CREATE INDEX intra_teammember_f6a7ca40 ON intra_teammember USING btree (team_id);
...
CREATE INDEX kawacon2016_signupextra_needs_lodging_42414328 ON kawacon2016_signupextra_needs_lodging USING btree (signupextra_id);
...
CREATE INDEX kawacon2016_signupextra_needs_lodging_a9142bf0 ON kawacon2016_signupextra_needs_lodging USING btree (night_id);
...
CREATE INDEX kawacon2016_signupextra_special_diet_42414328 ON kawacon2016_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX kawacon2016_signupextra_special_diet_d37df680 ON kawacon2016_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX kawacon2017_signupextra_4437cfac ON kawacon2017_signupextra USING btree (event_id);
...
CREATE INDEX kawacon2017_signupextra_needs_lodging_42414328 ON kawacon2017_signupextra_needs_lodging USING btree (signupextra_id);
...
CREATE INDEX kawacon2017_signupextra_needs_lodging_a9142bf0 ON kawacon2017_signupextra_needs_lodging USING btree (night_id);
...
CREATE INDEX kawacon2017_signupextra_shifts_42414328 ON kawacon2017_signupextra_shifts USING btree (signupextra_id);
...
CREATE INDEX kawacon2017_signupextra_shifts_92547d67 ON kawacon2017_signupextra_shifts USING btree (shift_id);
...
CREATE INDEX kawacon2017_signupextra_special_diet_42414328 ON kawacon2017_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX kawacon2017_signupextra_special_diet_d37df680 ON kawacon2017_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX kuplii2015_signupextra_special_diet_42414328 ON kuplii2015_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX kuplii2015_signupextra_special_diet_d37df680 ON kuplii2015_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX kuplii2016_signupextra_special_diet_42414328 ON kuplii2016_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX kuplii2016_signupextra_special_diet_d37df680 ON kuplii2016_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX kuplii2017_signupextra_4437cfac ON kuplii2017_signupextra USING btree (event_id);
...
CREATE INDEX kuplii2017_signupextra_special_diet_42414328 ON kuplii2017_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX kuplii2017_signupextra_special_diet_d37df680 ON kuplii2017_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX kuplii2018_signupextra_4437cfac ON kuplii2018_signupextra USING btree (event_id);
...
CREATE INDEX kuplii2018_signupextra_special_diet_42414328 ON kuplii2018_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX kuplii2018_signupextra_special_diet_d37df680 ON kuplii2018_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX labour_alternativesignupform_4437cfac ON labour_alternativesignupform USING btree (event_id);
...
CREATE INDEX labour_emptysignupextra_4437cfac ON labour_emptysignupextra USING btree (event_id);
...
CREATE INDEX labour_infolink_0e939a4f ON labour_infolink USING btree (group_id);
...
CREATE INDEX labour_infolink_4437cfac ON labour_infolink USING btree (event_id);
...
CREATE INDEX labour_job_7b73164c ON labour_job USING btree (job_category_id);
...
CREATE INDEX labour_jobcategory_4437cfac ON labour_jobcategory USING btree (event_id);
...
CREATE INDEX labour_jobcategory_personnel_classes_057a1cce ON labour_jobcategory_personnel_classes USING btree (personnelclass_id);
...
CREATE INDEX labour_jobcategory_personnel_classes_da1e3d18 ON labour_jobcategory_personnel_classes USING btree (jobcategory_id);
...
CREATE INDEX labour_jobcategory_required_qualifications_068509ea ON labour_jobcategory_required_qualifications USING btree (qualification_id);
...
CREATE INDEX labour_jobcategory_required_qualifications_da1e3d18 ON labour_jobcategory_required_qualifications USING btree (jobcategory_id);
...
CREATE INDEX labour_jobrequirement_d697ea38 ON labour_jobrequirement USING btree (job_id);
...
CREATE INDEX labour_laboureventmeta_0a405bd6 ON labour_laboureventmeta USING btree (admin_group_id);
...
CREATE INDEX labour_laboureventmeta_8909846a ON labour_laboureventmeta USING btree (signup_extra_content_type_id);
...
CREATE INDEX labour_perk_4437cfac ON labour_perk USING btree (event_id);
...
CREATE INDEX labour_personnelclass_4437cfac ON labour_personnelclass USING btree (event_id);
...
CREATE INDEX labour_personnelclass_event_id_fb0d1adb_idx ON labour_personnelclass USING btree (event_id, app_label);
...
CREATE INDEX labour_personnelclass_perks_057a1cce ON labour_personnelclass_perks USING btree (personnelclass_id);
...
CREATE INDEX labour_personnelclass_perks_239a4dc4 ON labour_personnelclass_perks USING btree (perk_id);
...
CREATE INDEX labour_personqualification_068509ea ON labour_personqualification USING btree (qualification_id);
...
CREATE INDEX labour_personqualification_a8452ca7 ON labour_personqualification USING btree (person_id);
...
CREATE INDEX labour_qualification_9c641fc7 ON labour_qualification USING btree (qualification_extra_content_type_id);
...
CREATE INDEX labour_qualification_slug_d623f695_like ON labour_qualification USING btree (slug varchar_pattern_ops);
...
CREATE INDEX labour_shift_cc389636 ON labour_shift USING btree (signup_id);
...
CREATE INDEX labour_shift_d697ea38 ON labour_shift USING btree (job_id);
...
CREATE INDEX labour_signup_4437cfac ON labour_signup USING btree (event_id);
...
CREATE INDEX labour_signup_a8452ca7 ON labour_signup USING btree (person_id);
...
CREATE INDEX labour_signup_f011526f ON labour_signup USING btree (alternative_signup_form_used_id);
...
CREATE INDEX labour_signup_job_categories_accepted_cc389636 ON labour_signup_job_categories_accepted USING btree (signup_id);
...
CREATE INDEX labour_signup_job_categories_accepted_da1e3d18 ON labour_signup_job_categories_accepted USING btree (jobcategory_id);
...
CREATE INDEX labour_signup_job_categories_cc389636 ON labour_signup_job_categories USING btree (signup_id);
...
CREATE INDEX labour_signup_job_categories_da1e3d18 ON labour_signup_job_categories USING btree (jobcategory_id);
...
CREATE INDEX labour_signup_job_categories_rejected_cc389636 ON labour_signup_job_categories_rejected USING btree (signup_id);
...
CREATE INDEX labour_signup_job_categories_rejected_da1e3d18 ON labour_signup_job_categories_rejected USING btree (jobcategory_id);
...
CREATE INDEX labour_signup_personnel_classes_057a1cce ON labour_signup_personnel_classes USING btree (personnelclass_id);
...
CREATE INDEX labour_signup_personnel_classes_cc389636 ON labour_signup_personnel_classes USING btree (signup_id);
...
CREATE INDEX labour_survey_4437cfac ON labour_survey USING btree (event_id);
...
CREATE INDEX labour_surveyrecord_00b3bd7e ON labour_surveyrecord USING btree (survey_id);
...
CREATE INDEX labour_surveyrecord_a8452ca7 ON labour_surveyrecord USING btree (person_id);
...
CREATE INDEX labour_workperiod_4437cfac ON labour_workperiod USING btree (event_id);
...
CREATE INDEX lakeuscon2016_signupextra_special_diet_42414328 ON lakeuscon2016_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX lakeuscon2016_signupextra_special_diet_d37df680 ON lakeuscon2016_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX lippukala_code_69dfcb07 ON lippukala_code USING btree (order_id);
...
CREATE INDEX lippukala_code_code_40127e1c_like ON lippukala_code USING btree (code varchar_pattern_ops);
...
CREATE INDEX lippukala_order_reference_number_222cf9ed_like ON lippukala_order USING btree (reference_number varchar_pattern_ops);
...
CREATE INDEX mailings_message_8b938c66 ON mailings_message USING btree (recipient_id);
...
CREATE INDEX mailings_personmessage_1d0adb55 ON mailings_personmessage USING btree (body_id);
...
CREATE INDEX mailings_personmessage_4ccaa172 ON mailings_personmessage USING btree (message_id);
...
CREATE INDEX mailings_personmessage_a8452ca7 ON mailings_personmessage USING btree (person_id);
...
CREATE INDEX mailings_personmessage_ffaba1d1 ON mailings_personmessage USING btree (subject_id);
...
CREATE INDEX mailings_personmessagebody_c10f7796 ON mailings_personmessagebody USING btree (digest);
...
CREATE INDEX mailings_personmessagebody_digest_3a7f7175_like ON mailings_personmessagebody USING btree (digest varchar_pattern_ops);
...
CREATE INDEX mailings_personmessagesubject_c10f7796 ON mailings_personmessagesubject USING btree (digest);
...
CREATE INDEX mailings_personmessagesubject_digest_4e3a1b37_like ON mailings_personmessagesubject USING btree (digest varchar_pattern_ops);
...
CREATE INDEX mailings_recipientgroup_0e939a4f ON mailings_recipientgroup USING btree (group_id);
...
CREATE INDEX mailings_recipientgroup_4437cfac ON mailings_recipientgroup USING btree (event_id);
...
CREATE INDEX mailings_recipientgroup_7b73164c ON mailings_recipientgroup USING btree (job_category_id);
...
CREATE INDEX mailings_recipientgroup_a074c466 ON mailings_recipientgroup USING btree (personnel_class_id);
...
CREATE INDEX membership_membership_26b2345e ON membership_membership USING btree (organization_id);
...
CREATE INDEX membership_membership_a8452ca7 ON membership_membership USING btree (person_id);
...
CREATE INDEX membership_membershipfeepayment_b5c3e75b ON membership_membershipfeepayment USING btree (member_id);
...
CREATE INDEX membership_membershipfeepayment_ba3248a2 ON membership_membershipfeepayment USING btree (term_id);
...
CREATE INDEX membership_membershiporganizationmeta_0a405bd6 ON membership_membershiporganizationmeta USING btree (admin_group_id);
...
CREATE INDEX membership_membershiporganizationmeta_3c8dfdf4 ON membership_membershiporganizationmeta USING btree (members_group_id);
...
CREATE INDEX membership_term_26b2345e ON membership_term USING btree (organization_id);
...
CREATE INDEX mimicon2016_signupextra_lodging_needs_42414328 ON mimicon2016_signupextra_lodging_needs USING btree (signupextra_id);
...
CREATE INDEX mimicon2016_signupextra_lodging_needs_a9142bf0 ON mimicon2016_signupextra_lodging_needs USING btree (night_id);
...
CREATE INDEX mimicon2016_signupextra_special_diet_42414328 ON mimicon2016_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX mimicon2016_signupextra_special_diet_d37df680 ON mimicon2016_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX nexmo_deliverystatusfragment_4ccaa172 ON nexmo_deliverystatusfragment USING btree (message_id);
...
CREATE INDEX nippori2017_signupextra_4437cfac ON nippori2017_signupextra USING btree (event_id);
...
CREATE INDEX payments_payment_4437cfac ON payments_payment USING btree (event_id);
...
CREATE INDEX payments_paymentseventmeta_0a405bd6 ON payments_paymentseventmeta USING btree (admin_group_id);
...
CREATE INDEX popcult2017_signupextra_4437cfac ON popcult2017_signupextra USING btree (event_id);
...
CREATE INDEX popcult2017_signupextra_special_diet_42414328 ON popcult2017_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX popcult2017_signupextra_special_diet_d37df680 ON popcult2017_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX programme_alternativeprogrammeform_4437cfac ON programme_alternativeprogrammeform USING btree (event_id);
...
CREATE INDEX programme_category_4437cfac ON programme_category USING btree (event_id);
...
CREATE INDEX programme_freeformorganizer_82558bcc ON programme_freeformorganizer USING btree (programme_id);
...
CREATE INDEX programme_invitation_82558bcc ON programme_invitation USING btree (programme_id);
...
CREATE INDEX programme_invitation_84566833 ON programme_invitation USING btree (role_id);
...
CREATE INDEX programme_invitation_c6923410 ON programme_invitation USING btree (sire_id);
...
CREATE INDEX programme_invitation_code_88366215_like ON programme_invitation USING btree (code varchar_pattern_ops);
...
CREATE INDEX programme_invitation_e93cb7eb ON programme_invitation USING btree (created_by_id);
...
CREATE INDEX programme_programme_8273f993 ON programme_programme USING btree (room_id);
...
CREATE INDEX programme_programme_a8042b24 ON programme_programme USING btree (form_used_id);
...
CREATE INDEX programme_programme_b583a629 ON programme_programme USING btree (category_id);
...
CREATE INDEX programme_programme_category_id_6e4de3a1_idx ON programme_programme USING btree (category_id, state);
...
CREATE INDEX programme_programme_hitpoint2017_preferred_time_slots_0c7d745e ON programme_programme_hitpoint2017_preferred_time_slots USING btree (timeslot_id);
...
CREATE INDEX programme_programme_hitpoint2017_preferred_time_slots_82558bcc ON programme_programme_hitpoint2017_preferred_time_slots USING btree (programme_id);
...
CREATE INDEX programme_programme_tags_76f094bc ON programme_programme_tags USING btree (tag_id);
...
CREATE INDEX programme_programme_tags_82558bcc ON programme_programme_tags USING btree (programme_id);
...
CREATE INDEX programme_programmeeventmeta_0a405bd6 ON programme_programmeeventmeta USING btree (admin_group_id);
...
CREATE INDEX programme_programmefeedback_4f331e2f ON programme_programmefeedback USING btree (author_id);
...
CREATE INDEX programme_programmefeedback_82558bcc ON programme_programmefeedback USING btree (programme_id);
...
CREATE INDEX programme_programmefeedback_b254ccb6 ON programme_programmefeedback USING btree (hidden_by_id);
...
CREATE INDEX programme_programmerole_06af5fcd ON programme_programmerole USING btree (invitation_id);
...
CREATE INDEX programme_programmerole_82558bcc ON programme_programmerole USING btree (programme_id);
...
CREATE INDEX programme_programmerole_84566833 ON programme_programmerole USING btree (role_id);
...
CREATE INDEX programme_programmerole_a8452ca7 ON programme_programmerole USING btree (person_id);
...
CREATE INDEX programme_role_a074c466 ON programme_role USING btree (personnel_class_id);
...
CREATE INDEX programme_room_4437cfac ON programme_room USING btree (event_id);
...
CREATE INDEX programme_specialstarttime_4437cfac ON programme_specialstarttime USING btree (event_id);
...
CREATE INDEX programme_tag_4437cfac ON programme_tag USING btree (event_id);
...
CREATE INDEX programme_timeblock_4437cfac ON programme_timeblock USING btree (event_id);
...
CREATE INDEX programme_view_4437cfac ON programme_view USING btree (event_id);


--
-- Name: programme_view_rooms_2e1a1398; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX programme_view_rooms_2e1a1398 ON programme_view_rooms USING btree (view_id);


--
-- Name: programme_view_rooms_8273f993; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX programme_view_rooms_8273f993 ON programme_view_rooms USING btree (room_id);
...
CREATE INDEX shippocon2016_signupextra_4437cfac ON shippocon2016_signupextra USING btree (event_id);
...
CREATE INDEX shippocon2016_signupextra_special_diet_42414328 ON shippocon2016_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX shippocon2016_signupextra_special_diet_d37df680 ON shippocon2016_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX sms_hotword_2dbcba41 ON sms_hotword USING btree (slug);
...
CREATE INDEX sms_hotword_b44cd550 ON sms_hotword USING btree (assigned_event_id);
...
CREATE INDEX sms_hotword_slug_ab608568_like ON sms_hotword USING btree (slug varchar_pattern_ops);
...
CREATE INDEX sms_nominee_category_1c5b751a ON sms_nominee_category USING btree (votecategory_id);
...
CREATE INDEX sms_nominee_category_2e0f1201 ON sms_nominee_category USING btree (nominee_id);
...
CREATE INDEX sms_smseventmeta_0a405bd6 ON sms_smseventmeta USING btree (admin_group_id);
...
CREATE INDEX sms_smsmessagein_4ccaa172 ON sms_smsmessagein USING btree (message_id);
...
CREATE INDEX sms_smsmessagein_e7ebb2d3 ON sms_smsmessagein USING btree ("SMSEventMeta_id");
...
CREATE INDEX sms_smsmessageout_4437cfac ON sms_smsmessageout USING btree (event_id);
...
CREATE INDEX sms_smsmessageout_97c31eab ON sms_smsmessageout USING btree (ref_id);
...
CREATE INDEX sms_vote_4ccaa172 ON sms_vote USING btree (message_id);
...
CREATE INDEX sms_vote_b583a629 ON sms_vote USING btree (category_id);
...
CREATE INDEX sms_vote_vote_id_229694d2_uniq ON sms_vote USING btree (vote_id);
...
CREATE INDEX sms_votecategory_2dbcba41 ON sms_votecategory USING btree (slug);
...
CREATE INDEX sms_votecategory_8618c9dc ON sms_votecategory USING btree (hotword_id);
...
CREATE INDEX sms_votecategory_slug_c03fb6ca_like ON sms_votecategory USING btree (slug varchar_pattern_ops);
...
CREATE INDEX surveys_eventsurvey_4437cfac ON surveys_eventsurvey USING btree (event_id);
...
CREATE INDEX surveys_eventsurveyresult_00b3bd7e ON surveys_eventsurveyresult USING btree (survey_id);
...
CREATE INDEX surveys_eventsurveyresult_4f331e2f ON surveys_eventsurveyresult USING btree (author_id);
...
CREATE INDEX surveys_globalsurvey_slug_f09c3896_like ON surveys_globalsurvey USING btree (slug varchar_pattern_ops);
...
CREATE INDEX surveys_globalsurveyresult_00b3bd7e ON surveys_globalsurveyresult USING btree (survey_id);
...
CREATE INDEX surveys_globalsurveyresult_4f331e2f ON surveys_globalsurveyresult USING btree (author_id);
...
CREATE INDEX tickets_accommodationinformation_d925f7ee ON tickets_accommodationinformation USING btree (order_product_id);
...
CREATE INDEX tickets_accommodationinformation_limit_groups_66e6cef5 ON tickets_accommodationinformation_limit_groups USING btree (accommodationinformation_id);
...
CREATE INDEX tickets_accommodationinformation_limit_groups_db9ef8e3 ON tickets_accommodationinformation_limit_groups USING btree (limitgroup_id);
...
CREATE INDEX tickets_batch_4437cfac ON tickets_batch USING btree (event_id);
...
CREATE INDEX tickets_limitgroup_4437cfac ON tickets_limitgroup USING btree (event_id);
...
CREATE INDEX tickets_order_4437cfac ON tickets_order USING btree (event_id);
...
CREATE INDEX tickets_order_d4e60137 ON tickets_order USING btree (batch_id);
...
CREATE INDEX tickets_orderproduct_69dfcb07 ON tickets_orderproduct USING btree (order_id);
...
CREATE INDEX tickets_orderproduct_9bea82de ON tickets_orderproduct USING btree (product_id);
...
CREATE INDEX tickets_product_4437cfac ON tickets_product USING btree (event_id);
...
CREATE INDEX tickets_product_limit_groups_9bea82de ON tickets_product_limit_groups USING btree (product_id);
...
CREATE INDEX tickets_product_limit_groups_db9ef8e3 ON tickets_product_limit_groups USING btree (limitgroup_id);
...
CREATE INDEX tickets_shirtorder_69dfcb07 ON tickets_shirtorder USING btree (order_id);
...
CREATE INDEX tickets_shirtorder_8222f9c0 ON tickets_shirtorder USING btree (size_id);
...
CREATE INDEX tickets_shirtsize_94757cae ON tickets_shirtsize USING btree (type_id);
...
CREATE INDEX tickets_shirttype_4437cfac ON tickets_shirttype USING btree (event_id);
...
CREATE INDEX tickets_ticketseventmeta_0a405bd6 ON tickets_ticketseventmeta USING btree (admin_group_id);
...
CREATE INDEX tracon11_signupextra_lodging_needs_42414328 ON tracon11_signupextra_lodging_needs USING btree (signupextra_id);
...
CREATE INDEX tracon11_signupextra_lodging_needs_a9142bf0 ON tracon11_signupextra_lodging_needs USING btree (night_id);
...
CREATE INDEX tracon11_signupextra_special_diet_42414328 ON tracon11_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX tracon11_signupextra_special_diet_d37df680 ON tracon11_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX tracon11_signupextrav2_4437cfac ON tracon11_signupextrav2 USING btree (event_id);
...
CREATE INDEX tracon11_signupextrav2_lodging_needs_328bf3a7 ON tracon11_signupextrav2_lodging_needs USING btree (signupextrav2_id);
...
CREATE INDEX tracon11_signupextrav2_lodging_needs_a9142bf0 ON tracon11_signupextrav2_lodging_needs USING btree (night_id);
...
CREATE INDEX tracon11_signupextrav2_special_diet_328bf3a7 ON tracon11_signupextrav2_special_diet USING btree (signupextrav2_id);
...
CREATE INDEX tracon11_signupextrav2_special_diet_d37df680 ON tracon11_signupextrav2_special_diet USING btree (specialdiet_id);
...
CREATE INDEX tracon2017_signupextra_4437cfac ON tracon2017_signupextra USING btree (event_id);
...
CREATE INDEX tracon2017_signupextra_lodging_needs_42414328 ON tracon2017_signupextra_lodging_needs USING btree (signupextra_id);
...
CREATE INDEX tracon2017_signupextra_lodging_needs_a9142bf0 ON tracon2017_signupextra_lodging_needs USING btree (night_id);
...
CREATE INDEX tracon2017_signupextra_pick_your_poison_42414328 ON tracon2017_signupextra_pick_your_poison USING btree (signupextra_id);
...
CREATE INDEX tracon2017_signupextra_pick_your_poison_fee64e1f ON tracon2017_signupextra_pick_your_poison USING btree (poison_id);
...
CREATE INDEX tracon2017_signupextra_special_diet_42414328 ON tracon2017_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX tracon2017_signupextra_special_diet_d37df680 ON tracon2017_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX tracon2018_signupextra_4437cfac ON tracon2018_signupextra USING btree (event_id);
...
CREATE INDEX tracon2018_signupextra_lodging_needs_42414328 ON tracon2018_signupextra_lodging_needs USING btree (signupextra_id);
...
CREATE INDEX tracon2018_signupextra_lodging_needs_a9142bf0 ON tracon2018_signupextra_lodging_needs USING btree (night_id);
...
CREATE INDEX tracon2018_signupextra_special_diet_42414328 ON tracon2018_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX tracon2018_signupextra_special_diet_d37df680 ON tracon2018_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX tracon9_signupextra_lodging_needs_42414328 ON tracon9_signupextra_lodging_needs USING btree (signupextra_id);
...
CREATE INDEX tracon9_signupextra_lodging_needs_a9142bf0 ON tracon9_signupextra_lodging_needs USING btree (night_id);
...
CREATE INDEX tracon9_signupextra_special_diet_42414328 ON tracon9_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX tracon9_signupextra_special_diet_d37df680 ON tracon9_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX traconx_signupextra_lodging_needs_42414328 ON traconx_signupextra_lodging_needs USING btree (signupextra_id);
...
CREATE INDEX traconx_signupextra_lodging_needs_a9142bf0 ON traconx_signupextra_lodging_needs USING btree (night_id);
...
CREATE INDEX traconx_signupextra_special_diet_42414328 ON traconx_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX traconx_signupextra_special_diet_d37df680 ON traconx_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX tylycon2017_signupextra_4437cfac ON tylycon2017_signupextra USING btree (event_id);
...
CREATE INDEX tylycon2017_signupextra_special_diet_42414328 ON tylycon2017_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX tylycon2017_signupextra_special_diet_d37df680 ON tylycon2017_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX worldcon75_signupextra_4437cfac ON worldcon75_signupextra USING btree (event_id);
...
CREATE INDEX worldcon75_signupextra_special_diet_42414328 ON worldcon75_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX worldcon75_signupextra_special_diet_d37df680 ON worldcon75_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX yukicon2016_signupextra_special_diet_42414328 ON yukicon2016_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX yukicon2016_signupextra_special_diet_d37df680 ON yukicon2016_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX yukicon2017_signupextra_4437cfac ON yukicon2017_signupextra USING btree (event_id);
...
CREATE INDEX yukicon2017_signupextra_special_diet_42414328 ON yukicon2017_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX yukicon2017_signupextra_special_diet_d37df680 ON yukicon2017_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX yukicon2017_signupextra_work_days_42414328 ON yukicon2017_signupextra_work_days USING btree (signupextra_id);
...
CREATE INDEX yukicon2017_signupextra_work_days_99bcb875 ON yukicon2017_signupextra_work_days USING btree (eventday_id);
...
CREATE INDEX yukicon2018_signupextra_4437cfac ON yukicon2018_signupextra USING btree (event_id);
...
CREATE INDEX yukicon2018_signupextra_special_diet_42414328 ON yukicon2018_signupextra_special_diet USING btree (signupextra_id);
...
CREATE INDEX yukicon2018_signupextra_special_diet_d37df680 ON yukicon2018_signupextra_special_diet USING btree (specialdiet_id);
...
CREATE INDEX yukicon2018_signupextra_work_days_42414328 ON yukicon2018_signupextra_work_days USING btree (signupextra_id);
...
CREATE INDEX yukicon2018_signupextra_work_days_99bcb875 ON yukicon2018_signupextra_work_days USING btree (eventday_id);
...
ALTER TABLE ONLY labour_laboureventmeta
    ADD CONSTRAINT "D0c45c90c899f282a1abfffd2f7f77f8" FOREIGN KEY (signup_extra_content_type_id) REFERENCES django_content_type(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_qualification
    ADD CONSTRAINT "D0f16bf4a839240c70d8b1eee5b3779f" FOREIGN KEY (qualification_extra_content_type_id) REFERENCES django_content_type(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY event_log_entry
    ADD CONSTRAINT "D105895583fb84ebcf3b48b9b647b376" FOREIGN KEY (event_survey_result_id) REFERENCES surveys_eventsurveyresult(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY event_log_entry
    ADD CONSTRAINT "D464671a7fd2ba5a5303e1a203243997" FOREIGN KEY (global_survey_result_id) REFERENCES surveys_globalsurveyresult(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_signup
    ADD CONSTRAINT "D4970224b4c616c5e8f24faf0cdf2b41" FOREIGN KEY (alternative_signup_form_used_id) REFERENCES labour_alternativesignupform(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tickets_accommodationinformation_limit_groups
    ADD CONSTRAINT "D7e9d6eac83eb1d24cc3e29661aa71a9" FOREIGN KEY (accommodationinformation_id) REFERENCES tickets_accommodationinformation(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_common_qualifications_jvkortti
    ADD CONSTRAINT "D8a89871f53bc1af42a785ec2a8b778e" FOREIGN KEY (personqualification_id) REFERENCES labour_personqualification(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY animecon2016_signupextra_special_diet
    ADD CONSTRAINT a_signupextra_id_0e3d250b_fk_animecon2016_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES animecon2016_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY animecon2016_signupextra_lodging_needs
    ADD CONSTRAINT a_signupextra_id_0fe70a98_fk_animecon2016_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES animecon2016_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY animecon2015_signupextra_lodging_needs
    ADD CONSTRAINT a_signupextra_id_3e5bfb35_fk_animecon2015_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES animecon2015_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY animecon2015_signupextra_special_diet
    ADD CONSTRAINT a_signupextra_id_4083b445_fk_animecon2015_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES animecon2015_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_smtpserver_domains
    ADD CONSTRAINT acce_emailaliasdomain_id_725c76a4_fk_access_emailaliasdomain_id FOREIGN KEY (emailaliasdomain_id) REFERENCES access_emailaliasdomain(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_emailalias
    ADD CONSTRAINT acces_group_grant_id_2a432527_fk_access_groupemailaliasgrant_id FOREIGN KEY (group_grant_id) REFERENCES access_groupemailaliasgrant(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_accessorganizationmeta
    ADD CONSTRAINT access_accesso_organization_id_6fd5296f_fk_core_organization_id FOREIGN KEY (organization_id) REFERENCES core_organization(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_accessorganizationmeta
    ADD CONSTRAINT access_accessorganizat_admin_group_id_fba465cc_fk_auth_group_id FOREIGN KEY (admin_group_id) REFERENCES auth_group(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_emailalias
    ADD CONSTRAINT access_emailal_domain_id_1c715651_fk_access_emailaliasdomain_id FOREIGN KEY (domain_id) REFERENCES access_emailaliasdomain(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_emailaliastype
    ADD CONSTRAINT access_emailal_domain_id_384f9e33_fk_access_emailaliasdomain_id FOREIGN KEY (domain_id) REFERENCES access_emailaliasdomain(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_emailaliasdomain
    ADD CONSTRAINT access_emailal_organization_id_5bc3eedd_fk_core_organization_id FOREIGN KEY (organization_id) REFERENCES core_organization(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_emailalias
    ADD CONSTRAINT access_emailalias_person_id_d36631ab_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_emailalias
    ADD CONSTRAINT access_emailalias_type_id_707106ba_fk_access_emailaliastype_id FOREIGN KEY (type_id) REFERENCES access_emailaliastype(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_grantedprivilege
    ADD CONSTRAINT access_grantedpriv_privilege_id_6da68281_fk_access_privilege_id FOREIGN KEY (privilege_id) REFERENCES access_privilege(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_grantedprivilege
    ADD CONSTRAINT access_grantedprivilege_person_id_f05c5d84_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_groupemailaliasgrant
    ADD CONSTRAINT access_groupemaila_type_id_9bc02ef3_fk_access_emailaliastype_id FOREIGN KEY (type_id) REFERENCES access_emailaliastype(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_groupemailaliasgrant
    ADD CONSTRAINT access_groupemailaliasgrant_group_id_00052328_fk_auth_group_id FOREIGN KEY (group_id) REFERENCES auth_group(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_groupprivilege
    ADD CONSTRAINT access_groupprivil_privilege_id_036ee3bc_fk_access_privilege_id FOREIGN KEY (privilege_id) REFERENCES access_privilege(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_groupprivilege
    ADD CONSTRAINT access_groupprivilege_event_id_b0b63a87_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_groupprivilege
    ADD CONSTRAINT access_groupprivilege_group_id_5bdb3244_fk_auth_group_id FOREIGN KEY (group_id) REFERENCES auth_group(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_internalemailalias
    ADD CONSTRAINT access_interna_domain_id_ab77b615_fk_access_emailaliasdomain_id FOREIGN KEY (domain_id) REFERENCES access_emailaliasdomain(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_internalemailalias
    ADD CONSTRAINT access_internalemailalias_event_id_67f9e0dd_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_slackaccess
    ADD CONSTRAINT access_slackaccess_privilege_id_d6089b77_fk_access_privilege_id FOREIGN KEY (privilege_id) REFERENCES access_privilege(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_smtppassword
    ADD CONSTRAINT access_smtppass_smtp_server_id_1fbe2a7a_fk_access_smtpserver_id FOREIGN KEY (smtp_server_id) REFERENCES access_smtpserver(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_smtppassword
    ADD CONSTRAINT access_smtppassword_person_id_89672f1a_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY access_smtpserver_domains
    ADD CONSTRAINT access_smtpserve_smtpserver_id_6baacdcb_fk_access_smtpserver_id FOREIGN KEY (smtpserver_id) REFERENCES access_smtpserver(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY aicon2016_signupextra_special_diet
    ADD CONSTRAINT aico_signupextra_id_bbc49f9a_fk_aicon2016_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES aicon2016_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY aicon2016_signupextra_special_diet
    ADD CONSTRAINT aicon2016_s_specialdiet_id_7979648c_fk_aicon2016_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES aicon2016_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY aicon2016_signupextra
    ADD CONSTRAINT aicon2016_signupextra_signup_id_24462d43_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY animecon2015_signupextra_lodging_needs
    ADD CONSTRAINT animecon2015_signupe_night_id_ce59630a_fk_animecon2015_night_id FOREIGN KEY (night_id) REFERENCES animecon2015_night(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY animecon2015_signupextra
    ADD CONSTRAINT animecon2015_signupextra_signup_id_5e198a46_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY animecon2016_signupextra_lodging_needs
    ADD CONSTRAINT animecon2016_signupe_night_id_bc88d453_fk_animecon2016_night_id FOREIGN KEY (night_id) REFERENCES animecon2016_night(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY animecon2016_signupextra
    ADD CONSTRAINT animecon2016_signupextra_signup_id_b7b76e70_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY animecon2016_signupextra_special_diet
    ADD CONSTRAINT animecon_specialdiet_id_11b4f192_fk_animecon2016_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES animecon2016_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY animecon2015_signupextra_special_diet
    ADD CONSTRAINT animecon_specialdiet_id_a4c9e66b_fk_animecon2015_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES animecon2015_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY badges_batch
    ADD CONSTRAINT badges__personnel_class_id_271df0ef_fk_labour_personnelclass_id FOREIGN KEY (personnel_class_id) REFERENCES labour_personnelclass(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY badges_badge
    ADD CONSTRAINT badges__personnel_class_id_9e440435_fk_labour_personnelclass_id FOREIGN KEY (personnel_class_id) REFERENCES labour_personnelclass(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY badges_badge
    ADD CONSTRAINT badges_badge_batch_id_9f1ce5b1_fk_badges_batch_id FOREIGN KEY (batch_id) REFERENCES badges_batch(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY badges_badge
    ADD CONSTRAINT badges_badge_created_by_id_c5ff2ddb_fk_auth_user_id FOREIGN KEY (created_by_id) REFERENCES auth_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY badges_badge
    ADD CONSTRAINT badges_badge_person_id_4cca74fd_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY badges_badge
    ADD CONSTRAINT badges_badge_revoked_by_id_b6962e71_fk_auth_user_id FOREIGN KEY (revoked_by_id) REFERENCES auth_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY badges_badgeseventmeta
    ADD CONSTRAINT badges_badgeseventmeta_admin_group_id_fc8c43c8_fk_auth_group_id FOREIGN KEY (admin_group_id) REFERENCES auth_group(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY badges_badgeseventmeta
    ADD CONSTRAINT badges_badgeseventmeta_event_id_34d22bf5_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY badges_batch
    ADD CONSTRAINT badges_batch_event_id_4587b0d6_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY core_emailverificationtoken
    ADD CONSTRAINT core_emailverificationtoke_person_id_e0aada72_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY core_event
    ADD CONSTRAINT core_event_organization_id_a2ce68e9_fk_core_organization_id FOREIGN KEY (organization_id) REFERENCES core_organization(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY core_event
    ADD CONSTRAINT core_event_venue_id_d74b5c9b_fk_core_venue_id FOREIGN KEY (venue_id) REFERENCES core_venue(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY core_passwordresettoken
    ADD CONSTRAINT core_passwordresettoken_person_id_0b8e45c0_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY core_person
    ADD CONSTRAINT core_person_user_id_3dfe5fcf_fk_auth_user_id FOREIGN KEY (user_id) REFERENCES auth_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY desucon2016_signupextra_special_diet
    ADD CONSTRAINT de_signupextra_id_0ce3578c_fk_desucon2016_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES desucon2016_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY desucon2016_signupextrav2_special_diet
    ADD CONSTRAINT desuc_signupextrav2_id_a1f10bc4_fk_desucon2016_signupextrav2_id FOREIGN KEY (signupextrav2_id) REFERENCES desucon2016_signupextrav2(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY desucon2016_signupextra
    ADD CONSTRAINT desucon2016_signupextra_signup_id_883b05a4_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY desucon2016_signupextrav2
    ADD CONSTRAINT desucon2016_signupextrav2_event_id_ee6f4c01_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY desucon2016_signupextrav2
    ADD CONSTRAINT desucon2016_signupextrav2_person_id_29c53c5d_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY desucon2017_signupextra
    ADD CONSTRAINT desucon2017_signupextra_event_id_c6ec463c_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY desucon2017_signupextra
    ADD CONSTRAINT desucon2017_signupextra_person_id_6c671a8f_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY desucon2017_signupextra_special_diet
    ADD CONSTRAINT desucon20_signupextra_id_12848af8_fk_desucon2017_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES desucon2017_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY desucon2017_signupextra_special_diet
    ADD CONSTRAINT desucon20_specialdiet_id_1320d296_fk_desucon2017_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES desucon2017_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY desucon2016_signupextrav2_special_diet
    ADD CONSTRAINT desucon20_specialdiet_id_8b334325_fk_desucon2016_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES desucon2016_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY desucon2016_signupextra_special_diet
    ADD CONSTRAINT desucon20_specialdiet_id_f2a2eb01_fk_desucon2016_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES desucon2016_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY desuprofile_integration_confirmationcode
    ADD CONSTRAINT desuprofile_integration_co_person_id_30adca39_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY desuprofile_integration_connection
    ADD CONSTRAINT desuprofile_integration_connec_user_id_fb8f4d2c_fk_auth_user_id FOREIGN KEY (user_id) REFERENCES auth_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY directory_directoryorganizationmeta
    ADD CONSTRAINT directory_dire_organization_id_50be5a38_fk_core_organization_id FOREIGN KEY (organization_id) REFERENCES core_organization(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY directory_directoryaccessgroup
    ADD CONSTRAINT directory_dire_organization_id_fbf7e185_fk_core_organization_id FOREIGN KEY (organization_id) REFERENCES core_organization(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY directory_directoryaccessgroup
    ADD CONSTRAINT directory_directoryaccessgro_group_id_54b04030_fk_auth_group_id FOREIGN KEY (group_id) REFERENCES auth_group(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY enrollment_enrollment_concon_parts
    ADD CONSTRAINT enrollment_e_conconpart_id_a31ad2d9_fk_enrollment_conconpart_id FOREIGN KEY (conconpart_id) REFERENCES enrollment_conconpart(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY enrollment_enrollment_special_diet
    ADD CONSTRAINT enrollment_e_enrollment_id_24d0a686_fk_enrollment_enrollment_id FOREIGN KEY (enrollment_id) REFERENCES enrollment_enrollment(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY enrollment_enrollment_concon_parts
    ADD CONSTRAINT enrollment_e_enrollment_id_db71f2cb_fk_enrollment_enrollment_id FOREIGN KEY (enrollment_id) REFERENCES enrollment_enrollment(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY enrollment_enrollment
    ADD CONSTRAINT enrollment_enrollment_event_id_688bf29a_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY enrollment_enrollment
    ADD CONSTRAINT enrollment_enrollment_person_id_7567f500_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY enrollment_enrollmenteventmeta
    ADD CONSTRAINT enrollment_enrollmente_admin_group_id_36dd0d32_fk_auth_group_id FOREIGN KEY (admin_group_id) REFERENCES auth_group(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY enrollment_enrollmenteventmeta
    ADD CONSTRAINT enrollment_enrollmenteventme_event_id_34b90512_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY enrollment_enrollment_special_diet
    ADD CONSTRAINT enrollment_specialdiet_id_0bd4c253_fk_enrollment_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES enrollment_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY event_log_entry
    ADD CONSTRAINT eve_feedback_message_id_3acc7090_fk_feedback_feedbackmessage_id FOREIGN KEY (feedback_message_id) REFERENCES feedback_feedbackmessage(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY event_log_subscription
    ADD CONSTRAINT event_event_survey_filter_id_7cb834e7_fk_surveys_eventsurvey_id FOREIGN KEY (event_survey_filter_id) REFERENCES surveys_eventsurvey(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY event_log_entry
    ADD CONSTRAINT event_log_entr_organization_id_cd93d7fb_fk_core_organization_id FOREIGN KEY (organization_id) REFERENCES core_organization(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY event_log_entry
    ADD CONSTRAINT event_log_entry_created_by_id_355ad5a2_fk_auth_user_id FOREIGN KEY (created_by_id) REFERENCES auth_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY event_log_entry
    ADD CONSTRAINT event_log_entry_event_id_f13a35d2_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY event_log_entry
    ADD CONSTRAINT event_log_entry_person_id_b043f99f_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY event_log_subscription
    ADD CONSTRAINT event_log_subscriptio_event_filter_id_dc05b2ac_fk_core_event_id FOREIGN KEY (event_filter_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY event_log_subscription
    ADD CONSTRAINT event_log_subscription_user_id_bc3b7408_fk_auth_user_id FOREIGN KEY (user_id) REFERENCES auth_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY feedback_feedbackmessage
    ADD CONSTRAINT feedback_feedbackmessage_author_id_1530360c_fk_auth_user_id FOREIGN KEY (author_id) REFERENCES auth_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY finncon2016_signupextra_special_diet
    ADD CONSTRAINT fi_signupextra_id_25fed210_fk_finncon2016_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES finncon2016_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY finncon2016_signupextra
    ADD CONSTRAINT finncon2016_signupextra_signup_id_a2aadeeb_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY finncon2016_signupextra_special_diet
    ADD CONSTRAINT finncon20_specialdiet_id_85c394f6_fk_finncon2016_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES finncon2016_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_programme
    ADD CONSTRAINT form_used_id_e35c2164_fk_programme_alternativeprogrammeform_id FOREIGN KEY (form_used_id) REFERENCES programme_alternativeprogrammeform(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY frostbite2017_signupextra_special_diet
    ADD CONSTRAINT frostbi_signupextra_id_102c791a_fk_frostbite2017_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES frostbite2017_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY frostbite2018_signupextra_special_diet
    ADD CONSTRAINT frostbi_signupextra_id_7fdfee8b_fk_frostbite2018_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES frostbite2018_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY frostbite2017_signupextra_special_diet
    ADD CONSTRAINT frostbi_specialdiet_id_d1a5df15_fk_frostbite2017_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES frostbite2017_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY frostbite2018_signupextra_special_diet
    ADD CONSTRAINT frostbi_specialdiet_id_d22ebe8f_fk_frostbite2018_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES frostbite2018_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY frostbite2016_signupextra
    ADD CONSTRAINT frostbite2016_signupextr_signup_id_492cfdb1_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY frostbite2017_signupextra
    ADD CONSTRAINT frostbite2017_signupextra_event_id_c5b1f437_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY frostbite2017_signupextra
    ADD CONSTRAINT frostbite2017_signupextra_person_id_13d02157_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY frostbite2018_signupextra
    ADD CONSTRAINT frostbite2018_signupextra_event_id_29a7e18c_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY frostbite2018_signupextra
    ADD CONSTRAINT frostbite2018_signupextra_person_id_1962eecb_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY hitpoint2017_signupextra_special_diet
    ADD CONSTRAINT h_signupextra_id_15a2675c_fk_hitpoint2017_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES hitpoint2017_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY hitpoint2015_signupextra_special_diet
    ADD CONSTRAINT h_signupextra_id_85886027_fk_hitpoint2015_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES hitpoint2015_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY hitpoint2015_signupextra
    ADD CONSTRAINT hitpoint2015_signupextra_signup_id_4026d4fb_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY hitpoint2017_signupextra
    ADD CONSTRAINT hitpoint2017_signupextra_signup_id_5e03e712_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY hitpoint2015_signupextra_special_diet
    ADD CONSTRAINT hitpoint_specialdiet_id_6f6b2ec6_fk_hitpoint2015_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES hitpoint2015_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY hitpoint2017_signupextra_special_diet
    ADD CONSTRAINT hitpoint_specialdiet_id_78103888_fk_hitpoint2017_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES hitpoint2017_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY intra_intraeventmeta
    ADD CONSTRAINT intra_intraeventme_organizer_group_id_fe100965_fk_auth_group_id FOREIGN KEY (organizer_group_id) REFERENCES auth_group(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY intra_intraeventmeta
    ADD CONSTRAINT intra_intraeventmeta_admin_group_id_0fb9c0b0_fk_auth_group_id FOREIGN KEY (admin_group_id) REFERENCES auth_group(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY intra_intraeventmeta
    ADD CONSTRAINT intra_intraeventmeta_event_id_86c9bde2_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY intra_team
    ADD CONSTRAINT intra_team_event_id_b801aca9_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY intra_team
    ADD CONSTRAINT intra_team_group_id_9dce430d_fk_auth_group_id FOREIGN KEY (group_id) REFERENCES auth_group(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY intra_teammember
    ADD CONSTRAINT intra_teammember_person_id_d1a2a240_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY intra_teammember
    ADD CONSTRAINT intra_teammember_team_id_c9f4d093_fk_intra_team_id FOREIGN KEY (team_id) REFERENCES intra_team(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kawacon2016_signupextra_special_diet
    ADD CONSTRAINT ka_signupextra_id_52caee97_fk_kawacon2016_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES kawacon2016_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kawacon2016_signupextra_needs_lodging
    ADD CONSTRAINT ka_signupextra_id_5cccff99_fk_kawacon2016_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES kawacon2016_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kawacon2016_signupextra_needs_lodging
    ADD CONSTRAINT kawacon2016_signupext_night_id_10fd96bc_fk_kawacon2016_night_id FOREIGN KEY (night_id) REFERENCES kawacon2016_night(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kawacon2016_signupextra
    ADD CONSTRAINT kawacon2016_signupextra_signup_id_b5902ba5_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kawacon2017_signupextra_needs_lodging
    ADD CONSTRAINT kawacon2017_signupext_night_id_9a1c44be_fk_kawacon2017_night_id FOREIGN KEY (night_id) REFERENCES kawacon2017_night(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kawacon2017_signupextra_shifts
    ADD CONSTRAINT kawacon2017_signupext_shift_id_51a1fcc5_fk_kawacon2017_shift_id FOREIGN KEY (shift_id) REFERENCES kawacon2017_shift(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kawacon2017_signupextra
    ADD CONSTRAINT kawacon2017_signupextra_event_id_781dd815_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kawacon2017_signupextra
    ADD CONSTRAINT kawacon2017_signupextra_person_id_2b2304ea_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kawacon2017_signupextra_shifts
    ADD CONSTRAINT kawacon20_signupextra_id_a58d9288_fk_kawacon2017_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES kawacon2017_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kawacon2017_signupextra_special_diet
    ADD CONSTRAINT kawacon20_signupextra_id_c4077076_fk_kawacon2017_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES kawacon2017_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kawacon2017_signupextra_needs_lodging
    ADD CONSTRAINT kawacon20_signupextra_id_c9348470_fk_kawacon2017_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES kawacon2017_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kawacon2017_signupextra_special_diet
    ADD CONSTRAINT kawacon20_specialdiet_id_0bd8cd33_fk_kawacon2017_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES kawacon2017_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kawacon2016_signupextra_special_diet
    ADD CONSTRAINT kawacon20_specialdiet_id_806c9b63_fk_kawacon2016_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES kawacon2016_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kuplii2016_signupextra_special_diet
    ADD CONSTRAINT kup_signupextra_id_40d17874_fk_kuplii2016_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES kuplii2016_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kuplii2015_signupextra_special_diet
    ADD CONSTRAINT kup_signupextra_id_9529574b_fk_kuplii2015_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES kuplii2015_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kuplii2015_signupextra
    ADD CONSTRAINT kuplii2015_signupextra_signup_id_1bffcfdb_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kuplii2015_signupextra_special_diet
    ADD CONSTRAINT kuplii2015_specialdiet_id_5b4e8659_fk_kuplii2015_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES kuplii2015_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kuplii2016_signupextra
    ADD CONSTRAINT kuplii2016_signupextra_signup_id_8896f075_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kuplii2016_signupextra_special_diet
    ADD CONSTRAINT kuplii2016_specialdiet_id_053c34ec_fk_kuplii2016_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES kuplii2016_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kuplii2017_signupextra
    ADD CONSTRAINT kuplii2017_signupextra_event_id_a142d95d_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kuplii2017_signupextra_special_diet
    ADD CONSTRAINT kuplii2017_signupextra_id_a922b21a_fk_kuplii2017_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES kuplii2017_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kuplii2017_signupextra
    ADD CONSTRAINT kuplii2017_signupextra_person_id_b9148d52_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kuplii2017_signupextra_special_diet
    ADD CONSTRAINT kuplii2017_specialdiet_id_ffb41e30_fk_kuplii2017_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES kuplii2017_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kuplii2018_signupextra
    ADD CONSTRAINT kuplii2018_signupextra_event_id_ff454760_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kuplii2018_signupextra_special_diet
    ADD CONSTRAINT kuplii2018_signupextra_id_4233b02a_fk_kuplii2018_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES kuplii2018_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kuplii2018_signupextra
    ADD CONSTRAINT kuplii2018_signupextra_person_id_e53a0420_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY kuplii2018_signupextra_special_diet
    ADD CONSTRAINT kuplii2018_specialdiet_id_7f3d25a5_fk_kuplii2018_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES kuplii2018_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_alternativesignupform
    ADD CONSTRAINT labour_alternativesignupform_event_id_8bbc0126_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_emptysignupextra
    ADD CONSTRAINT labour_emptysignupextra_event_id_a13b5c89_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_emptysignupextra
    ADD CONSTRAINT labour_emptysignupextra_person_id_1927c3e9_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_obsoleteemptysignupextrav1
    ADD CONSTRAINT labour_emptysignupextra_signup_id_f1ae244c_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_infolink
    ADD CONSTRAINT labour_infolink_event_id_d38b6e45_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_infolink
    ADD CONSTRAINT labour_infolink_group_id_4311e349_fk_auth_group_id FOREIGN KEY (group_id) REFERENCES auth_group(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_jobcategory_personnel_classes
    ADD CONSTRAINT labour_j_personnelclass_id_ff76a774_fk_labour_personnelclass_id FOREIGN KEY (personnelclass_id) REFERENCES labour_personnelclass(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_job
    ADD CONSTRAINT labour_job_job_category_id_9d70afde_fk_labour_jobcategory_id FOREIGN KEY (job_category_id) REFERENCES labour_jobcategory(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_jobcategory_required_qualifications
    ADD CONSTRAINT labour_job_qualification_id_61392645_fk_labour_qualification_id FOREIGN KEY (qualification_id) REFERENCES labour_qualification(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_jobcategory_required_qualifications
    ADD CONSTRAINT labour_jobcate_jobcategory_id_3cb328a5_fk_labour_jobcategory_id FOREIGN KEY (jobcategory_id) REFERENCES labour_jobcategory(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_jobcategory_personnel_classes
    ADD CONSTRAINT labour_jobcate_jobcategory_id_55756148_fk_labour_jobcategory_id FOREIGN KEY (jobcategory_id) REFERENCES labour_jobcategory(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_jobcategory
    ADD CONSTRAINT labour_jobcategory_event_id_1e21d50d_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_jobrequirement
    ADD CONSTRAINT labour_jobrequirement_job_id_61d80756_fk_labour_job_id FOREIGN KEY (job_id) REFERENCES labour_job(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_laboureventmeta
    ADD CONSTRAINT labour_laboureventmeta_admin_group_id_f9241604_fk_auth_group_id FOREIGN KEY (admin_group_id) REFERENCES auth_group(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_laboureventmeta
    ADD CONSTRAINT labour_laboureventmeta_event_id_fb48ee26_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_personnelclass_perks
    ADD CONSTRAINT labour_p_personnelclass_id_5db1c6e8_fk_labour_personnelclass_id FOREIGN KEY (personnelclass_id) REFERENCES labour_personnelclass(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_personqualification
    ADD CONSTRAINT labour_per_qualification_id_4c308ec9_fk_labour_qualification_id FOREIGN KEY (qualification_id) REFERENCES labour_qualification(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_perk
    ADD CONSTRAINT labour_perk_event_id_2a97e683_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_personnelclass
    ADD CONSTRAINT labour_personnelclass_event_id_b0317718_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_personnelclass_perks
    ADD CONSTRAINT labour_personnelclass_perks_perk_id_e028f3cf_fk_labour_perk_id FOREIGN KEY (perk_id) REFERENCES labour_perk(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_personqualification
    ADD CONSTRAINT labour_personqualification_person_id_f4bae3e1_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_signup_personnel_classes
    ADD CONSTRAINT labour_s_personnelclass_id_e1f04525_fk_labour_personnelclass_id FOREIGN KEY (personnelclass_id) REFERENCES labour_personnelclass(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_shift
    ADD CONSTRAINT labour_shift_job_id_36dd099c_fk_labour_job_id FOREIGN KEY (job_id) REFERENCES labour_job(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_shift
    ADD CONSTRAINT labour_shift_signup_id_030cb7ae_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_signup_job_categories_accepted
    ADD CONSTRAINT labour_signup__jobcategory_id_9ae81fa7_fk_labour_jobcategory_id FOREIGN KEY (jobcategory_id) REFERENCES labour_jobcategory(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_signup_job_categories
    ADD CONSTRAINT labour_signup__jobcategory_id_b447c4bb_fk_labour_jobcategory_id FOREIGN KEY (jobcategory_id) REFERENCES labour_jobcategory(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_signup_job_categories_rejected
    ADD CONSTRAINT labour_signup__jobcategory_id_df04007f_fk_labour_jobcategory_id FOREIGN KEY (jobcategory_id) REFERENCES labour_jobcategory(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_signup
    ADD CONSTRAINT labour_signup_event_id_e5a1f121_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_signup_job_categories
    ADD CONSTRAINT labour_signup_job_catego_signup_id_215bc17f_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_signup_job_categories_rejected
    ADD CONSTRAINT labour_signup_job_catego_signup_id_aea2a80d_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_signup_job_categories_accepted
    ADD CONSTRAINT labour_signup_job_catego_signup_id_b8987e0e_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_signup
    ADD CONSTRAINT labour_signup_person_id_69459f4c_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_signup_personnel_classes
    ADD CONSTRAINT labour_signup_personnel__signup_id_3a45091a_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_survey
    ADD CONSTRAINT labour_survey_event_id_47fe14bb_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_surveyrecord
    ADD CONSTRAINT labour_surveyrecord_person_id_796a7ef7_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_surveyrecord
    ADD CONSTRAINT labour_surveyrecord_survey_id_7c57d742_fk_labour_survey_id FOREIGN KEY (survey_id) REFERENCES labour_survey(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY labour_workperiod
    ADD CONSTRAINT labour_workperiod_event_id_59f25286_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY lakeuscon2016_signupextra_special_diet
    ADD CONSTRAINT lakeusc_specialdiet_id_337e8423_fk_lakeuscon2016_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES lakeuscon2016_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY lakeuscon2016_signupextra
    ADD CONSTRAINT lakeuscon2016_signupextr_signup_id_5747105f_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY lippukala_code
    ADD CONSTRAINT lippukala_code_order_id_919a620c_fk_lippukala_order_id FOREIGN KEY (order_id) REFERENCES lippukala_order(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY mailings_recipientgroup
    ADD CONSTRAINT mailing_personnel_class_id_de97b3f1_fk_labour_personnelclass_id FOREIGN KEY (personnel_class_id) REFERENCES labour_personnelclass(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY mailings_personmessage
    ADD CONSTRAINT mailing_subject_id_3e0f05a7_fk_mailings_personmessagesubject_id FOREIGN KEY (subject_id) REFERENCES mailings_personmessagesubject(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY mailings_message
    ADD CONSTRAINT mailings_me_recipient_id_ce463be1_fk_mailings_recipientgroup_id FOREIGN KEY (recipient_id) REFERENCES mailings_recipientgroup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY mailings_personmessage
    ADD CONSTRAINT mailings_pers_body_id_f7af2c8e_fk_mailings_personmessagebody_id FOREIGN KEY (body_id) REFERENCES mailings_personmessagebody(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY mailings_personmessage
    ADD CONSTRAINT mailings_personmessa_message_id_71cb79ef_fk_mailings_message_id FOREIGN KEY (message_id) REFERENCES mailings_message(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY mailings_personmessage
    ADD CONSTRAINT mailings_personmessage_person_id_05b8f64d_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY mailings_recipientgroup
    ADD CONSTRAINT mailings_reci_job_category_id_13d2489b_fk_labour_jobcategory_id FOREIGN KEY (job_category_id) REFERENCES labour_jobcategory(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY mailings_recipientgroup
    ADD CONSTRAINT mailings_recipientgroup_event_id_bf96d4fb_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY mailings_recipientgroup
    ADD CONSTRAINT mailings_recipientgroup_group_id_9ff711ef_fk_auth_group_id FOREIGN KEY (group_id) REFERENCES auth_group(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY membership_membershiporganizationmeta
    ADD CONSTRAINT membership_mem_organization_id_1b2daa7e_fk_core_organization_id FOREIGN KEY (organization_id) REFERENCES core_organization(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY membership_membership
    ADD CONSTRAINT membership_mem_organization_id_a3fda0eb_fk_core_organization_id FOREIGN KEY (organization_id) REFERENCES core_organization(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY membership_membershipfeepayment
    ADD CONSTRAINT membership_membe_member_id_4bba2660_fk_membership_membership_id FOREIGN KEY (member_id) REFERENCES membership_membership(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY membership_membershiporganizationmeta
    ADD CONSTRAINT membership_membershi_members_group_id_53cc2b3e_fk_auth_group_id FOREIGN KEY (members_group_id) REFERENCES auth_group(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY membership_membership
    ADD CONSTRAINT membership_membership_person_id_4593a1f9_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY membership_membershipfeepayment
    ADD CONSTRAINT membership_membershipfee_term_id_5936abef_fk_membership_term_id FOREIGN KEY (term_id) REFERENCES membership_term(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY membership_membershiporganizationmeta
    ADD CONSTRAINT membership_membershipo_admin_group_id_a43faffa_fk_auth_group_id FOREIGN KEY (admin_group_id) REFERENCES auth_group(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY membership_term
    ADD CONSTRAINT membership_ter_organization_id_2856c581_fk_core_organization_id FOREIGN KEY (organization_id) REFERENCES core_organization(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY mimicon2016_signupextra_lodging_needs
    ADD CONSTRAINT mi_signupextra_id_dadaf58c_fk_mimicon2016_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES mimicon2016_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY mimicon2016_signupextra_special_diet
    ADD CONSTRAINT mi_signupextra_id_e577e3ae_fk_mimicon2016_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES mimicon2016_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY mimicon2016_signupextra_lodging_needs
    ADD CONSTRAINT mimicon2016_signupext_night_id_a72b6b12_fk_mimicon2016_night_id FOREIGN KEY (night_id) REFERENCES mimicon2016_night(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY mimicon2016_signupextra
    ADD CONSTRAINT mimicon2016_signupextra_signup_id_59c09464_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY mimicon2016_signupextra_special_diet
    ADD CONSTRAINT mimicon20_specialdiet_id_2cab16d8_fk_mimicon2016_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES mimicon2016_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY nexmo_deliverystatusfragment
    ADD CONSTRAINT nexmo_deliverys_message_id_87b65c24_fk_nexmo_outboundmessage_id FOREIGN KEY (message_id) REFERENCES nexmo_outboundmessage(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY nippori2017_signupextra
    ADD CONSTRAINT nippori2017_signupextra_event_id_7c6fe68c_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY nippori2017_signupextra
    ADD CONSTRAINT nippori2017_signupextra_person_id_d78ca762_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY payments_payment
    ADD CONSTRAINT payments_payment_event_id_1aa1e2db_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY payments_paymentseventmeta
    ADD CONSTRAINT payments_paymentsevent_admin_group_id_eabdf94c_fk_auth_group_id FOREIGN KEY (admin_group_id) REFERENCES auth_group(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY payments_paymentseventmeta
    ADD CONSTRAINT payments_paymentseventmeta_event_id_945aaefa_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY popcult2017_signupextra
    ADD CONSTRAINT popcult2017_signupextra_event_id_5d295723_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY popcult2017_signupextra
    ADD CONSTRAINT popcult2017_signupextra_person_id_a6b1ea92_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY popcult2017_signupextra_special_diet
    ADD CONSTRAINT popcult201_specialdiet_id_21cca6aa_fk_enrollment_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES enrollment_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY popcult2017_signupextra_special_diet
    ADD CONSTRAINT popcult20_signupextra_id_65c246da_fk_popcult2017_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES popcult2017_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_role
    ADD CONSTRAINT program_personnel_class_id_80cd2894_fk_labour_personnelclass_id FOREIGN KEY (personnel_class_id) REFERENCES labour_personnelclass(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_alternativeprogrammeform
    ADD CONSTRAINT programme_alternativeprogram_event_id_8c2c8d29_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_category
    ADD CONSTRAINT programme_category_event_id_543f9962_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_freeformorganizer
    ADD CONSTRAINT programme_freef_programme_id_6b52860d_fk_programme_programme_id FOREIGN KEY (programme_id) REFERENCES programme_programme(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_invitation
    ADD CONSTRAINT programme_invit_programme_id_aa6cf384_fk_programme_programme_id FOREIGN KEY (programme_id) REFERENCES programme_programme(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_invitation
    ADD CONSTRAINT programme_invita_sire_id_bba296f0_fk_programme_programmerole_id FOREIGN KEY (sire_id) REFERENCES programme_programmerole(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_invitation
    ADD CONSTRAINT programme_invitation_created_by_id_c12b2d9b_fk_auth_user_id FOREIGN KEY (created_by_id) REFERENCES auth_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_invitation
    ADD CONSTRAINT programme_invitation_role_id_d52adb64_fk_programme_role_id FOREIGN KEY (role_id) REFERENCES programme_role(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_programmerole
    ADD CONSTRAINT programme_pro_invitation_id_b7973069_fk_programme_invitation_id FOREIGN KEY (invitation_id) REFERENCES programme_invitation(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_programme_hitpoint2017_preferred_time_slots
    ADD CONSTRAINT programme_prog_timeslot_id_badea01c_fk_hitpoint2017_timeslot_id FOREIGN KEY (timeslot_id) REFERENCES hitpoint2017_timeslot(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_programme_tags
    ADD CONSTRAINT programme_progr_programme_id_5f486c08_fk_programme_programme_id FOREIGN KEY (programme_id) REFERENCES programme_programme(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_programmefeedback
    ADD CONSTRAINT programme_progr_programme_id_8c29e8df_fk_programme_programme_id FOREIGN KEY (programme_id) REFERENCES programme_programme(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_programmerole
    ADD CONSTRAINT programme_progr_programme_id_aa452c66_fk_programme_programme_id FOREIGN KEY (programme_id) REFERENCES programme_programme(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_programme_hitpoint2017_preferred_time_slots
    ADD CONSTRAINT programme_progr_programme_id_d1293657_fk_programme_programme_id FOREIGN KEY (programme_id) REFERENCES programme_programme(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_programme
    ADD CONSTRAINT programme_program_category_id_915d2622_fk_programme_category_id FOREIGN KEY (category_id) REFERENCES programme_category(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_programme
    ADD CONSTRAINT programme_programme_room_id_94b7fc9d_fk_programme_room_id FOREIGN KEY (room_id) REFERENCES programme_room(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_programme_tags
    ADD CONSTRAINT programme_programme_tags_tag_id_d1f12a82_fk_programme_tag_id FOREIGN KEY (tag_id) REFERENCES programme_tag(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_programmeeventmeta
    ADD CONSTRAINT programme_programmeeve_admin_group_id_cb2cc13e_fk_auth_group_id FOREIGN KEY (admin_group_id) REFERENCES auth_group(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_programmeeventmeta
    ADD CONSTRAINT programme_programmeeventmeta_event_id_5511f336_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_programmefeedback
    ADD CONSTRAINT programme_programmefeedba_hidden_by_id_ab5e0d9f_fk_auth_user_id FOREIGN KEY (hidden_by_id) REFERENCES auth_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_programmefeedback
    ADD CONSTRAINT programme_programmefeedbac_author_id_2b02e587_fk_core_person_id FOREIGN KEY (author_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_programmerole
    ADD CONSTRAINT programme_programmerole_person_id_c6c414c6_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_programmerole
    ADD CONSTRAINT programme_programmerole_role_id_435e73a8_fk_programme_role_id FOREIGN KEY (role_id) REFERENCES programme_role(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_room
    ADD CONSTRAINT programme_room_event_id_7c662e2b_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_specialstarttime
    ADD CONSTRAINT programme_specialstarttime_event_id_7b426c03_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_tag
    ADD CONSTRAINT programme_tag_event_id_6b7447e6_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_timeblock
    ADD CONSTRAINT programme_timeblock_event_id_4c100d3e_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY programme_view
    ADD CONSTRAINT programme_view_event_id_691e64f3_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: programme_view_rooms programme_view_rooms_room_id_b29d6355_fk_programme_room_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY programme_view_rooms
    ADD CONSTRAINT programme_view_rooms_room_id_b29d6355_fk_programme_room_id FOREIGN KEY (room_id) REFERENCES programme_room(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: programme_view_rooms programme_view_rooms_view_id_4154e68a_fk_programme_view_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY programme_view_rooms
    ADD CONSTRAINT programme_view_rooms_view_id_4154e68a_fk_programme_view_id FOREIGN KEY (view_id) REFERENCES programme_view(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY shippocon2016_signupextra_special_diet
    ADD CONSTRAINT shippoc_signupextra_id_b29d6fba_fk_shippocon2016_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES shippocon2016_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY shippocon2016_signupextra_special_diet
    ADD CONSTRAINT shippoc_specialdiet_id_19f63b56_fk_shippocon2016_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES shippocon2016_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY shippocon2016_signupextra
    ADD CONSTRAINT shippocon2016_signupextra_event_id_4479ba8d_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY shippocon2016_signupextra
    ADD CONSTRAINT shippocon2016_signupextra_person_id_19fe9525_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY lakeuscon2016_signupextra_special_diet
    ADD CONSTRAINT signupextra_id_3cb66b20_fk_lakeuscon2016_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES lakeuscon2016_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY sms_hotword
    ADD CONSTRAINT sms_hotword_assigned_event_id_d298f898_fk_core_event_id FOREIGN KEY (assigned_event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY sms_nominee_category
    ADD CONSTRAINT sms_nominee_cat_votecategory_id_08bc1fec_fk_sms_votecategory_id FOREIGN KEY (votecategory_id) REFERENCES sms_votecategory(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY sms_nominee_category
    ADD CONSTRAINT sms_nominee_category_nominee_id_a2874e71_fk_sms_nominee_id FOREIGN KEY (nominee_id) REFERENCES sms_nominee(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY sms_smseventmeta
    ADD CONSTRAINT sms_smseventmeta_admin_group_id_4524f722_fk_auth_group_id FOREIGN KEY (admin_group_id) REFERENCES auth_group(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY sms_smseventmeta
    ADD CONSTRAINT sms_smseventmeta_event_id_2ff17584_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY sms_smsmessagein
    ADD CONSTRAINT "sms_smsme_SMSEventMeta_id_a1385f58_fk_sms_smseventmeta_event_id" FOREIGN KEY ("SMSEventMeta_id") REFERENCES sms_smseventmeta(event_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY sms_smsmessagein
    ADD CONSTRAINT sms_smsmessagein_message_id_03b4453b_fk_nexmo_inboundmessage_id FOREIGN KEY (message_id) REFERENCES nexmo_inboundmessage(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY sms_smsmessageout
    ADD CONSTRAINT sms_smsmessageou_event_id_992ac8cf_fk_sms_smseventmeta_event_id FOREIGN KEY (event_id) REFERENCES sms_smseventmeta(event_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY sms_smsmessageout
    ADD CONSTRAINT sms_smsmessageout_ref_id_76a283ed_fk_nexmo_outboundmessage_id FOREIGN KEY (ref_id) REFERENCES nexmo_outboundmessage(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY sms_vote
    ADD CONSTRAINT sms_vote_category_id_c14fe76a_fk_sms_votecategory_id FOREIGN KEY (category_id) REFERENCES sms_votecategory(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY sms_vote
    ADD CONSTRAINT sms_vote_message_id_90333d83_fk_nexmo_inboundmessage_id FOREIGN KEY (message_id) REFERENCES nexmo_inboundmessage(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY sms_vote
    ADD CONSTRAINT sms_vote_vote_id_229694d2_fk_sms_nominee_id FOREIGN KEY (vote_id) REFERENCES sms_nominee(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY sms_votecategory
    ADD CONSTRAINT sms_votecategory_hotword_id_a37cf6c3_fk_sms_hotword_id FOREIGN KEY (hotword_id) REFERENCES sms_hotword(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY surveys_eventsurveyresult
    ADD CONSTRAINT surveys_eventsurve_survey_id_446992bc_fk_surveys_eventsurvey_id FOREIGN KEY (survey_id) REFERENCES surveys_eventsurvey(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY surveys_eventsurvey
    ADD CONSTRAINT surveys_eventsurvey_event_id_d6a821a9_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY surveys_eventsurveyresult
    ADD CONSTRAINT surveys_eventsurveyresult_author_id_1d35eb67_fk_auth_user_id FOREIGN KEY (author_id) REFERENCES auth_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY surveys_globalsurveyresult
    ADD CONSTRAINT surveys_globalsur_survey_id_b613a23a_fk_surveys_globalsurvey_id FOREIGN KEY (survey_id) REFERENCES surveys_globalsurvey(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY surveys_globalsurveyresult
    ADD CONSTRAINT surveys_globalsurveyresult_author_id_862ef18f_fk_auth_user_id FOREIGN KEY (author_id) REFERENCES auth_user(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tickets_accommodationinformation
    ADD CONSTRAINT tickets_ac_order_product_id_5eb3a6ae_fk_tickets_orderproduct_id FOREIGN KEY (order_product_id) REFERENCES tickets_orderproduct(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tickets_accommodationinformation_limit_groups
    ADD CONSTRAINT tickets_accommo_limitgroup_id_215aa00d_fk_tickets_limitgroup_id FOREIGN KEY (limitgroup_id) REFERENCES tickets_limitgroup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tickets_batch
    ADD CONSTRAINT tickets_batch_event_id_46c1ceb1_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tickets_limitgroup
    ADD CONSTRAINT tickets_limitgroup_event_id_aeb65dae_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tickets_order
    ADD CONSTRAINT tickets_order_batch_id_f6bf9442_fk_tickets_batch_id FOREIGN KEY (batch_id) REFERENCES tickets_batch(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tickets_order
    ADD CONSTRAINT tickets_order_customer_id_60494c04_fk_tickets_customer_id FOREIGN KEY (customer_id) REFERENCES tickets_customer(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tickets_order
    ADD CONSTRAINT tickets_order_event_id_02418efc_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tickets_orderproduct
    ADD CONSTRAINT tickets_orderproduct_order_id_5217f4c3_fk_tickets_order_id FOREIGN KEY (order_id) REFERENCES tickets_order(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tickets_orderproduct
    ADD CONSTRAINT tickets_orderproduct_product_id_e0ebcc8f_fk_tickets_product_id FOREIGN KEY (product_id) REFERENCES tickets_product(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tickets_product
    ADD CONSTRAINT tickets_product_event_id_fcae311a_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tickets_product_limit_groups
    ADD CONSTRAINT tickets_product_limit_product_id_74d7bbe2_fk_tickets_product_id FOREIGN KEY (product_id) REFERENCES tickets_product(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tickets_product_limit_groups
    ADD CONSTRAINT tickets_product_limitgroup_id_f1524f50_fk_tickets_limitgroup_id FOREIGN KEY (limitgroup_id) REFERENCES tickets_limitgroup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tickets_shirtorder
    ADD CONSTRAINT tickets_shirtorder_order_id_f1918032_fk_tickets_order_id FOREIGN KEY (order_id) REFERENCES tickets_order(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tickets_shirtorder
    ADD CONSTRAINT tickets_shirtorder_size_id_15e61db1_fk_tickets_shirtsize_id FOREIGN KEY (size_id) REFERENCES tickets_shirtsize(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tickets_shirtsize
    ADD CONSTRAINT tickets_shirtsize_type_id_e6d17df8_fk_tickets_shirttype_id FOREIGN KEY (type_id) REFERENCES tickets_shirttype(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tickets_shirttype
    ADD CONSTRAINT tickets_shirttype_event_id_959a8c59_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tickets_ticketseventmeta
    ADD CONSTRAINT tickets_ticketseventme_admin_group_id_a37c02a1_fk_auth_group_id FOREIGN KEY (admin_group_id) REFERENCES auth_group(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tickets_ticketseventmeta
    ADD CONSTRAINT tickets_ticketseventmeta_event_id_a24fa3fd_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon11_signupextra_lodging_needs
    ADD CONSTRAINT traco_signupextra_id_9fe2d92a_fk_tracon11_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES tracon11_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon11_signupextra_special_diet
    ADD CONSTRAINT traco_signupextra_id_fc8d6f5e_fk_tracon11_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES tracon11_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon11_signupextra_special_diet
    ADD CONSTRAINT tracon11_sig_specialdiet_id_0747ebfc_fk_tracon11_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES tracon11_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon11_signupextrav2_special_diet
    ADD CONSTRAINT tracon11_sig_specialdiet_id_7426385d_fk_tracon11_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES tracon11_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon11_signupextra_lodging_needs
    ADD CONSTRAINT tracon11_signupextra_lod_night_id_30ac4159_fk_tracon11_night_id FOREIGN KEY (night_id) REFERENCES tracon11_night(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon11_signupextra
    ADD CONSTRAINT tracon11_signupextra_signup_id_0aae51f1_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon11_signupextrav2
    ADD CONSTRAINT tracon11_signupextrav2_event_id_90e7d336_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon11_signupextrav2_special_diet
    ADD CONSTRAINT tracon11_signupextrav2_id_845e141a_fk_tracon11_signupextrav2_id FOREIGN KEY (signupextrav2_id) REFERENCES tracon11_signupextrav2(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon11_signupextrav2_lodging_needs
    ADD CONSTRAINT tracon11_signupextrav2_id_db124b21_fk_tracon11_signupextrav2_id FOREIGN KEY (signupextrav2_id) REFERENCES tracon11_signupextrav2(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon11_signupextrav2_lodging_needs
    ADD CONSTRAINT tracon11_signupextrav2_l_night_id_a03a048b_fk_tracon11_night_id FOREIGN KEY (night_id) REFERENCES tracon11_night(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon11_signupextrav2
    ADD CONSTRAINT tracon11_signupextrav2_person_id_715ff1f2_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon2017_signupextra_pick_your_poison
    ADD CONSTRAINT tracon2017_signupext_poison_id_e429d715_fk_tracon2017_poison_id FOREIGN KEY (poison_id) REFERENCES tracon2017_poison(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon2017_signupextra
    ADD CONSTRAINT tracon2017_signupextra_event_id_e8e1ca64_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon2017_signupextra_pick_your_poison
    ADD CONSTRAINT tracon2017_signupextra_id_50989430_fk_tracon2017_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES tracon2017_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon2017_signupextra_special_diet
    ADD CONSTRAINT tracon2017_signupextra_id_6029da95_fk_tracon2017_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES tracon2017_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon2017_signupextra_lodging_needs
    ADD CONSTRAINT tracon2017_signupextra_id_e63221b3_fk_tracon2017_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES tracon2017_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon2017_signupextra_lodging_needs
    ADD CONSTRAINT tracon2017_signupextra_night_id_c6ef9a96_fk_tracon2017_night_id FOREIGN KEY (night_id) REFERENCES tracon2017_night(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon2017_signupextra
    ADD CONSTRAINT tracon2017_signupextra_person_id_c74ce6f6_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon2017_signupextra_special_diet
    ADD CONSTRAINT tracon2017_specialdiet_id_7807c41f_fk_enrollment_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES enrollment_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon2018_signupextra
    ADD CONSTRAINT tracon2018_signupextra_event_id_1afcd586_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon2018_signupextra_lodging_needs
    ADD CONSTRAINT tracon2018_signupextra_id_103a2d37_fk_tracon2018_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES tracon2018_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon2018_signupextra_special_diet
    ADD CONSTRAINT tracon2018_signupextra_id_eb12e583_fk_tracon2018_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES tracon2018_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon2018_signupextra_lodging_needs
    ADD CONSTRAINT tracon2018_signupextra_night_id_1e2f6fc7_fk_tracon2018_night_id FOREIGN KEY (night_id) REFERENCES tracon2018_night(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon2018_signupextra
    ADD CONSTRAINT tracon2018_signupextra_person_id_907feec9_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon2018_signupextra_special_diet
    ADD CONSTRAINT tracon2018_specialdiet_id_8ec190aa_fk_enrollment_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES enrollment_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon9_signupextra_special_diet
    ADD CONSTRAINT tracon9_signu_specialdiet_id_bf241ca7_fk_tracon9_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES tracon9_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon9_signupextra_lodging_needs
    ADD CONSTRAINT tracon9_signupextra_lodgi_night_id_0e266b02_fk_tracon9_night_id FOREIGN KEY (night_id) REFERENCES tracon9_night(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon9_signupextra
    ADD CONSTRAINT tracon9_signupextra_signup_id_d4bdbbd4_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon9_signupextra_lodging_needs
    ADD CONSTRAINT tracon_signupextra_id_472a3533_fk_tracon9_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES tracon9_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tracon9_signupextra_special_diet
    ADD CONSTRAINT tracon_signupextra_id_71856f9a_fk_tracon9_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES tracon9_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY traconx_signupextra_special_diet
    ADD CONSTRAINT tracon_signupextra_id_8cd32bc6_fk_traconx_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES traconx_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY traconx_signupextra_lodging_needs
    ADD CONSTRAINT tracon_signupextra_id_d6ee7c08_fk_traconx_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES traconx_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY traconx_signupextra_special_diet
    ADD CONSTRAINT traconx_signu_specialdiet_id_8268f384_fk_traconx_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES traconx_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY traconx_signupextra_lodging_needs
    ADD CONSTRAINT traconx_signupextra_lodgi_night_id_4f89f18a_fk_traconx_night_id FOREIGN KEY (night_id) REFERENCES traconx_night(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY traconx_signupextra
    ADD CONSTRAINT traconx_signupextra_signup_id_e26acdca_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tylycon2017_signupextra
    ADD CONSTRAINT tylycon2017_signupextra_event_id_d1a4bd07_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tylycon2017_signupextra
    ADD CONSTRAINT tylycon2017_signupextra_person_id_cde12b10_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tylycon2017_signupextra_special_diet
    ADD CONSTRAINT tylycon20_signupextra_id_cfae71a9_fk_tylycon2017_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES tylycon2017_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY tylycon2017_signupextra_special_diet
    ADD CONSTRAINT tylycon20_specialdiet_id_0dbeceb6_fk_tylycon2017_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES tylycon2017_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY worldcon75_signupextra
    ADD CONSTRAINT worldcon75_signupextra_event_id_6d49c550_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY worldcon75_signupextra_special_diet
    ADD CONSTRAINT worldcon75_signupextra_id_3dfd4726_fk_worldcon75_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES worldcon75_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY worldcon75_signupextra
    ADD CONSTRAINT worldcon75_signupextra_person_id_36c0d651_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY worldcon75_signupextra_special_diet
    ADD CONSTRAINT worldcon75_specialdiet_id_e5dfea81_fk_enrollment_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES enrollment_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY yukicon2016_signupextra_special_diet
    ADD CONSTRAINT yu_signupextra_id_8110186d_fk_yukicon2016_signupextra_signup_id FOREIGN KEY (signupextra_id) REFERENCES yukicon2016_signupextra(signup_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY yukicon2016_signupextra
    ADD CONSTRAINT yukicon2016_signupextra_signup_id_b360aa04_fk_labour_signup_id FOREIGN KEY (signup_id) REFERENCES labour_signup(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY yukicon2017_signupextra_work_days
    ADD CONSTRAINT yukicon2017_sig_eventday_id_42bb1342_fk_yukicon2017_eventday_id FOREIGN KEY (eventday_id) REFERENCES yukicon2017_eventday(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY yukicon2017_signupextra
    ADD CONSTRAINT yukicon2017_signupextra_event_id_94e34e57_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY yukicon2017_signupextra
    ADD CONSTRAINT yukicon2017_signupextra_person_id_73d7b8f4_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY yukicon2018_signupextra_work_days
    ADD CONSTRAINT yukicon2018_sig_eventday_id_7c144f29_fk_yukicon2018_eventday_id FOREIGN KEY (eventday_id) REFERENCES yukicon2018_eventday(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY yukicon2018_signupextra
    ADD CONSTRAINT yukicon2018_signupextra_event_id_4e3cc4b7_fk_core_event_id FOREIGN KEY (event_id) REFERENCES core_event(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY yukicon2018_signupextra
    ADD CONSTRAINT yukicon2018_signupextra_person_id_17b24a02_fk_core_person_id FOREIGN KEY (person_id) REFERENCES core_person(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY yukicon2018_signupextra_special_diet
    ADD CONSTRAINT yukicon20_signupextra_id_0644183b_fk_yukicon2018_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES yukicon2018_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY yukicon2018_signupextra_work_days
    ADD CONSTRAINT yukicon20_signupextra_id_4dd3e7bb_fk_yukicon2018_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES yukicon2018_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY yukicon2017_signupextra_special_diet
    ADD CONSTRAINT yukicon20_signupextra_id_7df373d0_fk_yukicon2017_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES yukicon2017_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY yukicon2017_signupextra_work_days
    ADD CONSTRAINT yukicon20_signupextra_id_e21eb43a_fk_yukicon2017_signupextra_id FOREIGN KEY (signupextra_id) REFERENCES yukicon2017_signupextra(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY yukicon2016_signupextra_special_diet
    ADD CONSTRAINT yukicon20_specialdiet_id_249f2237_fk_yukicon2016_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES yukicon2016_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY yukicon2017_signupextra_special_diet
    ADD CONSTRAINT yukicon20_specialdiet_id_ab802cd2_fk_yukicon2017_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES yukicon2017_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY yukicon2018_signupextra_special_diet
    ADD CONSTRAINT yukicon20_specialdiet_id_e1957e53_fk_yukicon2018_specialdiet_id FOREIGN KEY (specialdiet_id) REFERENCES yukicon2018_specialdiet(id) DEFERRABLE INITIALLY DEFERRED;

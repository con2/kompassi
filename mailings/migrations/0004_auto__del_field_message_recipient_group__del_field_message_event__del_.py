...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Message.recipient_group'
        db.delete_column(u'mailings_message', 'recipient_group_id')

        # Deleting field 'Message.event'
        db.delete_column(u'mailings_message', 'event_id')

        # Deleting field 'Message.app_label'
        db.delete_column(u'mailings_message', 'app_label')


        # Changing field 'Message.recipient'
        db.alter_column(u'mailings_message', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['mailings.RecipientGroup']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Message.recipient_group'
        raise RuntimeError("Cannot reverse this migration. 'Message.recipient_group' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Message.event'
        raise RuntimeError("Cannot reverse this migration. 'Message.event' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Message.app_label'
        raise RuntimeError("Cannot reverse this migration. 'Message.app_label' and its values cannot be restored.")

        # Changing field 'Message.recipient'
        db.alter_column(u'mailings_message', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mailings.RecipientGroup'], null=True))
    ...
    models = {
        ...
        u'mailings.message': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mailings.RecipientGroup']"}),

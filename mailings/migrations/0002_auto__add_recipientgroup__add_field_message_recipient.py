...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mailings_recipientgroup', (
            ...
            ('verbose_name', self.gf('django.db.models.fields.CharField')(max_length=63)),
        ))
        db.send_create_signal(u'mailings', ['RecipientGroup'])

        # Adding field 'Message.recipient'
        db.add_column(u'mailings_message', 'recipient',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mailings.RecipientGroup'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'RecipientGroup'
        db.delete_table(u'mailings_recipientgroup')

        # Deleting field 'Message.recipient'
        db.delete_column(u'mailings_message', 'recipient_id')

...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='badge_layout',
            field=models.CharField(choices=[('trad', 'Traditional'), ('nick', 'Emphasize nick name')], default='trad', help_text='This controls how fields are grouped in the badge. Traditional: job title, firstname surname, nick. Emphasize nick name: first name or nick, surname or full name, job title.', max_length=4, verbose_name='Badgen asettelu'),
        ),
        migrations.AlterField(
            model_name='batch',
            name='created_at',

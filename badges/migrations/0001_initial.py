    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_title', models.CharField(default='', max_length=63, verbose_name='Teht\xe4v\xe4nimike', blank=True)),
        ...
        migrations.CreateModel(
            ...
            bases=(models.Model, badges.models.CountBadgesMixin),
        ),
        migrations.CreateModel(
            name='Batch',
            fields=[
        ...
        migrations.AddField(
            model_name='batch',
            name='template',
            field=models.ForeignKey(blank=True, to='badges.Template', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='badge',
            name='batch',
            field=models.ForeignKey(blank=True, to='badges.Batch', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='badge',
            name='person',
            field=models.ForeignKey(blank=True, to='core.Person', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='badge',
            name='template',
            field=models.ForeignKey(verbose_name='Badgetyyppi', to='badges.Template'),
            preserve_default=True,
        ),
    ]

            ...
            DimensionDTO(
                ...
                choices=[
                    ...
                    for slug, title_fi, title_en, color in [
                        ("miniatures", "Figuurit", "Miniatures", "#208eb7"),
                        ("boardgames", "Lautapelit", "Board games", "#7ce5e6"),
                        ("cardgames", "Korttipelit", "Card games", "#194f46"),
                        ("crafts", "Käsityöt", "Crafts", "#5bef8f"),
                        ("dance", "Tanssi", "Dance", "#5a9057"),
                        ("larp", "Larppaaminen", "LARP", "#bce091"),
                        ("music", "Musiikki", "Music", "#1e438d"),
                        ("penandpaper", "Pöytäroolipelit", "Pen & Paper RPG", "#8699ee"),
                        ("boffering", "Boffaus", "Boffering", "#6314af"),
                        ("goh", "Kunniavieraat", "Guests of Honor", "#ae73fb"),
                        ("theme", "Hirviöt", "Monsters", "#873073"),
                    ]
                ],
            ),
            DimensionDTO(

...
class Setup:
    ...
    def setup_core(self):
        ...
        self.event, unused = Event.objects.get_or_create(
            ...
            defaults=dict(
                name="Matsucon 2022",
                name_genitive="Matsucon 2022 -tapahtuman",
                name_illative="Matsucon 2022 -tapahtumaan",
                name_inessive="Matsucon 2022 -tapahtumassa",
                homepage_url="http://matsucon.fi",
                organization=self.organization,
                start_time=datetime(2022, 12, 10, 10, 0, tzinfo=self.tz),
                end_time=datetime(2022, 12, 11, 18, 0, tzinfo=self.tz),
                venue=self.venue,
            ),
        )
    ...
    def setup_labour(self):
        ...
        AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path="events.matsucon2022.forms:OrganizerSignupForm",
                signup_extra_form_class_path="events.matsucon2022.forms:OrganizerSignupExtraForm",
                active_from=now(),
    ...
    def setup_tickets(self):
        ...
        defaults = dict(
            ...
            ticket_free_text="Tämä on sähköinen lippusi Matsucon 2022 -tapahtumaan. Sähköinen lippu vaihdetaan\n"
            ...
            front_page_text="<h2>Tervetuloa ostamaan pääsylippuja Matsucon 2022 -tapahtumaan!</h2>"
            "<p>Liput maksetaan suomalaisilla verkkopankkitunnuksilla heti tilauksen yhteydessä.</p>"
            "<p>Lue lisää tapahtumasta <a href='http://matsucon.fi'>Matsucon 2022 -tapahtuman kotisivuilta</a>.</p>",
        )
...
class Command(BaseCommand):
    args = ""
    help = "Setup matsucon2022 specific stuff"

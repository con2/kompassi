    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accommodation', models.ManyToManyField(blank=True, related_name='kotaeexpo2025_signup_extras', to='kotaeexpo2025.accommodation', verbose_name='Tarvitsen lattiamajoitusta')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_signup_extras', to='core.event')),
                ('known_language', models.ManyToManyField(blank=True, related_name='kotaeexpo2025_signup_extras', to='kotaeexpo2025.knownlanguage', verbose_name='Osaamasi kielet')),
                ...
                ('special_diet', models.ManyToManyField(blank=True, related_name='kotaeexpo2025_signup_extras', to='enrollment.specialdiet', verbose_name='Erikoisruokavalio')),
            ],
            options={
                'abstract': False,
            },

...
def tracon2025_afterparty_participants_view(request, event_slug):
    if event_slug != "tracon2025":
        raise NotImplementedError("This view is only available for tracon2025")
...
@default_cbac_required
def tracon2025_afterparty_summary_view(request, event_slug):
    if event_slug != "tracon2025":
        raise NotImplementedError("This view is only available for tracon2025")
    ...
    return render(request, "tracon2025_afterparty_summary_view.pug", vars)

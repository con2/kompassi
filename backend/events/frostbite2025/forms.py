...
class OrganizerSignupForm(forms.ModelForm, AlternativeFormMixin):
    ...
    def get_excluded_m2m_field_defaults(self):
        return dict(job_categories=JobCategory.objects.filter(event__slug="frostbite2025", name="Vastaava"))
...
class SpecialistSignupForm(SignupForm, AlternativeFormMixin):
    def get_job_categories_query(self, event, admin=False):
        ...
        return Q(event__slug="frostbite2025", public=False) & ~Q(slug="vastaava")

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.public'
        db.add_column(u'timetable_category', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Programme.public'
        db.delete_column(u'timetable_programme', 'public')


    def backwards(self, orm):
        # Deleting field 'Category.public'
        db.delete_column(u'timetable_category', 'public')

        # Adding field 'Programme.public'
        db.add_column(u'timetable_programme', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Programme.hilight'
        db.delete_column(u'timetable_programme', 'hilight')


    def backwards(self, orm):
        # Adding field 'Programme.hilight'
        db.add_column(u'timetable_programme', 'hilight',

...
class Setup(object):
    ...
    def setup_core(self):
        ...
        self.venue, unused = Venue.objects.get_or_create(name='Hyvinkään kaupungintalo ja Takomo', defaults=dict(
            name_inessive='Hyvinkään kaupungintalolla ja Takomossa',
        ))
        ...
        self.event, unused = Event.objects.get_or_create(slug='hypecon2019', defaults=dict(
            name='Hypecon (2019)',
            ...
            start_time=datetime(2019, 6, 8, 10, 0, tzinfo=self.tz),
            end_time=datetime(2019, 6, 8, 22, 0, tzinfo=self.tz),
            venue=self.venue,
        ))
    ...
    def setup_labour(self):
        ...
        labour_event_meta_defaults = dict(
            ...
            work_begins=datetime(2019, 6, 8, 8, 0, 0, tzinfo=self.tz),
            work_ends=datetime(2019, 6, 8, 23, 0, 0, tzinfo=self.tz),
        ...
        AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path='events.hypecon2019.forms:OrganizerSignupForm',
                signup_extra_form_class_path='events.hypecon2019.forms:OrganizerSignupExtraForm',
                active_from=datetime(2019, 1, 6, 0, 0, 0, tzinfo=self.tz),
...
class Command(BaseCommand):
    args = ''
    help = 'Setup hypecon2019 specific stuff'

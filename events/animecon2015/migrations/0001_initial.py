...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='SignupExtra',
            fields=[
                ('signup', models.OneToOneField(primary_key=True, serialize=False, help_text='', related_name=b'+', to='labour.Signup')),
                ('shift_type', models.CharField(verbose_name='Toivottu ty\xf6vuoron pituus', max_length=15, choices=[('yksipitka', b'Yksi pitk\xc3\xa4 vuoro'), ('montalyhytta', b'Monta lyhyemp\xc3\xa4\xc3\xa4 vuoroa'), ('kaikkikay', b'Kumpi tahansa k\xc3\xa4y')], help_text='Haluatko tehd\xe4 yhden pitk\xe4n ty\xf6vuoron vaiko monta lyhyemp\xe4\xe4 vuoroa?')),
                ('total_work', models.CharField(verbose_name='Toivottu kokonaisty\xf6m\xe4\xe4r\xe4', max_length=15, choices=[('8h', b'Minimi - 8 tuntia (1 l\xc3\xa4mmin ateria)'), ('12h', b'12 tuntia (2 l\xc3\xa4mmint\xc3\xa4 ateriaa)'), ('yli12h', b'Ty\xc3\xb6n Sankari! Yli 12 tuntia! (2 l\xc3\xa4mmint\xc3\xa4 ateriaa)')], help_text='Kuinka paljon haluat tehd\xe4 t\xf6it\xe4 yhteens\xe4 tapahtuman aikana? Useimmissa teht\xe4vist\xe4 minimi on kahdeksan tuntia, mutta joissain teht\xe4viss\xe4 se voi olla my\xf6s v\xe4hemm\xe4n (esim. majoitusvalvonta 6 h).')),

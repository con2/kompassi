...
class Setup(object):
    ...
    def setup_core(self):
        ...
        self.event, unused = Event.objects.get_or_create(slug='kuplii2021', defaults=dict(
            name='Tampere Kuplii 2021',
            name_genitive='Tampere Kuplii 2021 -tapahtuman',
            name_illative='Tampere Kuplii 2021 -tapahtumaan',
            name_inessive='Tampere Kuplii 2021 -tapahtumassa',
            homepage_url='http://2021.tamperekuplii.fi',
            organization=self.organization,
            start_time=datetime(2021, 5, 19, 10, 0, tzinfo=self.tz),
            end_time=datetime(2021, 5, 23, 17, 0, tzinfo=self.tz),
            venue=self.venue,
        ))
    ...
    def setup_labour(self):
        ...
        AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path='events.kuplii2021.forms:OrganizerSignupForm',
                signup_extra_form_class_path='events.kuplii2021.forms:OrganizerSignupExtraForm',
                active_from=now(),
...
class Command(BaseCommand):
    args = ''
    help = 'Setup kuplii2021 specific stuff'

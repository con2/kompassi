...
class Setup:
    ...
    def setup_core(self):
        ...
        self.event, unused = Event.objects.get_or_create(
            ...
            defaults=dict(
                name="Concon 18",
                name_genitive="Concon 18 -seminaarin",
                name_illative="Concon 18 -seminaariin",
                name_inessive="Concon 18 -seminaarissa",
                homepage_url="https://con2.fi/concon",
                organization=self.organization,
                start_time=datetime(2023, 1, 28, 10, 0, tzinfo=self.tz),
                end_time=datetime(2023, 1, 28, 18, 0, tzinfo=self.tz),
                venue=self.venue,
                public=False,
            ),
        )
    ...
    def setup_enrollment(self):
        ...
        enrollment_event_meta_defaults = dict(
            ...
            form_class_path="events.concon18.forms:EnrollmentForm",
...
class Command(BaseCommand):
    args = ""
    help = "Setup Concon 18 specific stuff"

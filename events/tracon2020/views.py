...
def tracon2020_afterparty_participants_view(request, vars, event):
...
def tracon2020_afterparty_summary_view(request, event_slug):
    assert event_slug == "tracon2020"
    ...
    return render(request, "tracon2020_afterparty_summary_view.pug", vars)

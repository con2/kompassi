# -*- coding: utf-8 -*-
# Generated by Django 1.10.8 on 2018-01-31 21:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='matsucon2018_signup_extras', to='core.Event')),
                ('person', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='matsucon2018_signup_extra', to='core.Person')),
                ('special_diet', models.ManyToManyField(blank=True, related_name='matsucon2018_signupextra', to='enrollment.SpecialDiet', verbose_name='Erikoisruokavalio')),
            ],
            options={
                'abstract': False,
            },

...
class EnrollmentForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['traconjv_solemnly_swear'].label = 'Vakuutan antamani tiedot oikeiksi. Ilmoittautumalla sitoudun osallistumaan peruskurssille 25.–31.3. pääkaupunkiseudulla ja järjestyksenvalvojana Ropecon 2019- tai Ropecon 2020-tapahtumiin.'

...
LARP_FORM_FIELD_TEXTS = dict(
    ...
    ropecon2020_theme_end_of_the_world=(_('Theme: End of the world'), _('If your larp is related to the theme of Ropecon 2021 (end of the world), please tick this box.')),
    ropecon2020_theme_dinosaurs=(_('Theme: Dinosaurs'), _('If your larp is related to the children’s theme of Ropecon 2021 (dinosaurs), please tick this box.')),
)

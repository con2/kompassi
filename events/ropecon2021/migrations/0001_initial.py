# Generated by Django 2.2.9 on 2020-08-29 11:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ropecon2021_signup_extras', to='core.Event')),
                ('person', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='ropecon2021_signup_extra', to='core.Person')),
                ('special_diet', models.ManyToManyField(blank=True, to='ropecon2021.SpecialDiet', verbose_name='Erikoisruokavalio')),
            ],
            options={
                'abstract': False,
            },

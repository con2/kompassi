...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='SignupExtra',
            fields=[
                ('signup', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='hitpoint2019_signup_extra', serialize=False, to='labour.Signup')),

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='desucon2016_signup_extras', to='core.Event')),
                ('person', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='desucon2016_signup_extra', to='core.Person')),
                ('special_diet', models.ManyToManyField(blank=True, to='desucon2016.SpecialDiet', verbose_name='Erikoisruokavalio')),
            ],
            options={
                'abstract': False,
            },

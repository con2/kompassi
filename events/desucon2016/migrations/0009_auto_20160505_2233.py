...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('desucon2016', '0008_auto_20160406_2151'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='signupextra',
            name='shirt_type',
            field=models.CharField(choices=[('STAFF', 'Staff'), ('DESURITY', 'Desurity'), ('KUVAAJA', 'Kuvaaja'), ('VENDOR', 'Myynti'), ('TOOLATE', 'My\xf6h\xe4styi paitatilauksesta')], default='TOOLATE', max_length=8, verbose_name='Paidan tyyppi'),
        ),
    ]

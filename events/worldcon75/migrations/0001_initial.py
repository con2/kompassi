        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Miten olet käytettävissä työvuoroihin tapahtuman aikana? Jos tiedät, ettet pääse paikalle johonkin tiettyyn aikaan tai haluat esimerkiksi osallistua johonkin tiettyyn ohjelmanumeroon, mainitse siitä tässä.",
                ...
                (
                    "is_attending_member",
                    models.BooleanField(verbose_name="Olen Worldcon 75:n <em>attending member</em>"),
                ),
                (
                    "event",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="worldcon75_signup_extras",
                        to="core.Event",
                    ),
                ),
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="worldcon75_signup_extra",
                        to="core.Person",
                    ),
                ),
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="worldcon75_signupextra",

...
class Setup(object):
    ...
    def setup_tickets(self):
        ...
        defaults = dict(
            ...
            ticket_free_text=u"Tämä on sähköinen lippusi Tracon 11 -tapahtumaan. Sähköinen lippu vaihdetaan rannekkeeseen\n"
            ...
            front_page_text=u"<h2>Tervetuloa ostamaan pääsylippuja Tracon 11 -tapahtumaan!</h2>"
                u"<p>Liput maksetaan suomalaisilla verkkopankkitunnuksilla heti tilauksen yhteydessä.</p>"
                u"<p>Lue lisää tapahtumasta <a href='http://2016.tracon.fi'>Traconin kotisivuilta</a>.</p>",
        )
        ...
        for product_info in [
            dict(
                ...
                description=u'Paketti sisältää kaksi viikonloppulippua ja yhden Tracon 2016 -seinäkalenterin. Tuotteet toimitetaan antamaasi osoitteeseen postitse, ja postikulut sisältyvät hintaan.',
            ...
            dict(
                ...
                description=u'Paketti sisältää yhden viikonloppulipun ja yhden Tracon 2016 -seinäkalenterin. Tuotteet toimitetaan antamaasi osoitteeseen postitse, ja postikulut sisältyvät hintaan.',
                limit_groups=[
            ...
            dict(
                ...
                description=u'Viikonloppulippu Tracon 2016 -tapahtumaan. Voimassa koko viikonlopun ajan la klo 10 – su klo 18. Toimitetaan sähköpostitse PDF-tiedostona, jossa olevaa viivakoodia vastaan saat rannekkeen tapahtumaan saapuessasi.',
                limit_groups=[
                    limit_group('Lauantain liput', 3525),
                    limit_group('Sunnuntain liput', 3525),
                ],
            ...
            dict(
                ...
                description=u'Lauantailippu Tracon 2016 -tapahtumaan. Voimassa koko lauantaipäivän ajan la klo 10 – su klo 08. Toimitetaan sähköpostitse PDF-tiedostona, jossa olevaa viivakoodia vastaan saat rannekkeen tapahtumaan saapuessasi.',
                limit_groups=[
                    limit_group('Lauantain liput', 3525),
                ],
                price_cents=1800,
            ...
            dict(
                ...
                description=u'Lauantailippu Tracon 2016 -tapahtumaan. Voimassa koko sunnuntaipäivän ajan su klo 00 - su klo 18. Toimitetaan sähköpostitse PDF-tiedostona, jossa olevaa viivakoodia vastaan saat rannekkeen tapahtumaan saapuessasi.',
                limit_groups=[
                    limit_group('Sunnuntain liput', 3525),
                ],
                price_cents=1500,
            ...
            dict(
                ...
                description=u'Sisältää liput The Super Sound of Videogames 2 -konserttiin sekä Traconin iltabileisiin.</p><p>'
                    ...
                    u'Traconin iltabileet Pakkahuoneella lauantaina 5. syyskuuta 2016 kello 19–01. Esiintymässä MACHINAE SUPREMACY (SWE) sekä YOHIO (SWE) + DJ:t Klubilla. Ei sisällä narikkamaksua 2 €.</p><p>'
            ...
            dict(
                ...
                description=u'Traconin iltabileet Pakkahuoneella lauantaina 5. syyskuuta 2016 kello 19–01. Esiintymässä MACHINAE SUPREMACY (SWE) sekä YOHIO (SWE) + DJ:t Klubilla. Ei sisällä narikkamaksua 2 €.</p><p>'

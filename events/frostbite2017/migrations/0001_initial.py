# -*- coding: utf-8 -*-
# Generated by Django 1.9.9 on 2016-09-09 11:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='frostbite2017_signup_extras', to='core.Event')),
                ('person', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='frostbite2017_signup_extra', to='core.Person')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='special_diet',
            field=models.ManyToManyField(blank=True, to='frostbite2017.SpecialDiet', verbose_name='Erikoisruokavalio'),
        ),
    ]

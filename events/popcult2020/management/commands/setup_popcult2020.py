...
class Setup(object):
    ...
    def setup_core(self):
        ...
        self.venue, unused = Venue.objects.get_or_create(name='Kulttuuritehdas Korjaamo (Helsinki)', defaults=dict(
        ...
        self.event, unused = Event.objects.get_or_create(slug='popcult2020', defaults=dict(
    ...
    def setup_tickets(self):
        ...
        defaults = dict(
            ...
            ticket_free_text=
                "Tämä on sähköinen lippusi Popcult Helsinki 2020 -tapahtumaan. Sähköinen lippu vaihdetaan\n"

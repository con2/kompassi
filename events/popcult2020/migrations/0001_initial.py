    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('want_certificate', models.BooleanField(default=False, verbose_name='Haluan todistuksen työskentelystäni Popcult Helsingissä')),
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='popcult2020_signup_extras', to='core.Event')),
                ('person', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='popcult2020_signup_extra', to='core.Person')),
                ('special_diet', models.ManyToManyField(blank=True, related_name='popcult2020_signupextra', to='enrollment.SpecialDiet', verbose_name='Erikoisruokavalio')),
            ],
            options={
                'abstract': False,
            },

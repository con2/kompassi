...
class Setup(object):
    ...
    def setup_core(self):
        ...
        self.event, unused = Event.objects.get_or_create(slug='kuplii2020', defaults=dict(
            name='Tampere Kuplii 2020',
            name_genitive='Tampere Kuplii 2020 -tapahtuman',
            name_illative='Tampere Kuplii 2020 -tapahtumaan',
            name_inessive='Tampere Kuplii 2020 -tapahtumassa',
            homepage_url='http://2020.tamperekuplii.fi',
            organization=self.organization,
            start_time=datetime(2020, 3, 18, 10, 0, tzinfo=self.tz),
            end_time=datetime(2020, 3, 22, 17, 0, tzinfo=self.tz),
            venue=self.venue,
        ))
    ...
    def setup_labour(self):
        ...
        AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path='events.kuplii2020.forms:OrganizerSignupForm',
                signup_extra_form_class_path='events.kuplii2020.forms:OrganizerSignupExtraForm',
                active_from=now(),
...
class Command(BaseCommand):
    args = ''
    help = 'Setup kuplii2020 specific stuff'

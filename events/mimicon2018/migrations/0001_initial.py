...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='SignupExtra',
            fields=[
                ('signup', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='mimicon2018_signup_extra', serialize=False, to='labour.Signup')),
                ...
                ('want_certificate', models.BooleanField(default=False, verbose_name='Haluan todistuksen työskentelystäni Mimiconissa')),
                ...
                ('lodging_needs', models.ManyToManyField(blank=True, help_text='Jos tarvitset lattiamajoitusta, merkitse tähän ne yöt joina tarvitset majoitusta.', to='mimicon2018.Night', verbose_name='Majoitustarpeet')),
            ],
            options={
                'abstract': False,
            },

# Generated by Django 2.1.12 on 2019-09-06 06:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='desucon2020_signup_extras', to='core.Event')),
                ('person', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='desucon2020_signup_extra', to='core.Person')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='special_diet',
            field=models.ManyToManyField(blank=True, related_name='_signupextra_special_diet_+', to='desucon2020.SpecialDiet', verbose_name='Erikoisruokavalio'),
        ),
    ]

...
class Setup(object):
    ...
    def setup_core(self):
        ...
        self.event, unused = Event.objects.get_or_create(slug='hitpoint2020', defaults=dict(
            name='Tracon Hitpoint 2020',
            name_genitive='Tracon Hitpoint 2020 -tapahtuman',
            name_illative='Tracon Hitpoint 2020 -tapahtumaan',
            name_inessive='Tracon Hitpoint 2020 -tapahtumassa',
            homepage_url='http://2020.hitpoint.tracon.fi',
            organization=self.organization,
            start_time=datetime(2020, 11, 14, 10, 0, tzinfo=self.tz),
            end_time=datetime(2020, 11, 15, 18, 0, tzinfo=self.tz),
            venue=self.venue,
        ))
    ...
    def setup_labour(self):
        ...
        labour_event_meta_defaults = dict(
            ...
            contact_email='Tracon Hitpoint 2020 -työvoimatiimi <hitpoint@tracon.fi>',
        )
        ...
        AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path='events.hitpoint2020.forms:OrganizerSignupForm',
                signup_extra_form_class_path='events.hitpoint2020.forms:OrganizerSignupExtraForm',
        ...
        Survey.objects.get_or_create(
            ...
            defaults=dict(
                ...
                form_class_path='events.hitpoint2020.forms:SwagSurvey',
                active_from=now(),
                active_until=self.event.end_time,
            ),
        )
        ...
        for wiki_space, link_title, link_group in [
            ('HITPOINT2020', 'Coniteawiki', 'conitea'),
    ...
    def setup_programme(self):
        ...
        AlternativeProgrammeForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                description='',
                programme_form_code='events.hitpoint2020.forms:RpgForm',
                num_extra_invites=0,
                order=10,
            )
        )
        ...
        AlternativeProgrammeForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                short_description='',
                programme_form_code='events.hitpoint2020.forms:FreeformForm',
                num_extra_invites=0,
                order=20,
            )
        )
    ...
    def setup_tickets(self):
        ...
        defaults = dict(
            ...
            front_page_text="<h2>Tervetuloa ostamaan pääsylippuja Tracon Hitpoint -tapahtumaan!</h2>"
                ...
                "<p>Lue lisää tapahtumasta <a href='http://2020.hitpoint.tracon.fi'>Tracon Hitpoint -tapahtuman kotisivuilta</a>.</p>"
        ...
        for product_info in [
            dict(
                ...
                description='Viikonloppulippu Tracon Hitpoint 2020 -tapahtumaan. Voimassa koko viikonlopun ajan la klo 10–00 ja su klo 10–18. Toimitetaan sähköpostitse PDF-tiedostona, jossa olevaa viivakoodia vastaan saat rannekkeen tapahtumaan saapuessasi.',
                limit_groups=[
...
class Command(BaseCommand):
    args = ''
    help = 'Setup hitpoint2020 specific stuff'

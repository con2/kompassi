...
RPG_FORM_FIELD_TEXTS = dict(
    ...
    ropecon2020_not_suitable_for_children=(_('Not suitable for children under 15'), _('If your game is not suitable for children under 15 years of age, please tick this box.')),
    ropecon_theme=(_('Theme: Elements'), _('If your game is related to the theme of Ropecon 2022, please tick this box.')),
...
LARP_FORM_FIELD_TEXTS = dict(
    ...
    notes_from_host=(_('Comments'), _('Do you want to say something to the larp-conittee something that does not fit any of the fields above or clarify some answer?<br/><br/>If the design of your larp requires a large number of your characters to be gendered (for example, a larp about a sauna night with the guys, or about female pilots in WWII).<br/><br/>When deciding which larps to include at Ropecon, we want as many larps as possible to be accessible for as many attendees as possible, regardless of their gender or the gender they prefer to larp as. Requiring a large number of your characters to be gendered may affect whether or not your submission for a larp is accepted.<br/><br/>You can also specify your preferred schedule here.')),
    ...
    ropecon2020_not_suitable_for_children=(_('Not suitable for children under 15'), _('If your larp is not suitable for children under 15 years of age, please tick this box.')),
    ropecon2021_programme_for_children=(_('Programme for children'), _('If your larp is aimed at children and their guardians, please tick this box.')),
    ...
    ropecon_theme=(_('Theme: Elements'), _('If your larp is related to the theme of Ropecon 2022, please tick this box.')),
...
PROGRAMME_FORM_FIELD_TEXTS = dict(
    ...
    ropecon2020_not_suitable_for_children=(_('Not suitable for children under 15'), _('If your programme is not suitable for children under 15 years of age, please tick this box.')),

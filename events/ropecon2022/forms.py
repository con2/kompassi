...
RPG_FORM_FIELD_TEXTS = dict(
    ...
    is_revolving_door=(_('Revolving door RPG'), _('If new players can join your game while it is already running and old players can leave freely before the game has ended, please tick this box. Mention this in the description of your game as well, and provide additional information in the Comments section below if needed. If you are not sure whether your game is a revolving door RPG or not, contact us and we will figure it out together!')),
    is_in_english=(_('English OK'), _('If you are able, prepared and willing to run your game in English if necessary, please tick this box. If your game is selected for the event, we will contact you regarding the choice of language.')),
    ...
    is_beginner_friendly=(_('Beginner-friendly'), _('If your game is suitable for players with very limited or without any previous experience about role-playing games, please tick this box.')),
    ropecon_theme=(_('Theme: Friendship'), _('If your game is related to the theme of Ropecon 2022, please tick this box.')),
    ...
    ropecon2021_accessibility_inaccessibility=(_('Other inaccessibility'), _('In the open field, define if necessary what features of your game may possibly limit participation.')),
...
class RpgForm(AlternativeProgrammeFormMixin, forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Fieldset(_('Who is your game for?'),
                'is_in_english',
    ...
    def get_excluded_field_defaults(self):
        return dict(
            category=Category.objects.get(event__slug='ropecon2022', slug='rpg'),
        )
...
LARP_FORM_FIELD_TEXTS = dict(
    ...
    ropecon2018_characters=(_('Number of characters'), _('If the design of your larp requires gendered characters, please mention it in the Comments section of this form.')),
    ...
    other_author=(_('Game designer (if other than GM)'), _('If the larp was designed by someone other than the GM running it at Ropecon, please enter the name of the designer here.')),
    ropecon2018_signuplist=(_('Who makes the sign-up list - you or the Larp Desk?'), _('If you make the sign-up list for your larp yourself, you can ask more specific questions about player preferences. A sign-up list made by the Larp Desk is simply a list of names. In this case, select "Larp Desk makes the list".')),
    ropecon2021_blocked_time_slots=(_('When are you NOT able to run your larp?'), _('Select the times when you are <b>NOT able</b> to run your larp. In other words, leave the times that you would be <b>able</b> to run your larp unselected!<br><br>In this section, we would like to know more about how work or volunteer shifts, public transport schedules and other factors might be impacting your schedule. For example, if you need to leave the venue by 11pm to be able to catch the last bus to your accommodation.<br/><br/>If you have a more specific request in mind regarding your schedule (for example, you would like to run your larp late at night), please let us know in the Comments section below.')),
    notes_from_host=(_('Comments'), _('Do you want to say something to the larp-conittee that does not fit any of the fields above or clarify some answer?<br/><br/>If the design of your larp requires a large number of your characters to be gendered (for example, a larp about a sauna night with the guys, or about female pilots in WWII).<br/><br/>When deciding which larps to include at Ropecon, we want as many larps as possible to be accessible for as many attendees as possible, regardless of their gender or the gender they prefer to larp as. Requiring a large number of your characters to be gendered may affect whether or not your submission for a larp is accepted.<br/><br/>You can also specify your preferred schedule here.')),
    is_in_english=(_('English OK'), _('If you are able, prepared and willing to run your larp in English if necessary, please tick this box. If your larp is selected for the event, the programming team will contact you regarding the choice of language.')),
    ...
    ropecon_theme=(_('Theme: Friendship'), _('If your larp is related to the theme of Ropecon 2022, please tick this box.')),
    ropecon2018_space_requirements=(_('Space and technical needs'), _('Describe what kind of space you hope to organise your larp in (completely dark, separate rooms, water supply, etc.) and whether you have any technical needs (lights, sound, etc). Please keep in mind that we may not be able to fulfill all requests, so please justify how yours would benefit your larp.')),
...
class LarpForm(forms.ModelForm, AlternativeProgrammeFormMixin):
    ...
    def get_excluded_field_defaults(self):
        return dict(
            category=Category.objects.get(event__slug='ropecon2022', slug='larp'),
        )
...
PROGRAMME_FORM_FIELD_TEXTS = dict(
    ...
    is_english_ok=(_('English OK'), _('If you are able, prepared and willing to organise your programme in English if necessary, please tick this box. If your programme is selected for the event, the programme team will be in contact with you in regards to your language choice.')),
    ropecon2021_gamedesk_physical_or_virtual=(_('Physical or virtual programme?'), _('The organisers of Ropecon strive to organise a physical  con; if it can be organised thusly, virtual programmes cannot be organised. If a physical con cannot be organised, physical programmes cannot be organised, naturally.<br/><br/>Specify here whether you can organise your programme at a physical con, at a virtual con, or at both.')),
    ...
    is_age_restricted=(_('For 18+ only'), _('If your programme contains themes that require participants to be 18 years or older, please tick this box. There will be an ID check for all participants.')),
    ...
    ropecon2021_blocked_time_slots=(_('When are you NOT able to host your programme?'), _('Select the times when you <b>DO NOT</b> want to host your programme. Time slots have been intentionally left vague. If you have a more specific request in mind regarding your schedule, please let us know in the Comments section below.')),
    ...
    is_available_for_panel=(_('Panel discussions'), _('I’m interested in participating in a panel discussion related to my field(s) of expertise.')),
...
class ProgrammeForm(forms.ModelForm, AlternativeProgrammeFormMixin):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            'video_permission',
            Fieldset(_('Accessibility and inclusivity'),
                RenderTemplate('ropecon2022_programme_form_accessibility.html'),
                'ropecon2021_accessibility_loud_sounds',
                'ropecon2021_accessibility_flashing_lights',
                'ropecon2021_accessibility_strong_smells',
                'ropecon2021_accessibility_irritate_skin',
...
class OrganizerSignupForm(forms.ModelForm, AlternativeFormMixin):
    ...
    def get_excluded_m2m_field_defaults(self):
        return dict(
            job_categories=JobCategory.objects.filter(event__slug='ropecon2022', name='Conitea')
        )

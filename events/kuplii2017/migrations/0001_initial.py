    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shift_type', models.CharField(choices=[('2h', '2 tunnin vuoroja'), ('4h', '4 tunnin vuoroja'), ('yli4h', 'Yli 4 tunnin vuoroja')], help_text='Haluatko tehd\xe4 yhden pitk\xe4n ty\xf6vuoron vaiko monta lyhyemp\xe4\xe4 vuoroa?', max_length=15, verbose_name='Toivottu ty\xf6vuoron pituus')),
                ('total_work', models.CharField(choices=[('8h', '8 tuntia'), ('yli8h', 'Yli 8 tuntia')], help_text='Kuinka paljon haluat tehd\xe4 t\xf6it\xe4 yhteens\xe4 tapahtuman aikana? Useimmissa teht\xe4vist\xe4 minimi on kahdeksan tuntia, mutta joissain teht\xe4viss\xe4 se voi olla my\xf6s v\xe4hemm\xe4n (esim. majoitusvalvonta 6 h).', max_length=15, verbose_name='Toivottu kokonaisty\xf6m\xe4\xe4r\xe4')),

...
class Setup(object):
    ...
    def setup_core(self):
        ...
        self.event, unused = Event.objects.get_or_create(
            ...
            defaults=dict(
                ...
                homepage_url="http://2022.tracon.fi",
                organization=self.organization,
                start_time=datetime(2022, 9, 3, 16, 0, tzinfo=self.tz),
                end_time=datetime(2022, 9, 5, 18, 0, tzinfo=self.tz),
                venue=self.venue,
    ...
    def setup_labour(self):
        ...
        AlternativeSignupForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                signup_form_class_path="events.tracon2022.forms:OrganizerSignupForm",
                signup_extra_form_class_path="events.tracon2022.forms:OrganizerSignupExtraForm",
                active_from=now(),
        ...
        InfoLink.objects.get_or_create(
            ...
            title="Coniteawiki",
            defaults=dict(
                url="https://wiki.tracon.fi",
                group=labour_event_meta.get_group("conitea"),
            ),
        )
        ...
        Survey.objects.get_or_create(
            ...
            defaults=dict(
                ...
                form_class_path="events.tracon2022.forms:ShiftWishesSurvey",
                active_from=now(),
    ...
    def setup_tickets(self):
        ...
        defaults = dict(
            ...
            ticket_free_text=(
                "Tämä on sähköinen lippusi vuoden 2022 Traconiin. Sähköinen lippu vaihdetaan rannekkeeseen\n"
            ...
            front_page_text=(
                ...
                "<p>Lue lisää tapahtumasta <a href='http://2022.tracon.fi'>Traconin kotisivuilta</a>.</p>"
            ),
        )
    ...
    def setup_programme(self):
        ...
        if settings.DEBUG:
            ...
            programme_event_meta.accepting_cold_offers_until = now() + timedelta(
                days=60
            )
        ...
        for time_block in TimeBlock.objects.filter(event=self.event):
            ...
            for hour_start_time in full_hours_between(
                time_block.start_time, time_block.end_time
            )[:-1]:
        ...
        AlternativeProgrammeForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                programme_form_code="events.tracon2022.forms:RpgForm",
                num_extra_invites=0,
                order=10,
            ),
        )
        ...
        default_form, created = AlternativeProgrammeForm.objects.get_or_create(
            ...
            defaults=dict(
                ...
                programme_form_code="events.tracon2022.forms:ProgrammeForm",
                num_extra_invites=3,
                order=30,
            ),
        )
        if default_form.programme_form_code == "programme.forms:ProgrammeOfferForm":
            default_form.programme_form_code = "events.tracon2022.forms:ProgrammeForm"
            default_form.save()
    ...
    def setup_access(self):
        ...
        for metavar in [
            ...
            alias_type = EmailAliasType.objects.get(
                domain__domain_name="tracon.fi", metavar=metavar
            )
    ...
    def setup_kaatoilmo(self):
        ...
        for coach_title, room_title, hour in [
            ...
            coach, created = Programme.objects.get_or_create(
                ...
                title=coach_title,
                defaults=dict(
                    room=Room.objects.get_or_create(event=self.event, name=room_title)[
                        0
                    ],
...
class Command(BaseCommand):
    args = ""
    help = "Setup tracon2022 specific stuff"

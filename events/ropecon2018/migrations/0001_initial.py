    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_work', models.CharField(choices=[('miel', 'Otan mielelläni varatyövoimavuoron'), ('ei', 'En halua varatyövuoroa')], help_text='Varatyövoiman päivystysvuoro on 4h, jonka aikana sinun tulee olla tavoitettavissa puhelimella Messukeskuksessa. Voit joutua mihin tahansa työpisteeseen paikkaamaan', max_length=5, verbose_name='Haluatko päivystää varatyövoimana?')),

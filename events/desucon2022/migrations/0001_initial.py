# Generated by Django 2.2.24 on 2021-09-14 12:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='desucon2022_signup_extras', to='core.Event')),
                ('person', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='desucon2022_signup_extra', to='core.Person')),
                ('special_diet', models.ManyToManyField(blank=True, related_name='_signupextra_special_diet_+', to='desucon2022.SpecialDiet', verbose_name='Erikoisruokavalio')),
            ],
            options={
                'abstract': False,
            },

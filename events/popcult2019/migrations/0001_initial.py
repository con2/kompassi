# -*- coding: utf-8 -*-
# Generated by Django 1.10.8 on 2018-11-14 07:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('want_certificate', models.BooleanField(default=False, verbose_name='Haluan todistuksen työskentelystäni Popcult Dayssa')),
                ...
                ('y_u', models.TextField(blank=True, help_text='Miksi juuri sinä sopisit hakemaasi työtehtävään? Voit kertoa itsestäsi vapaamuotoisesti: harrastukset, koulutus, hullu-kissanainen/vähemmän-hullu-koiraihminen yms.', verbose_name='Miksi juuri sinä?')),
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='popcult2019_signup_extras', to='core.Event')),
                ('person', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='popcult2019_signup_extra', to='core.Person')),
                ('special_diet', models.ManyToManyField(blank=True, related_name='popcult2019_signupextra', to='enrollment.SpecialDiet', verbose_name='Erikoisruokavalio')),
            ],
            options={
                'abstract': False,
            },

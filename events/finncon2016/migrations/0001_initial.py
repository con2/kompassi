    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shift_type', models.CharField(help_text='Haluatko tehd\xe4 yhden pitk\xe4n ty\xf6vuoron vaiko monta lyhyemp\xe4\xe4 vuoroa?', max_length=15, verbose_name='Toivottu ty\xf6vuoron pituus', choices=[('2h', b'2 tunnin vuoroja'), ('4h', b'4 tunnin vuoroja'), ('yli4h', b'Yli 4 tunnin vuoroja')])),
                ('total_work', models.CharField(help_text='Kuinka paljon haluat tehd\xe4 t\xf6it\xe4 yhteens\xe4 tapahtuman aikana? Useimmissa teht\xe4vist\xe4 minimi on kahdeksan tuntia, mutta joissain teht\xe4viss\xe4 se voi olla my\xf6s v\xe4hemm\xe4n (esim. majoitusvalvonta 6 h).', max_length=15, verbose_name='Toivottu kokonaisty\xf6m\xe4\xe4r\xe4', choices=[('8h', b'8 tuntia'), ('yli8h', b'Yli 8 tuntia')])),
        ...
        migrations.AddField(
            ...
            name='special_diet',
            field=models.ManyToManyField(to='finncon2016.SpecialDiet', verbose_name='Erikoisruokavalio', blank=True),

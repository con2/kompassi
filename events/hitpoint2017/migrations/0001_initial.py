...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='SignupExtra',
            fields=[
                ('signup', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='hitpoint2017_signup_extra', serialize=False, to='labour.Signup')),
                ...
                ('total_work', models.CharField(choices=[('8h', 'Minimi - 8 tuntia'), ('12h', '10\u201312 tuntia'), ('yli12h', 'Ty\xf6n Sankari! Yli 12 tuntia!')], help_text='Kuinka paljon haluat tehd\xe4 t\xf6it\xe4 yhteens\xe4 tapahtuman aikana? Useimmissa teht\xe4vist\xe4 minimi on kahdeksan tuntia, mutta joissain teht\xe4viss\xe4 se voi olla my\xf6s v\xe4hemm\xe4n (esim. majoitusvalvonta 6 h).', max_length=15, verbose_name='Toivottu kokonaisty\xf6m\xe4\xe4r\xe4')),
                ('night_work', models.CharField(choices=[('miel', 'Ty\xf6skentelen mielell\xe4ni y\xf6vuorossa'), ('tarv', 'Voin tarvittaessa ty\xf6skennell\xe4 y\xf6vuorossa'), ('ei', 'En vaan voi ty\xf6skennell\xe4 y\xf6vuorossa')], help_text='Y\xf6t\xf6it\xe4 voi olla ainoastaan lauantain ja sunnuntain v\xe4lisen\xe4 y\xf6n\xe4.', max_length=5, verbose_name='Voitko ty\xf6skennell\xe4 y\xf6ll\xe4?')),
                ('construction', models.BooleanField(default=False, help_text='Huomaathan, ett\xe4 perjantain ja lauantain v\xe4liselle y\xf6lle ei ole tarjolla majoitusta.', verbose_name='Voin ty\xf6skennell\xe4 jo perjantaina 27. marraskuuta')),

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shirt_type', models.CharField(choices=[('NO_SHIRT', 'Ei paitaa'), ('STAFF', 'Staff'), ('DESURITY', 'Desurity'), ('DESUTV', 'DesuTV'), ('KUVAAJA', 'Kuvaaja'), ('VENDOR', 'Myynti'), ('TOOLATE', 'Myöhästyi paitatilauksesta')], default='TOOLATE', max_length=8, verbose_name='Paidan tyyppi')),
                ...
                ('special_diet', models.ManyToManyField(blank=True, related_name='_desucon2023_signupextra_special_diet+', to='desucon2023.specialdiet', verbose_name='Erikoisruokavalio')),
            ],
            options={
                'abstract': False,
            },

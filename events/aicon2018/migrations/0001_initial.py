            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        ...
                        primary_key=True,
                        related_name="aicon2018_signup_extra",
                        serialize=False,
                        to="labour.Signup",
                    ),
                ),
                ...
                (
                    "want_certificate",
                    models.BooleanField(default=False, verbose_name="Haluan todistuksen työskentelystäni Aiconissa"),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default="",
                        help_text='Vastaavat saavat käyttöönsä sähköpostialiakset, jotka ovat muotoa tehtävä@aicon.fi. Mikäli tiedät jo Aiconin vastaavatehtäväsi, syötä se tähän mahdollisimman yksinkertaisessa muodossa (esim. pj, työvoima, ohjelma ym). Osoitteessa isot kirjaimet muutetaan automaattisesti pieniksi, ä a:ksi ja niin edelleen. Näet lopullisen osoitteesi <a href="/profile/aliases" target="_blank">profiilin sähköpostialiassivulta</a> sitten, kun vastaavailmoittautumisesi on hyväksytty. Mikäli osoitteisiin tarvitaan tämän jälkeen muutoksia, Japsu auttaa.',
                        max_length=32,
                        validators=[

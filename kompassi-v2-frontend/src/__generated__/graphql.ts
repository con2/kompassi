...
export type FullProgramType = {
  ...
  /** Returns a mapping of dimension slugs to lists of value slugs. By default, returns both dimensions set on the program itself and those set on its schedule items. If `own_only` is True, only returns dimensions set on the program itself. */
  cachedDimensions?: Maybe<Scalars['GenericScalar']['output']>;
...
export type FullScheduleItemType = {
  ...
  /** Returns a mapping of dimension slugs to lists of value slugs. By default, returns both dimensions set on the schedule item itself and those set on its parent program. If `own_only` is True, only returns dimensions set on the schedule item itself. */
  cachedDimensions?: Maybe<Scalars['GenericScalar']['output']>;
  createdAt: Scalars['DateTime']['output'];

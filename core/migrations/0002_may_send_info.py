...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.may_send_info'
        db.add_column(u'core_person', 'may_send_info',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.may_send_info'
        db.delete_column(u'core_person', 'may_send_info')

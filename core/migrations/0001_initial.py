    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_illative', models.CharField(help_text='Esimerkki: Susiconiin', max_length=63, verbose_name='Tapahtuman nimi illatiiviss\xe4')),
                ('name_inessive', models.CharField(help_text='Esimerkki: Susiconissa', max_length=63, verbose_name='Tapahtuman nimi inessiiviss\xe4')),
                ...
                ('organization_name', models.CharField(max_length=63, verbose_name='J\xe4rjest\xe4v\xe4 taho', blank=True)),
                ('organization_url', models.CharField(max_length=255, verbose_name='J\xe4rjest\xe4v\xe4n tahon kotisivu', blank=True)),
                ('public', models.BooleanField(default=True, help_text='Julkiset tapahtumat n\xe4ytet\xe4\xe4n etusivulla.', verbose_name='Julkinen')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('may_send_info', models.BooleanField(default=False, verbose_name='Minulle saa l\xe4hett\xe4\xe4 s\xe4hk\xf6postitse tietoa tulevista tapahtumista <i>(vapaaehtoinen)</i>')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_inessive', models.CharField(help_text='Esimerkki: Paasitornissa', max_length=63, verbose_name='Tapahtumapaikan nimi inessiiviss\xe4')),
            ],
            options={

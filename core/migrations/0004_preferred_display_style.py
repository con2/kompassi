...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.preferred_name_display_style'
        db.add_column(u'core_person', 'preferred_name_display_style',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.preferred_name_display_style'
        db.delete_column(u'core_person', 'preferred_name_display_style')

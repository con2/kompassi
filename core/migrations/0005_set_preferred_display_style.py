...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm.Person.objects.filter(anonymous__isnull=True, nick__isnull=True).update(preferred_name_display_style='firstname_surname')
        orm.Person.objects.filter(anonymous__isnull=True, nick__isnull=False).update(preferred_name_display_style='firstname_nick_surname')
        orm.Person.objects.filter(anonymous=True).update(preferred_name_display_style='nick')
        orm.Person.objects.filter(anonymous=False, nick__isnull=True).update(preferred_name_display_style='firstname_surname')
        orm.Person.objects.filter(anonymous=False, nick__isnull=False).update(preferred_name_display_style='firstname_nick_surname')

    def backwards(self, orm):
        raise RuntimeError('programmer says no')

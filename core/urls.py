...
urlpatterns = [
    ...
    re_path(r"^events/(?P<event_slug>[a-z0-9-]+)/fobba.xlsx$", core_fobba_export_view, name="core_fobba_export_view"),
    re_path(
        r"^organizations/?$",
        core_organizations_view,
    ...
    re_path(
        r"^organizations/(?P<organization_slug>[a-z0-9-]+)/?$", core_organization_view, name="core_organization_view"
    ),
    ...
    re_path(r"^profile/password/reset/(?P<code>[a-f0-9]+)$", core_password_reset_view, name="core_password_reset_view"),
    path("profile/email/verify", core_email_verification_request_view, name="core_email_verification_request_view"),
    re_path(
        r"^profile/email/verify/(?P<code>[a-f0-9]+)$", core_email_verification_view, name="core_email_verification_view"
    ),
    re_path(
        r"^impersonate/(?P<username>[a-zA-Z0-9_-]+)$", core_admin_impersonate_view, name="core_admin_impersonate_view"
    ),
]

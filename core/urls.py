...
urlpatterns = [
    ...
    re_path(r"^organizations/(?P<organization_slug>[a-z0-9-]+)/?$", core_organization_view, name="core_organization_view"),
    ...
    re_path(r"^impersonate/(?P<username>[a-zA-Z0-9_-]+)$", core_admin_impersonate_view, name="core_admin_impersonate_view"),
]

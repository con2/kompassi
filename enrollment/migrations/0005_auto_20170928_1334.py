...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, default='', help_text='Mikäli edustat jotain tapahtumaorganisaatiota, voit kertoa siitä tässä. Conconiin ovat tervetulleita osallistumaan kaikki kiinnostuneet, eli minkään tapahtumaorganisaation edustaminen ei ole edellytys osallistumiselle. Jos annat julkaista nimesi osallistujalistassa, myös tämä kenttä näytetään siinä.', max_length=512, verbose_name='Mitä tapahtumia edustat?'),
        ),
        migrations.AlterField(
            model_name='enrollment',
            name='is_public',
        ...
        migrations.AddField(
            model_name='enrollment',
            name='concon_parts',
            field=models.ManyToManyField(blank=True, help_text='Concon koostuu päivän luento- ja keskusteluohjelmasta sekä jatkosaunasta illalla.', to='enrollment.ConconPart', verbose_name='Mihin osiin tilaisuudesta osallistut?'),
        ),
    ]

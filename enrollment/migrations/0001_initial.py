    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('special_diet_other', models.TextField(blank=True, help_text="If you're on a diet that's not included in the list, please detail your diet here. Event organizer will try to take dietary needs into consideration, but all diets may not be catered for.", verbose_name='Other diets')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_class_path', models.CharField(help_text='Reference to form class. Example: events.yukicon2016.forms:EnrollmentForm', max_length=63)),

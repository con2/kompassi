...
export type AdminQuotaDetailPageQuery = { __typename?: 'Query', event?: { __typename?: 'FullEventType', name: string, slug: string, tickets?: { __typename?: 'TicketsV2EventMetaType', quota: { __typename?: 'FullQuotaType', id: string, name: string, countReserved: number, quota: number, products: Array<{ __typename?: 'LimitedProductType', id: string, title: string, price: any, countReserved: number }> } } | null } | null };

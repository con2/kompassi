...
export type ProgramListFragment = { __typename?: 'ProgramType', slug: string, title: string, cachedDimensions?: unknown | null, color: string, scheduleItems: Array<{ __typename?: 'ScheduleItemType', startTime: string, endTime: string, location?: string | null }> };

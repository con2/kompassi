...
export type LimitedPersonType = {
  __typename?: 'LimitedPersonType';
...
export type AcceptInvitationPageQuery = { __typename?: 'Query', profile?: { __typename?: 'ProfileType', firstName: string, lastName: string, nick: string, email: string, phoneNumber: string, discordHandle: string } | null, userRegistry: { __typename?: 'LimitedRegistryType', slug: string, title: string, policyUrl: string, organization: { __typename?: 'LimitedOrganizationType', slug: string, name: string } }, event?: { __typename?: 'FullEventType', name: string, involvement?: { __typename?: 'InvolvementEventMetaType', invitation?: { __typename?: 'FullInvitationType', isUsed: boolean, program?: { __typename?: 'LimitedProgramType', slug: string, title: string, description: string } | null, survey?: { __typename?: 'FullSurveyType', slug: string, isActive: boolean, purpose: SurveyPurpose, profileFieldSelector: { __typename?: 'ProfileFieldSelectorType', firstName: boolean, lastName: boolean, nick: boolean, email: boolean, phoneNumber: boolean, discordHandle: boolean }, registry?: { __typename?: 'LimitedRegistryType', slug: string, title: string, policyUrl: string, organization: { __typename?: 'LimitedOrganizationType', slug: string, name: string } } | null, form?: { __typename?: 'FormType', language: FormsFormLanguageChoices, title: string, description: string, fields?: unknown | null } | null, languages: Array<{ __typename?: 'FormType', language: FormsFormLanguageChoices }> } | null } | null } | null } | null };
...
export type ProgramAdminDetailHostFragment = { __typename?: 'LimitedInvolvementType', id: string, person: { __typename?: 'LimitedPersonType', fullName: string, firstName: string, lastName: string, nick: string, email: string, phoneNumber: string, discordHandle: string } };
...
export type ProgramAdminHostFragment = { __typename?: 'FullProgramHostType', person: { __typename?: 'LimitedPersonType', firstName: string, lastName: string, nick: string }, programs: Array<{ __typename?: 'LimitedProgramType', slug: string, title: string, cachedDimensions?: unknown | null }> };
...
export type ValueFieldsFragment = { __typename?: 'DimensionValueType', slug: string, color: string, isTechnical: boolean, canRemove: boolean, title?: string | null, titleFi: string, titleEn: string, titleSv: string };
...
export type EditSurveyPageFragment = { __typename?: 'FullSurveyType', slug: string, title?: string | null, loginRequired: boolean, anonymity: Anonymity, maxResponsesPerUser: number, countResponsesByCurrentUser: number, activeFrom?: string | null, activeUntil?: string | null, canRemove: boolean, purpose: SurveyPurpose, protectResponses: boolean, languages: Array<{ __typename?: 'FormType', title: string, language: FormsFormLanguageChoices, canRemove: boolean }> };
...
export type ProfileProgramOfferFragment = { __typename?: 'FullResponseType', id: string, createdAt: string, values?: unknown | null, form: { __typename?: 'FormType', event: { __typename?: 'LimitedEventType', slug: string, name: string } }, dimensions: Array<{ __typename?: 'ResponseDimensionValueType', dimension: { __typename?: 'FullDimensionType', slug: string, title?: string | null }, value: { __typename?: 'DimensionValueType', slug: string, title?: string | null, color: string } }> };
...
export type ProfileProgramItemListQuery = { __typename?: 'Query', profile?: { __typename?: 'ProfileType', program: { __typename?: 'ProgramV2ProfileMetaType', programs?: Array<{ __typename?: 'FullProgramType', slug: string, title: string, event: { __typename?: 'LimitedEventType', slug: string, name: string }, dimensions: Array<{ __typename?: 'ProgramDimensionValueType', dimension: { __typename?: 'FullDimensionType', slug: string, title?: string | null }, value: { __typename?: 'DimensionValueType', slug: string, title?: string | null, color: string } }> }> | null, programOffers: Array<{ __typename?: 'FullResponseType', id: string, createdAt: string, values?: unknown | null, form: { __typename?: 'FormType', event: { __typename?: 'LimitedEventType', slug: string, name: string } }, dimensions: Array<{ __typename?: 'ResponseDimensionValueType', dimension: { __typename?: 'FullDimensionType', slug: string, title?: string | null }, value: { __typename?: 'DimensionValueType', slug: string, title?: string | null, color: string } }> }> } } | null };
...
export const ProfileProgramOfferFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ProfileProgramOffer"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"FullResponseType"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"values"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"keyFieldsOnly"},"value":{"kind":"BooleanValue","value":true}}]},{"kind":"Field","name":{"kind":"Name","value":"form"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"event"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"dimensions"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"keyDimensionsOnly"},"value":{"kind":"BooleanValue","value":true}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"dimension"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"title"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"lang"},"value":{"kind":"Variable","name":{"kind":"Name","value":"locale"}}}]}]}},{"kind":"Field","name":{"kind":"Name","value":"value"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"title"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"lang"},"value":{"kind":"Variable","name":{"kind":"Name","value":"locale"}}}]},{"kind":"Field","name":{"kind":"Name","value":"color"}}]}}]}}]}}]} as unknown as DocumentNode<ProfileProgramOfferFragment, unknown>;

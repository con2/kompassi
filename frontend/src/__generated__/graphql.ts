...
export type EditSurveyPageFragment = { __typename?: 'SurveyType', slug: string, title?: string | null, loginRequired: boolean, anonymity: FormsSurveyAnonymityChoices, maxResponsesPerUser: number, countResponsesByCurrentUser: number, activeFrom?: string | null, activeUntil?: string | null, languages: Array<{ __typename?: 'FormType', title: string, language: FormsFormLanguageChoices }> };

...
export type ProgramAdminDetailHostFragment = { __typename?: 'LimitedInvolvementType', id: string, firstName: string, lastName: string, nick: string, email: string, phoneNumber: string };
...
export type ProgramAdminDetailHostsQueryQuery = { __typename?: 'Query', event?: { __typename?: 'FullEventType', name: string, slug: string, timezone: string, program?: { __typename?: 'ProgramV2EventMetaType', program?: { __typename?: 'FullProgramType', slug: string, title: string, programHosts: Array<{ __typename?: 'LimitedInvolvementType', id: string, firstName: string, lastName: string, nick: string, email: string, phoneNumber: string }> } | null } | null } | null };

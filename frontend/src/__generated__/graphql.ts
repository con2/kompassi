...
export type TicketsV2EventMetaType = {
  ...
  provider: TicketsV2TicketsV2EventMetaProviderChoices;
...
/** An enumeration. */
export enum TicketsV2TicketsV2EventMetaProviderChoices {
  /** NONE */
  A_0 = 'A_0',
  /** PAYTRAIL */
  A_1 = 'A_1',
...
export type OrderListFragment = { __typename?: 'FullOrderType', id: string, formattedOrderNumber: string, displayName: string, createdAt: string, totalPrice: any, status: PaymentStatus };
...
export type OrderListQuery = { __typename?: 'Query', event?: { __typename?: 'FullEventType', name: string, slug: string, tickets?: { __typename?: 'TicketsV2EventMetaType', orders: Array<{ __typename?: 'FullOrderType', id: string, formattedOrderNumber: string, displayName: string, createdAt: string, totalPrice: any, status: PaymentStatus }> } | null } | null };

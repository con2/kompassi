...
export type AdminQuotaDetailPageQuery = { __typename?: 'Query', event?: { __typename?: 'FullEventType', name: string, slug: string, tickets?: { __typename?: 'TicketsV2EventMetaType', quota: { __typename?: 'FullQuotaType', id: string, name: string, countReserved: number, countTotal: number, products: Array<{ __typename?: 'LimitedProductType', id: string, title: string, price: any, countReserved: number }> } } | null } | null };
...
export type ProfileOrderFragment = { __typename?: 'ProfileOrderType', id: string, formattedOrderNumber: string, createdAt: string, totalPrice: any, status: PaymentStatus, eticketsLink?: string | null, event: { __typename?: 'LimitedEventType', slug: string, name: string } };

export type ProfileOrdersQueryVariables = Exact<{ [key: string]: never; }>;


export type ProfileOrdersQuery = { __typename?: 'Query', profile?: { __typename?: 'ProfileType', tickets: { __typename?: 'TicketsV2ProfileMetaType', haveUnlinkedOrders: boolean, orders: Array<{ __typename?: 'ProfileOrderType', id: string, formattedOrderNumber: string, createdAt: string, totalPrice: any, status: PaymentStatus, eticketsLink?: string | null, event: { __typename?: 'LimitedEventType', slug: string, name: string } }> } } | null };

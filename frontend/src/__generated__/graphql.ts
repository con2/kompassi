...
export type ProgramOfferDimensionFragment = { __typename?: 'FullDimensionType', slug: string, title?: string | null, values: Array<{ __typename?: 'DimensionValueType', slug: string, title?: string | null, color: string }> };

...
export type EventAnnotationType = {
  __typename?: 'EventAnnotationType';
  annotation: AnnotationType;
  /** If false, this annotation will not be used in this event. */
  isActive: Scalars['Boolean']['output'];
  meta: ProgramV2EventMetaType;
  /** List of program form field slugs this annotation will be attempted to be extracted from, in order. */
  programFormFields: Array<Scalars['String']['output']>;
};
...
export type Mutation = {
  ...
  putEventAnnotation?: Maybe<PutEventAnnotation>;
...
export type MutationPutEventAnnotationArgs = {
...
export type ProgramV2EventMetaType = {
  ...
  eventAnnotations: Array<EventAnnotationType>;
  program?: Maybe<FullProgramType>;
...
export type PutEventAnnotation = {
  __typename?: 'PutEventAnnotation';
  eventAnnotation?: Maybe<EventAnnotationType>;
};

/** An enumeration. */
export enum PutEventAnnotationAction {
  SaveAndRefresh = 'SAVE_AND_REFRESH',
  SaveWithoutRefresh = 'SAVE_WITHOUT_REFRESH'
}

export type PutEventAnnotationInput = {
  action?: InputMaybe<PutEventAnnotationAction>;
  annotationSlug: Scalars['String']['input'];
  eventSlug: Scalars['String']['input'];
  isActive: Scalars['Boolean']['input'];
  programFormFields: Array<Scalars['String']['input']>;
};
...
export type PutEventAnnotationMutation = { __typename?: 'Mutation', putEventAnnotation?: { __typename?: 'PutEventAnnotation', eventAnnotation?: { __typename?: 'EventAnnotationType', annotation: { __typename?: 'AnnotationType', slug: string } } | null } | null };

export type ProgramAdminEventAnnotationFragment = { __typename?: 'EventAnnotationType', isActive: boolean, programFormFields: Array<string>, annotation: { __typename?: 'AnnotationType', slug: string, title: string, description: string, type: AnnotationDataType, isComputed: boolean, isPublic: boolean, isShownInDetail: boolean, isInternal: boolean, isApplicableToProgramItems: boolean, isApplicableToScheduleItems: boolean } };
...
export type ProgramDetailQueryQuery = { __typename?: 'Query', profile?: { __typename?: 'OwnProfileType', program: { __typename?: 'ProgramV2ProfileMetaType', scheduleItems?: Array<{ __typename?: 'FullScheduleItemType', slug: string }> | null } } | null, event?: { __typename?: 'FullEventType', name: string, slug: string, timezone: string, program?: { __typename?: 'ProgramV2EventMetaType', calendarExportLink: string, program?: { __typename?: 'FullProgramType', title: string, description: string, cachedHosts: string, links: Array<{ __typename?: 'ProgramLink', type: ProgramLinkType, href: string, title: string }>, annotations: Array<{ __typename?: 'ProgramAnnotationType', value?: unknown | null, annotation: { __typename?: 'AnnotationType', slug: string, type: AnnotationDataType, title: string } }>, dimensions: Array<{ __typename?: 'ProgramDimensionValueType', dimension: { __typename?: 'FullDimensionType', slug: string, title?: string | null }, value: { __typename?: 'DimensionValueType', slug: string, title?: string | null } }>, scheduleItems: Array<{ __typename?: 'LimitedScheduleItemType', slug: string, subtitle: string, location?: string | null, startTime: string, endTime: string }> } | null } | null } | null };
...
export type DimensionEditorFragment = { __typename?: 'FullDimensionType', slug: string, canRemove: boolean, title?: string | null, isPublic: boolean, isKeyDimension: boolean, isMultiValue: boolean, isListFilter: boolean, isShownInDetail: boolean, isNegativeSelection: boolean, isTechnical: boolean, valueOrdering: DimensionsDimensionValueOrderingChoices, titleFi: string, titleEn: string, titleSv: string, values: Array<{ __typename?: 'DimensionValueType', slug: string, color: string, isTechnical: boolean, isSubjectLocked: boolean, canRemove: boolean, title?: string | null, titleFi: string, titleEn: string, titleSv: string }> };
...
export const PutEventAnnotationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"PutEventAnnotation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"PutEventAnnotationInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"putEventAnnotation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"eventAnnotation"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"annotation"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"slug"}}]}}]}}]}}]}}]} as unknown as DocumentNode<PutEventAnnotationMutation, PutEventAnnotationMutationVariables>;

...
const translations: Translations = {
  ...
  Survey: {
    ...
    attributes: {
      ...
      originalCreatedAt: "Alkuperäisen version lähetysaika",
      originalCreatedBy: "Alkuperäisen version lähettäjä",
      currentVersionCreatedAt: "Ajantasaisen version luontiaika",
      currentVersionCreatedBy: "Ajantasaisen version lähettäjä",

...
from .utils import OptionalTrailingSlashRouter, OptionalTrailingSlashNestedRouter
...
forms_router = OptionalTrailingSlashNestedRouter(router, 'forms', lookup='form')

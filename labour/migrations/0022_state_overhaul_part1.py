...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'Signup.is_active'
        db.delete_column(u'labour_signup', 'is_active')

        # Deleting field 'Signup.time_accepted'
        db.delete_column(u'labour_signup', 'time_accepted')

        # Deleting field 'Signup.time_shifts_ready'
        db.delete_column(u'labour_signup', 'time_shifts_ready')

        # Deleting field 'Signup.time_cancelled'
        db.delete_column(u'labour_signup', 'time_cancelled')

        # Deleting field 'Signup.time_rejected'
        db.delete_column(u'labour_signup', 'time_rejected')

        # Deleting field 'Signup.time_arrived'
        db.delete_column(u'labour_signup', 'time_arrived')

        # Deleting field 'Signup.time_work_accepted'
        db.delete_column(u'labour_signup', 'time_work_accepted')

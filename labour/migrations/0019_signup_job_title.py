...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Signup.job_title'
        db.add_column(u'labour_signup', 'job_title',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=63, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Signup.job_title'
        db.delete_column(u'labour_signup', 'job_title')

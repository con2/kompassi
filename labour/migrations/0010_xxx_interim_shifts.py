...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Signup.xxx_interim_shifts'
        db.add_column(u'labour_signup', 'xxx_interim_shifts',
                      self.gf('django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Signup.xxx_interim_shifts'
        db.delete_column(u'labour_signup', 'xxx_interim_shifts')
    ...
    models = {
        ...
        u'labour.signup': {
            ...
            'xxx_interim_shifts': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'})
        },
        u'labour.workperiod': {

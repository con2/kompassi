...
def fix_signup_extra_form_class_paths(apps, schema_editor):
    ...
    AlternativeSignupForm.objects.filter(
        signup_extra_form_class_path='labour.forms:EmptySignupExtraForm'
    ).update(
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(default='labour.forms:ObsoleteEmptySignupExtraV1Form', help_text='Viittaus lis\xe4tietolomakkeen toteuttavaan luokkaan. Esimerkki: tracon9.forms:ConcomSignupExtraForm', max_length=63),
        ),

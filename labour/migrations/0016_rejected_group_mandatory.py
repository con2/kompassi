...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LabourEventMeta.rejected_group'
        db.alter_column(u'labour_laboureventmeta', 'rejected_group_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.Group']))

    def backwards(self, orm):

        # Changing field 'LabourEventMeta.rejected_group'
        db.alter_column(u'labour_laboureventmeta', 'rejected_group_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.Group']))

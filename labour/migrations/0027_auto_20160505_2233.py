...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='job',
            name='job_category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='labour.JobCategory', verbose_name='job category'),
        ),
        migrations.AlterField(
            model_name='job',
            name='title',
        ...
        migrations.AlterField(
            model_name='jobrequirement',
            name='job',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requirements', to='labour.Job', verbose_name='job'),
        ),
        migrations.AlterField(
            model_name='jobrequirement',
            name='start_time',
        ...
        migrations.AlterField(
            model_name='shift',
            name='job',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shifts', to='labour.Job'),
        ),
        migrations.AlterField(
            model_name='shift',
            name='notes',
        ...
        migrations.AlterField(
            model_name='shift',
            name='signup',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shifts', to='labour.Signup'),
        ),
        migrations.AlterField(

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field job_categories_accepted on 'Signup'
        m2m_table_name = db.shorten_name(u'labour_signup_job_categories_accepted')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'labour_signup', 'job_category_accepted',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='accepted_signup_set', null=True, to=orm['labour.JobCategory'], blank=True),
                      keep_default=False)

        # Removing M2M table for field job_categories_accepted on 'Signup'
        db.delete_table(db.shorten_name(u'labour_signup_job_categories_accepted'))

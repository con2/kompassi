    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='Will be displayed at the top of the survey page.', max_length=255, verbose_name='Title')),
                ('description', models.TextField(help_text='Will be displayed at the top of the survey page.', verbose_name='Description')),
                ...
                ('form_class_path', models.CharField(help_text='A reference to the form that is used as the survey form.', max_length=255, verbose_name='Form path')),

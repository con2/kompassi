...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for labour_event_meta in orm.LabourEventMeta.objects.all():
            ...
            rejected_group, unused = orm['auth.Group'].objects.get_or_create(name=group_name)

            labour_event_meta.rejected_group = rejected_group
    ...
    models = {
        ...
        u'labour.laboureventmeta': {
            ...
            'rejected_group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['auth.Group']"}),

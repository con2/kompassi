...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlternativeSignupForm.signup_message'
        db.add_column(u'labour_alternativesignupform', 'signup_message',
                      self.gf('django.db.models.fields.TextField')(default=u'', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlternativeSignupForm.signup_message'
        db.delete_column(u'labour_alternativesignupform', 'signup_message')

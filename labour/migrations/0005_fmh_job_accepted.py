...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Signup.job_accepted'
        db.delete_column(u'labour_signup', 'job_accepted_id')


    def backwards(self, orm):
        # Adding field 'Signup.job_accepted'
        db.add_column(u'labour_signup', 'job_accepted',

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Signup.alternative_signup_form_used'
        db.add_column(u'labour_signup', 'alternative_signup_form_used',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labour.AlternativeSignupForm'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Signup.alternative_signup_form_used'
        db.delete_column(u'labour_signup', 'alternative_signup_form_used_id')

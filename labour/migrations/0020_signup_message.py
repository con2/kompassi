...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LabourEventMeta.signup_message'
        db.add_column(u'labour_laboureventmeta', 'signup_message',
                      self.gf('django.db.models.fields.TextField')(default=u'', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LabourEventMeta.signup_message'
        db.delete_column(u'labour_laboureventmeta', 'signup_message')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Signup.xxx_interim_shifts'
        db.alter_column(u'labour_signup', 'xxx_interim_shifts', self.gf('django.db.models.fields.TextField')(null=True))
        # Adding field 'LabourEventMeta.finished_group'
        db.add_column(u'labour_laboureventmeta', 'finished_group',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Signup.xxx_interim_shifts'
        db.alter_column(u'labour_signup', 'xxx_interim_shifts', self.gf('django.db.models.fields.TextField')())

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LabourEventMeta.accepted_group'
        db.alter_column(u'labour_laboureventmeta', 'accepted_group_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.Group']))

    def backwards(self, orm):

        # Changing field 'LabourEventMeta.accepted_group'
        db.alter_column(u'labour_laboureventmeta', 'accepted_group_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.Group']))

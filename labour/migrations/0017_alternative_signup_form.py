...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AlternativeSignupForm'
        db.create_table(u'labour_alternativesignupform', (
            ...
            ('signup_form_class_path', self.gf('django.db.models.fields.CharField')(max_length=63)),
            ('signup_extra_form_class_path', self.gf('django.db.models.fields.CharField')(default='labour.forms:EmptySignupExtraForm', max_length=63)),
            ('active_from', self.gf('django.db.models.fields.DateTimeField')(default=u'K\xe4ytt\xf6aika alkaa', null=True, blank=True)),
            ('active_until', self.gf('django.db.models.fields.DateTimeField')(default=u'K\xe4ytt\xf6aika p\xe4\xe4ttyy', null=True, blank=True)),
        ))
        db.send_create_signal(u'labour', ['AlternativeSignupForm'])

        # Adding unique constraint on 'AlternativeSignupForm', fields ['event', 'slug']
        db.create_unique(u'labour_alternativesignupform', ['event_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'AlternativeSignupForm', fields ['event', 'slug']
        db.delete_unique(u'labour_alternativesignupform', ['event_id', 'slug'])

        # Deleting model 'AlternativeSignupForm'
        db.delete_table(u'labour_alternativesignupform')

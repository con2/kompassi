...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('url', models.CharField(help_text='Muista aloittaa ulkoiset linkit <i>http://</i> tai <i>https://</i>.', max_length=255, verbose_name='Osoite')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('notes', models.TextField(help_text='T\xe4m\xe4 kentt\xe4 ei normaalisti n\xe4y henkil\xf6lle itselleen, mutta jos t\xe4m\xe4 pyyt\xe4\xe4 henkil\xf6rekisteriotetta, kent\xe4n arvo on siihen sis\xe4llytett\xe4v\xe4.', verbose_name='K\xe4sittelij\xe4n merkinn\xe4t', blank=True)),
                ...
                ('xxx_interim_shifts', models.TextField(default='', help_text='T\xe4m\xe4 tekstikentt\xe4 on v\xe4liaikaisratkaisu, jolla v\xe4nk\xe4rin ty\xf6vuorot voidaan merkit\xe4 Kompassiin ja l\xe4hett\xe4\xe4 v\xe4nk\xe4rille ty\xf6voimaviestiss\xe4 jo ennen kuin lopullinen ty\xf6vuoroty\xf6kalu on k\xe4ytt\xf6kunnossa.', null=True, verbose_name='Ty\xf6vuorot', blank=True)),
                ('job_title', models.CharField(default='', help_text='Printataan badgeen ym. Asetetaan automaattisesti hyv\xe4ksyttyjen teht\xe4v\xe4alueiden perusteella, mik\xe4li kentt\xe4 j\xe4tet\xe4\xe4n tyhj\xe4ksi.', max_length=63, verbose_name='Teht\xe4v\xe4nimike', blank=True)),
                ...
                ('time_work_accepted', models.DateTimeField(null=True, verbose_name='Ty\xf6panos hyv\xe4ksytty', blank=True)),
                ('time_reprimanded', models.DateTimeField(null=True, verbose_name='Ty\xf6panoksesta esitetty moite', blank=True)),
            ],
            options={

...
app_name = "labour"
urlpatterns = [
    url(r'^events/(?P<event_slug>[a-z0-9-]+)/signup/?$', signup_view, name='signup_view'),
    url(r'^events/(?P<event_slug>[a-z0-9-]+)/signup/(?P<alternative_form_slug>[a-z0-9-]+)/?$', signup_view, name='special_signup_view'),

    url(r'^profile/qualifications/?$', qualifications_view, name='qualifications_view'),
    url(r'^profile/qualifications/(?P<qualification>[a-z0-9-]+)/?$', person_qualification_view, name='person_qualification_view'),

    # XXX make these DELETE and POST of person_qualification_view
    url(r'^profile/qualifications/(?P<qualification>[a-z0-9-]+)/delete/?$', person_disqualify_view, name='person_disqualify_view'),
    url(r'^profile/qualifications/(?P<qualification>[a-z0-9-]+)/add/?$', person_qualify_view, name='person_qualify_view'),

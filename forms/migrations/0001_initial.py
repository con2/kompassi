    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_standalone', models.BooleanField(default=True, help_text='Stand-alone forms can be used via the generic form views whereas non-stand-alone forms can only be accessed from some other facility.', verbose_name='Stand-alone')),
